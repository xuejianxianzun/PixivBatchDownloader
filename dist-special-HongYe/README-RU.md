...
- Преобразование угойры в форматы WebP, WebM, GIF, APNG;
...
Этот загрузчик работает на страницах Pixiv.net. Когда вы просматриваете Pixiv, вы можете в любой момент открыть панель загрузчика и использовать её.

Примечание:
- После установки этого расширения, если у вас уже открыты вкладки Pixiv, обновите их, чтобы расширение могло работать на этих вкладках.
- На веб-страницах, отличных от Pixiv.net, нажатие на значок расширения не покажет панель загрузчика. Это нормально, так как расширение работает только на Pixiv.net.
