    ...
    async init(id) {
        ...
        for (const range of this.rangeList) {
            ...
            if (this.jpgFileList.length > 0 && !this.showCanvas) {
                ...
                _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].insertToHead(this.canvas);
...
class PreviewWork {
    ...
    async showWrap() {
        ...
        this.sendUrls();
        // 预览动图
        console.log('settings.previewUgoira', _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].previewUgoira);
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].previewUgoira && this.workData.body.illustType === 2) {
            this.previewUgoira = new _PreviewUgoira__WEBPACK_IMPORTED_MODULE_8__["PreviewUgoira"](this.workData.body.id);
        }
    }
    replaceUrl(url) {
...
class Settings {
    ...
    restore() {
        ...
        chrome.storage.local.get(_config_Config__WEBPACK_IMPORTED_MODULE_4__["Config"].settingStoreName, (result) => {
            ...
            this.settings.previewUgoira = true;
