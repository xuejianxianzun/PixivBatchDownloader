...
/* harmony import */ var _modules_setting_InvisibleSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/setting/InvisibleSettings */ "./src/ts/modules/setting/InvisibleSettings.ts");
/* harmony import */ var _modules_PageType__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _modules_QuickDownload__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/QuickDownload */ "./src/ts/modules/QuickDownload.ts");
/* harmony import */ var _modules_DownloadButton__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/DownloadButton */ "./src/ts/modules/DownloadButton.ts");
/* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _modules_setting_FormSettings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/setting/FormSettings */ "./src/ts/modules/setting/FormSettings.ts");
...
/* harmony import */ var _modules_tools_CheckNew__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/tools/CheckNew */ "./src/ts/modules/tools/CheckNew.ts");
...
class BG {
    ...
    setDisplay() {
        ...
        if (!this.haveImage) {
            ...
            this.wrap.classList[_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].bgDisplay ? 'add' : 'remove'](this.flagClassName);
        }
    }
    setOpacity() {
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Token */ "./src/ts/modules/Token.ts");
...
class BookmarkAfterDL {
    ...
    bindEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].list.downloadSuccess, (ev) => {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].list.skipDownload, (ev) => {
    ...
    async addBookmark(id) {
        return new Promise(async (resolve, reject) => {
            ...
            await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(data.type !== 3 ? 'illusts' : 'novels', id.toString(), _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].widthTag === 'yes' ? data.tags : [], _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].restrict === 'yes', _Token__WEBPACK_IMPORTED_MODULE_1__["token"].token).catch((err) => {
...
class BookmarkAllWorks {
    ...
    async getTagData() {
        return new Promise(async (resolve) => {
            for (const id of this.idList) {
                ...
                let data;
                if (id.type === 'novels') {
                    data = await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getNovelData(id.id);
                }
                else {
                    data = await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getArtworkData(id.id);
                }
    ...
    async addBookmarkAll() {
        return new Promise(async (resolve) => {
            ...
            for (const data of this.bookmarKData) {
                ...
                await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(data.type, data.id, _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].widthTag === 'yes' ? data.tags : [], _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].restrict === 'yes', _Token__WEBPACK_IMPORTED_MODULE_1__["token"].token);
                index++;
            }
            resolve();
        });
    ...
    complete() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].list.bookmarkModeEnd);
        _Toast__WEBPACK_IMPORTED_MODULE_5__["toast"].success('✓ Complete');
    }
}
...
/* harmony import */ var _Token__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Token */ "./src/ts/modules/Token.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
...
class BookmarksAddTag {
    ...
    async readyAddTag(loop = 0) {
        ...
        const [showData, hideData] = await Promise.all([
            _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].getUserId(), this.type, '未分類', offset, false),
            _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].getUserId(), this.type, '未分類', offset, true),
        ]).catch((error) => {
    ...
    async addTag(index, addList, tt) {
        ...
        await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(this.type, item.id, item.tags, item.restrict, tt);
...
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./MsgBox */ "./src/ts/modules/MsgBox.ts");
/* harmony import */ var _BG__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./BG */ "./src/ts/modules/BG.ts");
...
class CenterPanel {
    constructor() {
        ...
        new _BG__WEBPACK_IMPORTED_MODULE_6__["BG"](this.centerPanel);
        this.bindEvents();
    }
    // 添加中间面板
    addCenterPanel() {
    ...
    toggle() {
        ...
        if (nowDisplay === 'block') {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.openCenterPanel);
        }
    }
}
new CenterPanel();
...
/* harmony import */ var _FileName__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./FileName */ "./src/ts/modules/FileName.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./MsgBox */ "./src/ts/modules/MsgBox.ts");
/* harmony import */ var _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/Json2Blob */ "./src/ts/modules/utils/Json2Blob.ts");
...
class Deduplication {
    ...
    bindEvents() {
        ...
        // 导入下载记录的按钮
        {
            ...
            if (btn) {
                btn.addEventListener('click', () => {
                    _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.importDownloadRecord);
                });
            }
        }
        // 监听导入下载记录的事件
        ...
        // 导出下载记录的按钮
        {
            ...
            if (btn) {
                btn.addEventListener('click', () => {
                    _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.exportDownloadRecord);
                });
            }
        }
        // 监听导出下载记录的事件
        ...
        // 清空下载记录的按钮
        {
            ...
            if (btn) {
                btn.addEventListener('click', () => {
                    _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.clearDownloadRecord);
                });
            }
        }
        // 监听清空下载记录的事件
    ...
    createRecord(resultId) {
        let name = _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].userSetName;
        // 查找这个抓取结果，获取其文件名
        for (const result of _Store__WEBPACK_IMPORTED_MODULE_5__["store"].result) {
            if (result.id === resultId) {
                name = _FileName__WEBPACK_IMPORTED_MODULE_6__["fileName"].getFileName(result);
                break;
            }
        }
        return {
    ...
    async check(resultId) {
        if (!_Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].isPixiv()) {
            return false;
        }
        return new Promise(async (resolve, reject) => {
            // 如果未启用去重，直接返回不重复
    ...
    async exportRecord() {
        ...
        const blob = _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_10__["Json2Blob"].convert(record);
        const url = URL.createObjectURL(blob);
        _Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].downloadFile(url, `record-${_Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].replaceUnsafeStr(new Date().toLocaleString())}.json`);
    }
    // 导入下载记录
    async importRecord() {
        const record = (await _Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].loadJSONFile().catch((err) => {
        ...
        _MsgBox__WEBPACK_IMPORTED_MODULE_9__["msgBox"].success(`${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_导入下载记录')}<br>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_完成')}`);
    ...
    exportTestFile(number) {
        ...
        const blob = _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_10__["Json2Blob"].convert(r);
        const url = URL.createObjectURL(blob);
        _Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].downloadFile(url, `record-test-${number}.json`);
    }
}
...
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
...
class DeleteWorks {
    ...
    addClearMultipleBtn(selector, callback = () => { }) {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除多图作品'), [
    ...
    addClearUgoiraBtn(selector, callback = () => { }) {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除动图作品'), [
    ...
    addManuallyDeleteBtn(callback = () => { }) {
        ...
        this.delBtn = _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品Title')]]);
...
/***/ "./src/ts/modules/DestroyManager.ts":
/*!******************************************!*\
  !*** ./src/ts/modules/DestroyManager.ts ***!
  \******************************************/
...
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _novel_MakeNovelFile__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./novel/MakeNovelFile */ "./src/ts/modules/novel/MakeNovelFile.ts");
// 下载文件，并发送给浏览器下载
...
class Download {
    ...
    afterReTryMax(status, fileId) {
        ...
        if (status === 404) {
            // 跳过，不会再尝试下载它
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_file404', fileId));
            return this.skip({
                id: fileId,
                reason: '404',
            });
        ...
        this.cancel = true;
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.downloadError, fileId);
    }
    // 下载文件
    async download(arg) {
        // 检查是否是重复文件
        ...
        if (arg.data.type === 3) {
            ...
            if (arg.data.novelMeta) {
                let blob = await _novel_MakeNovelFile__WEBPACK_IMPORTED_MODULE_10__["MakeNovelFile"].make(arg.data.novelMeta);
            ...
            url = arg.data[_setting_Settings__WEBPACK_IMPORTED_MODULE_9__["settings"].imageSize] || arg.data.original;
        }
...
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
...
/* harmony import */ var _BookmarkAfterDL__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./BookmarkAfterDL */ "./src/ts/modules/BookmarkAfterDL.ts");
/* harmony import */ var _Resume__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Resume */ "./src/ts/modules/Resume.ts");
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./States */ "./src/ts/modules/States.ts");
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
// 下载控制
...
class DownloadControl {
    constructor() {
        ...
        // 只在 p 站内启用下载后收藏的功能
        if (_Tools__WEBPACK_IMPORTED_MODULE_17__["Tools"].isPixiv()) {
    ...
    listenEvents() {
        ...
        chrome.runtime.onMessage.addListener((msg) => {
            ...
            if (msg.msg === 'downloaded') {
                ...
                // 发送下载成功的事件
                _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.downloadSuccess, msg.data);
    ...
    <span class="bmkAfterDL_tip green"></span>
        ...
        this.wrapper.querySelector('.copyUrl').addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.showURLs);
        });
    }
    ...
    readyDownload() {
        ...
        // 检查 不自动开始下载 的标记
        if (_States__WEBPACK_IMPORTED_MODULE_14__["states"].notAutoDownload) {
            return;
        }
        // 视情况自动开始下载
    ...
    // 开始下载
    startDownload() {
        if (!this.pause && !_Resume__WEBPACK_IMPORTED_MODULE_13__["resume"].flag) {
    ...
    setDownloadThread() {
        ...
        if (setThread < 1 ||
            setThread > _config_Config__WEBPACK_IMPORTED_MODULE_15__["default"].downloadThreadMax ||
            isNaN(setThread)) {
            // 如果数值非法，则重设为默认值
            this.thread = _config_Config__WEBPACK_IMPORTED_MODULE_15__["default"].downloadThreadMax;
        }
        else {
    ...
    setDownloaded() {
        ...
        if (this.downloaded === _Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length) {
            ...
            this.reset();
            this.setDownStateText(_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_下载完毕'), _config_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].textSuccess);
        }
    ...
    // 设置下载状态文本，默认颜色为主题蓝色
    setDownStateText(text, color = _config_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgBlue) {
...
const bindOnceFlagList = [];
// 只绑定某个事件一次，用于防止事件重复绑定
// 通过 flag 确认是否是同一个事件
// 可以执行多次，不会自动解绑
function bindOnce(flag, targetEvt, evtFun) {
...
class ExportLST {
    ...
    createLst() {
        ...
        const url = URL.createObjectURL(blob);
        const name = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].getTitle() + '.lst';
        _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].downloadFile(url, name);
    }
}
new ExportLST();
...
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/Json2Blob */ "./src/ts/modules/utils/Json2Blob.ts");
...
class ExportResult {
    ...
    output() {
        ...
        const blob = _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_6__["Json2Blob"].convert(_Store__WEBPACK_IMPORTED_MODULE_2__["store"].result);
        const url = URL.createObjectURL(blob);
...
/***/ "./src/ts/modules/ExportResult2CSV.ts":
/*!********************************************!*\
  !*** ./src/ts/modules/ExportResult2CSV.ts ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
...
/* harmony import */ var _utils_CreateCSV__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/CreateCSV */ "./src/ts/modules/utils/CreateCSV.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
...
class ExportResult2CSV {
    ...
    create(data) {
        ...
        for (const d of data) {
            ...
            for (const field of this.fieldCfg) {
                if (field.name === 'fileName') {
                    ...
                    // 对于某些字段，将其内容特殊化处理
                    if (field.name === 'type') {
                        result = _config_Config__WEBPACK_IMPORTED_MODULE_3__["default"].worksTypeName[result];
                    }
        ...
        csvName = `result-${_Tools__WEBPACK_IMPORTED_MODULE_8__["Tools"].replaceUnsafeStr(csvName)}-${_Store__WEBPACK_IMPORTED_MODULE_4__["store"].crawlCompleteTime.getTime()}.csv`;
        _Tools__WEBPACK_IMPORTED_MODULE_8__["Tools"].downloadFile(csvURL, csvName);
...
class FastScreen {
    ...
    create() {
        ...
        _Theme__WEBPACK_IMPORTED_MODULE_2__["theme"].register(fastScreenArea);
        target.insertAdjacentElement('afterend', fastScreenArea);
    }
    // 打开快速筛选链接
    openFastScreenLink(secondTag) {
        // 拼接两个 tag。因为搜索页面可以无刷新切换搜索的 tag，所以从这里动态获取
        const nowTag = _Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].getTagFromURL();
...
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
/* harmony import */ var _DateFormat__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DateFormat */ "./src/ts/modules/DateFormat.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class FileName {
    ...
    getFileName(data) {
        // 为空时使用 {id}
        let result = _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].userSetName || '{id}';
        // 配置所有命名标记
        const cfg = {
            '{p_title}': {
            ...
            '{date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_3__["DateFormat"].format(data.date, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{task_date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_3__["DateFormat"].format(_Store__WEBPACK_IMPORTED_MODULE_1__["store"].crawlCompleteTime, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{type}': {
                value: _config_Config__WEBPACK_IMPORTED_MODULE_2__["default"].worksTypeName[data.type],
                prefix: '',
                safe: true,
            },
            '{series_title}': {
        ...
        // 替换命名规则里的特殊字符
        result = _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].replaceUnsafeStr(result);
        // 上一步会把斜线 / 替换成全角的斜线 ／，这里再替换回来，否则就不能建立文件夹了
        result = result.replace(/／/g, '/');
        // 判断这个作品是否要去掉序号
        const noSerialNo = cfg['{p_num}'].value === 0 && _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].noSerialNo;
        // 把命名规则的标记替换成实际值
        for (const [key, val] of Object.entries(cfg)) {
            if (result.includes(key)) {
                ...
                // 替换标记值中的特殊字符
                if (!val.safe) {
                    once = _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].replaceUnsafeStr(once);
                }
                // 添加标记名称
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderByType) {
            ...
            if (allSwitch[data.type]) {
                const folder = _config_Config__WEBPACK_IMPORTED_MODULE_2__["default"].worksTypeName[data.type];
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderByTag && _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderTagList.length > 0) {
            ...
            for (const tag of _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderTagList) {
                ...
                if (workTags.includes(nowTag)) {
                    ...
                    const folder = _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].replaceUnsafeStr(tag);
                    result = this.appendFolder(result, folder);
                    break;
                }
            }
...
class IdListWithPageNo {
    ...
    sort(flag) {
        if (this.allList[flag]) {
            this.allList[flag].sort(_Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].sortByProperty('page', 'asc'));
        }
    }
    // 转储到 store.idList 里
    // 自动排序
...
class ImageViewer {
    ...
    async createImageList() {
        ...
        // 获取作品数据，生成缩略图列表
        const data = await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getArtworkData(this.cfg.workId);
...
/***/ "./src/ts/modules/ImportResult.ts":
/*!****************************************!*\
  !*** ./src/ts/modules/ImportResult.ts ***!
  \****************************************/
/*! no exports provided */
...
class ImportResult {
    ...
    async import() {
        const loadedJSON = (await _Tools__WEBPACK_IMPORTED_MODULE_2__["Tools"].loadJSONFile().catch((err) => {
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
/* harmony import */ var _Token__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Token */ "./src/ts/modules/Token.ts");
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
...
/* harmony import */ var _BookmarksAddTag__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./BookmarksAddTag */ "./src/ts/modules/BookmarksAddTag.ts");
...
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
// 初始化旧版收藏页面
...
class InitBookmarkLegacyPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
        // 添加下载推荐作品的按钮
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_抓取推荐作品'), [
    ...
    addAnyElement() {
        ...
        if (_Token__WEBPACK_IMPORTED_MODULE_3__["token"].token) {
            const btn = _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_给未分类作品添加添加tag'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_给未分类作品添加添加tag')]]);
    ...
    readyGetIdList() {
        ...
        const nowPage = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'p'); // 判断当前处于第几页，页码从 1 开始。也可能没有页码
        if (nowPage) {
        ...
        this.isHide = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'rest') === 'hide';
    ...
    async getIdList() {
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].getUserId(), this.type, _Store__WEBPACK_IMPORTED_MODULE_7__["store"].tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
    ...
    afterGetIdList() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.concat(this.idList);
    ...
    getRecommendedList() {
        const selector = this.type === 'illusts'
            ...
            : '.novel-items>li';
        const idType = this.type === 'illusts' ? 'unknown' : 'novels';
        const getId = this.type === 'illusts' ? _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getIllustId : _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getNovelId;
        // 获取下方已经加载出来的作品
        ...
        for (const li of elements) {
            ...
            if (_Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.length === this.crawlNumber) {
                break;
            }
    ...
    sortResult() {
        ...
        !this.crawlRecommended && _Store__WEBPACK_IMPORTED_MODULE_7__["store"].result.reverse();
    }
}
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取'), [
    ...
    addAnyElement() {
        ...
        if (_Token__WEBPACK_IMPORTED_MODULE_8__["token"].token) {
            const btn = _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_给未分类作品添加添加tag'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_给未分类作品添加添加tag')]]);
    ...
    async getIdList() {
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].getUserId(), this.type, _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
    ...
    afterGetIdList() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.concat(this.idList);
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
        this.type = 'illusts';
...
/* harmony import */ var _InitPageBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./InitPageBase */ "./src/ts/modules/InitPageBase.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _utils_CreateCSV__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/CreateCSV */ "./src/ts/modules/utils/CreateCSV.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class InitFollowingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_下载用户列表')).addEventListener('click', () => {
    ...
    readyGet() {
        ...
        // 获取抓取开始时的页码
        const nowPage = _Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].getURLSearchField(location.href, 'p');
        // 计算开始抓取时的偏移量
        if (nowPage !== '') {
    ...
    async getUserList() {
        ...
        try {
            switch (this.pageType) {
                case 0:
                    res = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getFollowingList(this.myId, this.rest, offset);
                    break;
                case 1:
                    res = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getMyPixivList(this.myId, offset);
                    break;
                case 2:
                    res = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getFollowersList(this.myId, offset);
                    break;
            }
        }
        catch (_a) {
    ...
    toCSV() {
        ...
        _Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].downloadFile(csvURL, _Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].replaceUnsafeStr(csvName) + '.csv');
    }
    // 获取用户的 id 列表
    async getIdList() {
        let idList = [];
        try {
            idList = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByType(this.userList[this.index]);
        }
        catch (_a) {
            this.getIdList();
            return;
    ...
    sortResult() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_5__["store"].result.sort(_Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].sortByProperty('id'));
    }
}
...
class InitHomePage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        super();
    ...
    addCrawlBtns() {
        this.downIdButton = _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_输入id进行抓取'), [['id', 'down_id_button']]);
    }
    addAnyElement() {
        // 用于输入id的输入框
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_清空已保存的抓取结果')).addEventListener('click', () => {
    ...
    initAny() {
        ...
        this.downIdInput.addEventListener('change', () => {
            if (this.downIdInput.value !== '') {
                this.ready = true;
                window.setTimeout(() => {
                    _EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].list.openCenterPanel);
                }, 300);
    ...
    checkIdList() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_5__["EVT"].list.downloadIdList, idList);
    }
    destroy() {
...
/* harmony import */ var _artwork_InitArtworkSeriesPage__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./artwork/InitArtworkSeriesPage */ "./src/ts/modules/artwork/InitArtworkSeriesPage.ts");
...
class InitPage {
    ...
    initPage() {
        switch (_PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].type) {
            ...
            case _PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].list.ArtworkSerach:
            ...
            case _PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].list.ArtworkSeries:
                return new _artwork_InitArtworkSeriesPage__WEBPACK_IMPORTED_MODULE_21__["InitArtworkSeriesPage"]();
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Store */ "./src/ts/modules/Store.ts");
...
/* harmony import */ var _VipSearchOptimize__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./VipSearchOptimize */ "./src/ts/modules/VipSearchOptimize.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./MsgBox */ "./src/ts/modules/MsgBox.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
// 初始化所有页面抓取流程的基类
...
class InitPageBase {
    ...
    init() {
        ...
        // 监听下载 id 列表的事件
        _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].bindOnce('downloadIdList', _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.downloadIdList, (ev) => {
    ...
    // 添加抓取区域的按钮
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_开始抓取'), [
    ...
    checkWantPageInput(crawlPartTip, crawlAllTip) {
        const temp = _setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage;
        // 如果比 1 小，并且不是 -1，则不通过
        ...
        if (temp >= 1) {
            _Log__WEBPACK_IMPORTED_MODULE_5__["log"].warning(crawlPartTip.replace('{}', temp.toString()));
        }
        else if (temp === -1) {
    ...
    checkWantPageInputGreater0(max, page) {
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage > 0) {
            const want = _setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage > max ? max : _setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage;
            if (page) {
                _Log__WEBPACK_IMPORTED_MODULE_5__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_从本页开始下载x页', want.toString()));
            }
            else {
                _Log__WEBPACK_IMPORTED_MODULE_5__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_从本页开始下载x个', want.toString()));
            }
            return want;
        }
        else {
    ...
    async readyCrawl() {
        ...
        if (_Tools__WEBPACK_IMPORTED_MODULE_18__["Tools"].isPixiv()) {
    ...
    getIdListFinished() {
        ...
        if (_Store__WEBPACK_IMPORTED_MODULE_4__["store"].idList.length <= this.ajaxThreadsDefault) {
            this.ajaxThread = _Store__WEBPACK_IMPORTED_MODULE_4__["store"].idList.length;
        }
        else {
    ...
    async getWorksData(idData) {
        ...
        try {
            if (idData.type === 'novels') {
                const data = await _utils_API__WEBPACK_IMPORTED_MODULE_3__["API"].getNovelData(id);
                await _novel_SaveNovelData__WEBPACK_IMPORTED_MODULE_11__["saveNovelData"].save(data);
                this.afterGetWorksData(data);
            }
            else {
                const data = await _utils_API__WEBPACK_IMPORTED_MODULE_3__["API"].getArtworkData(id);
    ...
    async afterGetWorksData(data) {
        ...
        if (data && (await _VipSearchOptimize__WEBPACK_IMPORTED_MODULE_15__["vipSearchOptimize"].stopCrawl(data, this.ajaxThread))) {
            // 指示抓取已停止
...
class InitPixivisionPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        ...
        if (type === 'illustration' || type === 'manga' || type === 'cosplay') {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取该页面的图片')).addEventListener('click', () => {
                this.readyCrawl();
            }, false);
        }
    }
...
/* harmony import */ var _SaveAvatarImage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./SaveAvatarImage */ "./src/ts/modules/SaveAvatarImage.ts");
/* harmony import */ var _SaveUserCover__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SaveUserCover */ "./src/ts/modules/SaveUserCover.ts");
...
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
// 初始化用户页面
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_13__["BookmarkAllWorks"]();
        this.sendBookmarkIdList = () => {
            if (_States__WEBPACK_IMPORTED_MODULE_9__["states"].bookmarkMode) {
                // 将 id 的 type 设置为 illusts 或 novels
                const list = [];
                for (const data of _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList) {
                    if (data.type === 'novels') {
                        list.push(data);
                    }
                    else {
    ...
    // 添加中间按钮
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    addAnyElement() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveAvatarImage);
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户封面')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveUserCover);
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像为图标'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像为图标说明')]]).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveAvatarIcon);
        });
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
        ...
        bookmarkAllBtn.addEventListener('click', async () => {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.bookmarkModeStart);
            _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag = _Tools__WEBPACK_IMPORTED_MODULE_14__["Tools"].getTagFromURL();
    ...
    readyGetIdList() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag ? this.getIdListByTag() : this.getIdList();
    }
    getOffset() {
        const nowPage = _Tools__WEBPACK_IMPORTED_MODULE_14__["Tools"].getURLSearchField(location.href, 'p'); // 判断当前处于第几页，页码从 1 开始。也可能没有页码
        let offset = 0;
        if (nowPage) {
    ...
    async getIdList() {
        ...
        let idList = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type);
        ...
        idList.sort(_Tools__WEBPACK_IMPORTED_MODULE_14__["Tools"].sortByProperty('id')).reverse();
    ...
    async getIdListByTag() {
        ...
        const offset = this.getOffset();
        const requsetNumber = this.getRequsetNumber();
        let data = await _utils_API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByTypeWithTag(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), flag, _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag, offset, requsetNumber);
    ...
    sortResult() {
        // 把作品数据按 id 倒序排列，id 大的在前面，这样可以先下载最新作品，后下载早期作品
        _Store__WEBPACK_IMPORTED_MODULE_5__["store"].result.sort(_Tools__WEBPACK_IMPORTED_MODULE_14__["Tools"].sortByProperty('id'));
    }
    destroy() {
...
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
...
const langText = {
    ...
    _已收藏: ['已收藏', '已收藏', 'Bookmarked', 'ブックマーク'],
    ...
    _收藏设置: ['收藏设置', '收藏設定', 'Bookmark settings', 'ブックマーク設定 '],
    ...
    listenPageSwitch() {
        ...
        ['pushState', 'popstate', 'replaceState'].forEach((item) => {
            window.addEventListener(item, () => {
                _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.pageSwitch);
            });
        });
    }
}
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _Theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Theme */ "./src/ts/modules/Theme.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
...
/* harmony import */ var _Token__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Token */ "./src/ts/modules/Token.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
// 作品页面内的快速收藏功能
...
class QuickBookmark {
    ...
    async getWorkData() {
        const id = this.isNovel ? _Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].getNovelId() : _Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].getIllustId();
        return this.isNovel
            ? await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getNovelData(id)
            : await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getArtworkData(id);
    }
    async addBookmark() {
        ...
        // 添加收藏
        _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(type, id, tags, _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].restrict === 'yes', _Token__WEBPACK_IMPORTED_MODULE_3__["token"].token)
    ...
    // 点赞这个作品
    like(type, id) {
        _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].addLike(id, type, _Token__WEBPACK_IMPORTED_MODULE_3__["token"].token);
    ...
    getEditBookmarkLink() {
        if (this.isNovel) {
            return `/novel/bookmark_add.php?id=${_Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].getNovelId()}`;
        }
        else {
            return `/bookmark_add.php?type=illust&illust_id=${_Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].getIllustId()}`;
        }
    }
    // 如果这个作品已收藏，则改变快速收藏按钮
    bookmarked() {
...
/***/ "./src/ts/modules/QuickDownload.ts":
/*!*****************************************!*\
  !*** ./src/ts/modules/QuickDownload.ts ***!
  \*****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "quickDownload", function() { return quickDownload; });
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _PageType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./States */ "./src/ts/modules/States.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class QuickDownload {
    ...
    sendDownload() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.downloadIdList, [idData]);
    }
    setVisible() {
...
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./MsgBox */ "./src/ts/modules/MsgBox.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class Resume {
    ...
    async restoreData() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_3__["store"].crawlCompleteTime = meta.date;
        // 恢复模式就绪
        this.flag = true;
        ...
        for (const ev of evs) {
            window.addEventListener(ev, async () => {
                ...
                const metaData = {
                    ...
                    date: _Store__WEBPACK_IMPORTED_MODULE_3__["store"].crawlCompleteTime,
                };
...
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class SaveAvatarIcon {
    ...
    async saveAvatarIcon() {
        ...
        const userProfile = await _utils_API__WEBPACK_IMPORTED_MODULE_1__["API"].getUserProfile(userId);
        ...
        _Tools__WEBPACK_IMPORTED_MODULE_6__["Tools"].downloadFile(url, name);
...
/***/ "./src/ts/modules/SaveAvatarImage.ts":
/*!*******************************************!*\
  !*** ./src/ts/modules/SaveAvatarImage.ts ***!
  \*******************************************/
/*! no exports provided */
...
class SaveAvatarImage {
    ...
    async saveAvatarImage() {
        ...
        _Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].downloadFile(url, name);
...
/***/ "./src/ts/modules/SaveUserCover.ts":
/*!*****************************************!*\
  !*** ./src/ts/modules/SaveUserCover.ts ***!
  \*****************************************/
/*! no exports provided */
...
class SelectWork {
    ...
    addBtn() {
        this.controlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_手动选择作品'));
        this.updateControlBtn();
        this.clearBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_清空选择的作品'));
        this.clearBtn.style.display = 'none';
        this.clearBtn.addEventListener('click', () => {
            this.clearIdList();
        });
        this.crawlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取选择的作品'));
...
/***/ "./src/ts/modules/ShowHowToUse.ts":
/*!****************************************!*\
  !*** ./src/ts/modules/ShowHowToUse.ts ***!
  \****************************************/
/*! no exports provided */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _config_Config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/Config */ "./src/ts/modules/config/Config.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MsgBox */ "./src/ts/modules/MsgBox.ts");
...
class ShowHowToUse {
    ...
    show() {
        _MsgBox__WEBPACK_IMPORTED_MODULE_2__["msgBox"].show(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_HowToUse'), {
            title: _config_Config__WEBPACK_IMPORTED_MODULE_1__["default"].name,
...
class ShowWhatIsNew {
    constructor() {
        this.flag = 'xzNew920';
        this.msg = _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_新增设置项') + ': <br>' + _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_背景图片');
        this.storeName = 'xzNewVerTag';
        this.show();
    }
    show() {
        const value = localStorage.getItem(this.storeName);
        if (_Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].isPixiv() && value !== this.flag) {
            _MsgBox__WEBPACK_IMPORTED_MODULE_2__["msgBox"].show(this.msg, {
                title: _config_Config__WEBPACK_IMPORTED_MODULE_1__["default"].name + ` ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_最近更新')}`,
                btn: _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_我知道了'),
            });
...
class Store {
    ...
    addResult(data) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.addResult, result);
        if (result.type === 3) {
    ...
    reset() {
        ...
        this.title = _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].getTitle();
    }
    bindEvents() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.crawlStart, () => {
            this.reset();
...
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/Colors */ "./src/ts/modules/config/Colors.ts");
...
/* harmony import */ var _PageType__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _ImageViewer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ImageViewer */ "./src/ts/modules/ImageViewer.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class ViewBigImage {
  ...
  <use xlink:href="#icon-fangda"></use>
    ...
    findWorkId(el) {
        ...
        const href = a.href;
        return _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].getIllustId(href);
    }
    // 显示放大按钮
    showBtn(target) {
        ...
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].magnifier) {
            return;
        }
        window.clearTimeout(this.hiddenBtnTimer);
...
/***/ "./src/ts/modules/VipSearchOptimize.ts":
/*!*********************************************!*\
  !*** ./src/ts/modules/VipSearchOptimize.ts ***!
  \*********************************************/
...
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class VipSearchOptimize {
    constructor() {
        // 在哪些页面上启用
        this.enablePageType = [_PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].list.ArtworkSerach];
    ...
    setVipOptimize() {
        ...
        // 判断 order 方式
        const order = _Tools__WEBPACK_IMPORTED_MODULE_4__["Tools"].getURLSearchField(window.location.href, 'order');
        // 无排序方式
        if (!order) {
            return false;
        }
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _setting_Options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../setting/Options */ "./src/ts/modules/setting/Options.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
...
class InitAreaRankingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() { }
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取本页作品'), [
    ...
    async getIdList() {
        ...
        for (const el of allPicArea) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_5__["filter"].check(filterOpt)) {
                const id = _Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].getIllustId(el.querySelector('a').href);
...
/* harmony import */ var _ImageViewer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../ImageViewer */ "./src/ts/modules/ImageViewer.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
...
class InitArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_从本页开始抓取new')).addEventListener('click', () => {
            this.crawlDirection = -1;
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_从本页开始抓取old')).addEventListener('click', () => {
            this.crawlDirection = 1;
            this.readyCrawl();
        });
        const downRelatedBtn = _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取相关作品'));
    ...
    async getIdList() {
        ...
        let idList = await _utils_API__WEBPACK_IMPORTED_MODULE_9__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type);
        // 储存符合条件的 id
        let nowId = parseInt(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getIllustId(window.location.href));
        idList.forEach((id) => {
        ...
        if (this.crawlNumber !== -1) {
            ...
            if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.sort(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].sortByProperty('id')).reverse();
            }
            else {
                // 旧作品 降序排列
                _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.sort(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].sortByProperty('id'));
            }
    ...
    async getRelatedList() {
        let data = await _utils_API__WEBPACK_IMPORTED_MODULE_9__["API"].getRelatedData(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getIllustId());
...
/* harmony import */ var _InitPageBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../InitPageBase */ "./src/ts/modules/InitPageBase.ts");
/* harmony import */ var _config_Colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/Colors */ "./src/ts/modules/config/Colors.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _setting_Options__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../setting/Options */ "./src/ts/modules/setting/Options.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
// 初始化插画/漫画的系列作品页面
...
class InitArtworkSeriesPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        super();
        this.seriesId = '';
        this.init();
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    nextStep() {
        // 设置起始页码
        const p = _Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 获取系列 id
        this.seriesId = _utils_API__WEBPACK_IMPORTED_MODULE_2__["API"].getURLPathField('series');
        this.getIdList();
    }
    async getIdList() {
        let p = this.startpageNo + this.listPageFinished;
        const data = await _utils_API__WEBPACK_IMPORTED_MODULE_2__["API"].getSeriesData(this.seriesId, p);
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _setting_Options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../setting/Options */ "./src/ts/modules/setting/Options.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
...
class InitBookmarkDetailPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取相似图片'), [
    ...
    // 获取相似的作品列表
    async getIdList() {
        let data = await _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getRecommenderData(_Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].getIllustId(), this.crawlNumber);
...
/* harmony import */ var _setting_Options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../setting/Options */ "./src/ts/modules/setting/Options.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
...
class InitBookmarkNewArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    async getIdList() {
        ...
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_6__["API"].getBookmarkNewIllustData(p, this.r18);
        }
        catch (error) {
            this.getIdList();
            return;
        ...
        for (const data of worksData) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_5__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.push({
                    type: _utils_API__WEBPACK_IMPORTED_MODULE_6__["API"].getWorkType(data.illustType),
                    id: data.illustId,
                });
            }
        }
...
class InitDiscoverPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取当前作品'), [
    ...
    getIdList() {
        ...
        Array.from(nowIllust).forEach((el) => {
            ...
            const id = _Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].getIllustId(el.href.split('&uarea')[0]);
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push({
                type: 'unknown',
                id,
            });
...
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _setting_Options__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../setting/Options */ "./src/ts/modules/setting/Options.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
...
class InitNewArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getNewIllustData(this.option);
        }
        catch (error) {
            this.getIdList();
            return;
        ...
        for (const nowData of useData) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_4__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push({
                    type: _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getWorkType(nowData.illustType),
                    id: nowData.id,
                });
            }
        }
...
class InitRankingArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取本排行榜作品'), [
        ...
        const mode = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'mode');
        if (debutModes.includes(mode)) {
            _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取首次登场的作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取首次登场的作品Title')]]).addEventListener('click', () => {
    ...
    nextStep() {
        ...
        this.option = this.resetOption();
        this.option.mode = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'mode') || 'daily';
        this.option.worksType = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'content');
        this.option.date = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'date');
        this.startpageNo = 1;
        this.setPartNum();
        this.getIdList();
    }
    async getIdList() {
        ...
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_2__["API"].getRankingData(this.option);
        }
        catch (error) {
            if (error.status === 404) {
        ...
        for (const data of contents) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_7__["filter"].check(filterOpt)) {
                ...
                _Store__WEBPACK_IMPORTED_MODULE_8__["store"].idList.push({
                    type: _utils_API__WEBPACK_IMPORTED_MODULE_2__["API"].getWorkType(data.illust_type),
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../setting/Settings */ "./src/ts/modules/setting/Settings.ts");
...
/* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../FastScreen */ "./src/ts/modules/FastScreen.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../BookmarkAllWorks */ "./src/ts/modules/BookmarkAllWorks.ts");
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../States */ "./src/ts/modules/States.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
/* harmony import */ var _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../IdListWithPageNo */ "./src/ts/modules/IdListWithPageNo.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../MsgBox */ "./src/ts/modules/MsgBox.ts");
// 初始化 artwork 搜索页
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.onSettingChange = (event) => {
            ...
            if (this.causeResultChange.includes(data.name)) {
                if (_Store__WEBPACK_IMPORTED_MODULE_9__["store"].result.length > 0) {
                    this.reAddResult();
                    _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.resultChange);
                }
            }
        };
        ...
        this.onCrawlFinish = () => {
            ...
            this.reAddResult();
            // 解绑创建作品元素的事件
            window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.addResult, this.createWork);
            setTimeout(() => {
                _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.worksUpdate);
            }, 0);
        };
        // 显示抓取到的作品数量
        this.showCount = () => {
        ...
        this.createWork = (event) => {
            if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].previewResult || !this.worksWrap) {
                return;
            }
            const data = event.detail.data;
            let r18Text = '';
    ...
    `;
        ...
        this.addBookmark = (event) => {
            const data = event.detail.data;
            _utils_API__WEBPACK_IMPORTED_MODULE_8__["API"].addBookmark('illusts', data.id.toString(), _setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].widthTag === 'yes' ? data.tags : [], _setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].restrict === 'yes', _Token__WEBPACK_IMPORTED_MODULE_3__["token"].token);
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始筛选'), [
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_在结果中筛选'), [
    ...
    addAnyElement() {
        ...
        deleteWorks.addClearMultipleBtn(`.${this.multipleClass}`, () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.clearMultiple);
        });
        deleteWorks.addClearUgoiraBtn(`.${this.ugoiraClass}`, () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.clearUgoira);
        });
        ...
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
    ...
    initAny() {
        this.hotBar();
        this.setNotAutoDownload();
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.addResult, this.showCount);
        window.addEventListener('addBMK', this.addBookmark);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.crawlFinish, this.onCrawlFinish);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.clearMultiple, this.clearMultiple);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.clearUgoira, this.clearUgoira);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.deleteWork, this.deleteWork);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.settingChange, this.onSettingChange);
    }
    destroy() {
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].clearSlot('crawlBtns');
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].clearSlot('otherBtns');
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.addResult, this.showCount);
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.crawlFinish, this.onCrawlFinish);
        // 离开下载页面时，取消设置“不自动下载”
        _States__WEBPACK_IMPORTED_MODULE_16__["states"].notAutoDownload = false;
    }
    getWantPage() {
        this.crawlNumber = this.checkWantPageInput(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_从本页开始下载x页'), _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_下载所有页面'));
    ...
    async nextStep() {
        ...
        if (this.startpageNo > 1000) {
            _MsgBox__WEBPACK_IMPORTED_MODULE_20__["msgBox"].error(`${_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_超出最大页码')} ${this.maxCount}`);
            return this.noResult();
        }
    ...
    initFetchURL() {
        ...
        */
        ...
        let p = _Tools__WEBPACK_IMPORTED_MODULE_17__["Tools"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 从页面 url 中获取可以使用的选项
        this.option = {};
        this.allOption.forEach((param) => {
            let value = _Tools__WEBPACK_IMPORTED_MODULE_17__["Tools"].getURLSearchField(location.href, param);
            if (value !== '') {
    ...
    async getSearchData(p) {
        let data = await _utils_API__WEBPACK_IMPORTED_MODULE_8__["API"].getSearchData(_Store__WEBPACK_IMPORTED_MODULE_9__["store"].tag, this.worksType, p, this.option);
    ...
    async getIdList(p) {
        ...
        for (const nowData of data) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_7__["filter"].check(filterOpt)) {
                _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_18__["idListWithPageNo"].add(this.flag, {
                    type: _utils_API__WEBPACK_IMPORTED_MODULE_8__["API"].getWorkType(nowData.illustType),
                    id: nowData.id,
                }, p);
            }
        }
        ...
        if (this.sendCrawlTaskCount + 1 <= this.needCrawlPageCount) {
            ...
            if (this.listPageFinished === this.needCrawlPageCount) {
                ...
                _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_18__["idListWithPageNo"].store(this.flag);
                this.getIdListFinished();
            }
        }
    }
    ...
    sortResult() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_9__["store"].result.sort(_Tools__WEBPACK_IMPORTED_MODULE_17__["Tools"].sortByProperty('bmk'));
    }
    setNotAutoDownload() {
        // 如果设置了“预览搜索结果”，则不启用自动下载
        _States__WEBPACK_IMPORTED_MODULE_16__["states"].notAutoDownload = _setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].previewResult ? true : false;
    }
    // 返回包含作品列表的 ul 元素
    getWorksWrap() {
    ...
    async filterResult(callback) {
        if (this.resultMeta.length === 0) {
            _Toast__WEBPACK_IMPORTED_MODULE_19__["toast"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_没有数据可供使用'));
            return;
        }
    ...
    reAddResult() {
        ...
        for (let data of this.resultMeta) {
            ...
            const dlCount = _setting_SettingAPI__WEBPACK_IMPORTED_MODULE_12__["settingAPI"].getDLCount(data.pageCount);
    ...
    screenInResult() {
        if (_States__WEBPACK_IMPORTED_MODULE_16__["states"].busy) {
            _Toast__WEBPACK_IMPORTED_MODULE_19__["toast"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_当前任务尚未完成'));
            return;
        }
        _Log__WEBPACK_IMPORTED_MODULE_10__["log"].clear();
        this.getMultipleSetting();
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../setting/Settings */ "./src/ts/modules/setting/Settings.ts");
...
class SaveArtworkData {
    async save(data) {
        ...
        const tags = []; // 保存 tag 列表
        let tagsWithTransl = []; // 保存 tag 列表，附带翻译后的 tag
        let tagsTranslOnly = []; // 保存翻译后的 tag 列表
        for (const tagData of tagArr) {
            tags.push(tagData.tag);
        ...
        if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_1__["filter"].check(filterOpt)) {
            ...
            if (body.illustType !== 2) {
                // 插画或漫画
                // 下载该作品的前面几张
                const dlCount = _setting_SettingAPI__WEBPACK_IMPORTED_MODULE_3__["settingAPI"].getDLCount(body.pageCount);
                ...
                // 动图
                // 获取动图的信息
                const meta = await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getUgoiraMeta(body.id);
                // 动图帧延迟数据
                const ugoiraInfo = {
                    frames: meta.body.frames,
                    mime_type: meta.body.mime_type,
                };
                const ext = _setting_Settings__WEBPACK_IMPORTED_MODULE_2__["settings"].ugoiraSaveAs;
                _Store__WEBPACK_IMPORTED_MODULE_4__["store"].addResult({
                    id: body.id,
                    idNum: idNum,
                    thumb: thumb,
...
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../MsgBox */ "./src/ts/modules/MsgBox.ts");
...
class BlockTagsForSpecificUser {
  ...
  `;
    ...
    async updateUserName(data) {
        const profile = await _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getUserProfile(data.uid.toString()).catch((err) => {
            console.log(err);
        });
    ...
    checkValue(uidInput, tagsInput) {
        const tags = _Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].string2array(tagsInput);
...
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../States */ "./src/ts/modules/States.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _BlackandWhiteImage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BlackandWhiteImage */ "./src/ts/modules/filter/BlackandWhiteImage.ts");
/* harmony import */ var _Mute__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Mute */ "./src/ts/modules/filter/Mute.ts");
/* harmony import */ var _BlockTagsForSpecificUser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./BlockTagsForSpecificUser */ "./src/ts/modules/filter/BlockTagsForSpecificUser.ts");
/* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../MsgBox */ "./src/ts/modules/MsgBox.ts");
...
class Filter {
    ...
    checkExcludeTag(tags) {
        ...
        let result = true;
        const notNeedTags = _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].notNeedTag.map((val) => {
            return val.toLowerCase();
        });
        // 如果设置了排除 tag
    ...
    checkDebut(yes_rank) {
        if (!_States__WEBPACK_IMPORTED_MODULE_3__["states"].debut || yes_rank === undefined) {
            return true;
        }
        return yes_rank === 0;
    }
    ...
    // 如果设置项的值不合法，则显示提示
    showWarning(msg) {
        _EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].list.wrongSetting);
...
class Mute {
    ...
    async getMuteSettings() {
        this.userList = [];
        this.tagList = [];
        const response = await _utils_API__WEBPACK_IMPORTED_MODULE_0__["API"].getMuteSettings();
...
class InitBookmarkNewNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    getPageUrl() {
        // 设置起始页面
        const p = _Tools__WEBPACK_IMPORTED_MODULE_8__["Tools"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
...
class InitNewNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        let data;
        try {
            data = await _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getNewNovleData(this.option);
        }
        catch (error) {
            this.getIdList();
            return;
...
/* harmony import */ var _utils_API__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/API */ "./src/ts/modules/utils/API.ts");
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
//初始化小说作品页
...
class InitNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    */
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_6__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_从本页开始抓取new')).addEventListener('click', () => {
            this.crawlDirection = -1;
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_6__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_从本页开始抓取old')).addEventListener('click', () => {
            this.crawlDirection = 1;
            this.readyCrawl();
        });
    }
    ...
    async getIdList() {
        let type = ['novels'];
        let idList = await _utils_API__WEBPACK_IMPORTED_MODULE_7__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_6__["DOM"].getUserId(), type);
        // 储存符合条件的 id
        let nowId = parseInt(_Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].getIllustId(window.location.href));
        idList.forEach((id) => {
            let idNum = parseInt(id.id);
            // 新作品
            if (idNum >= nowId && this.crawlDirection === -1) {
        ...
        if (this.crawlNumber !== -1) {
            // 新作品 升序排列
            if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_4__["store"].idList.sort(_Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].sortByProperty('id')).reverse();
            }
            else {
                // 旧作品 降序排列
                _Store__WEBPACK_IMPORTED_MODULE_4__["store"].idList.sort(_Tools__WEBPACK_IMPORTED_MODULE_9__["Tools"].sortByProperty('id'));
            }
...
class InitNovelSeriesPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_5__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取系列小说')).addEventListener('click', () => {
            this.readyCrawl();
        });
    }
    initAny() { }
    ...
    getWantPage() { }
    nextStep() {
        this.seriesId = _utils_API__WEBPACK_IMPORTED_MODULE_6__["API"].getURLPathField('series');
        this.getIdList();
    }
    async getIdList() {
        const seriesData = await _utils_API__WEBPACK_IMPORTED_MODULE_6__["API"].getNovelSeriesData(this.seriesId, this.limit, this.last, 'asc');
...
class InitRankingNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取本排行榜作品'), [
...
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../FastScreen */ "./src/ts/modules/FastScreen.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../BookmarkAllWorks */ "./src/ts/modules/BookmarkAllWorks.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
/* harmony import */ var _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../IdListWithPageNo */ "./src/ts/modules/IdListWithPageNo.ts");
// 初始化小说搜索页
...
class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    addAnyElement() {
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
    ...
    // 获取搜索页的数据。因为有多处使用，所以进行了封装
    async getSearchData(p) {
        let data = await _utils_API__WEBPACK_IMPORTED_MODULE_5__["API"].getNovelSearchData(_Store__WEBPACK_IMPORTED_MODULE_6__["store"].tag, p, this.option);
        return data.body.novel;
    }
    // 组织要请求的 url 中的参数
    initFetchURL() {
        let p = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 从页面 url 中获取可以使用的选项
        this.option = {};
        this.allOption.forEach((param) => {
            let value = _Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getURLSearchField(location.href, param);
            if (value !== '') {
                this.option[param] = value;
            }
        });
    ...
    async getIdList(p) {
        ...
        for (const nowData of data) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_4__["filter"].check(filterOpt)) {
                _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_12__["idListWithPageNo"].add(this.flag, {
                    type: 'novels',
                    id: nowData.id,
                }, p);
            }
        ...
        if (this.sendCrawlTaskCount + 1 <= this.needCrawlPageCount) {
            ...
            if (this.listPageFinished === this.needCrawlPageCount) {
                // 抓取任务全部完成
                _Log__WEBPACK_IMPORTED_MODULE_7__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_列表页抓取完成'));
                _IdListWithPageNo__WEBPACK_IMPORTED_MODULE_12__["idListWithPageNo"].store(this.flag);
                this.getIdListFinished();
            }
        }
    }
    ...
    // 搜索页把下载任务按收藏数从高到低下载
    sortResult() {
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].resultMeta.sort(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].sortByProperty('bmk'));
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.sort(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].sortByProperty('bmk'));
    }
}
...
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Tools */ "./src/ts/modules/Tools.ts");
    ...
    make(data, saveMeta = true) {
        return new Promise((resolve, reject) => {
            ...
            new EpubMaker()
                ...
                .withAuthor(_Tools__WEBPACK_IMPORTED_MODULE_0__["Tools"].replaceUnsafeStr(data.userName))
                ...
                .withTitle(_Tools__WEBPACK_IMPORTED_MODULE_0__["Tools"].replaceUnsafeStr(data.title))
...
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _MakeEPUB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MakeEPUB */ "./src/ts/modules/novel/MakeEPUB.ts");
...
/* harmony import */ var _filter_Filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../filter/Filter */ "./src/ts/modules/filter/Filter.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../setting/Settings */ "./src/ts/modules/setting/Settings.ts");
...
class OutputPanel {
    ...
    output(content, title = _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_输出信息')) {
        ...
        if (_Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length > _config_Config__WEBPACK_IMPORTED_MODULE_4__["default"].outputMax) {
            ...
            _Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].downloadFile(url, fileName);
            // 禁用复制按钮
...
class PreviewFileName {
    ...
    previewFileName() {
        ...
        // 使用数组储存和拼接字符串，提高性能
        const resultArr = [];
        const length = _Store__WEBPACK_IMPORTED_MODULE_0__["store"].result.length;
        for (let i = 0; i < length; i++) {
            const data = _Store__WEBPACK_IMPORTED_MODULE_0__["store"].result[i];
            ...
            if (length < _config_Config__WEBPACK_IMPORTED_MODULE_4__["default"].outputMax) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.output, {
            content: result,
...
class ShowURLs {
    ...
    showURLs() {
        if (_Store__WEBPACK_IMPORTED_MODULE_0__["store"].result.length === 0) {
            _Toast__WEBPACK_IMPORTED_MODULE_4__["toast"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_没有数据可供使用'));
            return;
        }
        const urls = [];
        const size = _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].imageSize;
        for (const result of _Store__WEBPACK_IMPORTED_MODULE_0__["store"].result) {
...
/***/ "./src/ts/modules/setting/ConvertOldSettings.ts":
/*!******************************************************!*\
  !*** ./src/ts/modules/setting/ConvertOldSettings.ts ***!
  \******************************************************/
...
class Form {
    ...
    bindEvents() {
        ...
        // 预览文件名
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('namingBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_预览文件名')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.previewFileName);
        }, false);
        // 导出 csv
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('exportResult', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导出csv')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.outputCSV);
        }, false);
        // 导出抓取结果
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('exportResult', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导出抓取结果')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.exportResult);
        }, false);
        // 导入抓取结果
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('exportResult', _config_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导入抓取结果')).addEventListener('click', () => {
        ...
        // 重置设置按钮
        {
            ...
            if (el) {
                el.addEventListener('click', () => {
                    ...
                    if (result) {
                        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.resetSettings);
                    }
                });
            }
        }
        // 导出设置按钮
        {
            ...
            if (el) {
                el.addEventListener('click', () => {
                    _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.exportSettings);
                });
            }
        }
        // 导入设置按钮
        {
            ...
            if (el) {
                el.addEventListener('click', () => {
                    _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.importSettings);
                });
            }
        }
        // 显示命名字段提示
        ...
        this.form
            ...
            .addEventListener('click', () => _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].toggleEl(document.querySelector('.dateFormatTip')));
...
const formHtml = `<form class="settingForm">
    <div class="tabsContnet">
      ...
      <span class="has_tip settingNameStyle1" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_下载前几张图片提示') + ', ' + _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_必须大于0')}" >${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_多图下载设置')}<span class="gray1"> ? </span></span>
      ...
      ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_下载前几张图片')}&nbsp;
      ...
      <span>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_最小值')}&nbsp;</span>
      <input type="text" name="BMKNumMin" class="setinput_style1 blue bmkNum" value="0">
      <span>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_最大值')}&nbsp;</span>
      ...
      <span class="beautify_radio"></span>
      <label for="idRange1">  ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_大于')}&nbsp; </label>
      <input type="radio" name="idRange" id="idRange2" class="need_beautify radio" value="<">
      <span class="beautify_radio"></span>
      <label for="idRange2">  ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_小于')}&nbsp; </label>
    ...
    <p class="option" data-no="13">
      <span class="has_tip settingNameStyle1" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_设置文件夹名的提示') + '<br>' + '{user}/{id}'}">${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_命名规则')}<span class="gray1"> ? </span></span>
      ...
      ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_命名标记type')} ${_config_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName.join(', ')}
      <br>
      ...
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeIllust" class="has_tip" data-tip="${_config_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[0]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_插画')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeManga" id="createFolderByTypeManga" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeManga" class="has_tip" data-tip="${_config_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[1]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_漫画')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeUgoira" id="createFolderByTypeUgoira" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeUgoira" class="has_tip" data-tip="${_config_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[2]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_动图')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeNovel" id="createFolderByTypeNovel" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeNovel" class="has_tip" data-tip="${_config_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[3]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_小说')}&nbsp;</label>
      </span>
      </p>
      ...
      <span>&nbsp;</span>
      <span>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_目录名使用')}</span>
      ...
      <span class="beautify_radio"></span>
      <label for="workDirName2"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_命名规则')}&nbsp; </label>
      </span>
      </p>
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _PageType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _DateFormat__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../DateFormat */ "./src/ts/modules/DateFormat.ts");
...
class FormSettings {
    ...
    restoreDate(name) {
        if (_Settings__WEBPACK_IMPORTED_MODULE_2__["settings"][name] !== undefined) {
            ...
            this.form[name].value = _DateFormat__WEBPACK_IMPORTED_MODULE_3__["DateFormat"].format(date, 'YYYY-MM-DDThh:mm');
        }
    }
    // 从设置里恢复当前页面的页数/个数
    restoreWantPage() {
...
/* harmony import */ var _SecretSignal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../SecretSignal */ "./src/ts/modules/SecretSignal.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Toast */ "./src/ts/modules/Toast.ts");
...
class InvisibleSettings {
    ...
    register() {
        for (const item of this.list) {
            _SecretSignal__WEBPACK_IMPORTED_MODULE_1__["secretSignal"].register(item.code, () => {
  ...
  <ul class="namingRuleList"></ul>
    ...
    add(rule) {
        ...
        if (!_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].namingRuleList.includes(rule)) {
            const list = Array.from(_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].namingRuleList);
            list.push(rule);
            Object(_Settings__WEBPACK_IMPORTED_MODULE_5__["setSetting"])('namingRuleList', list);
        }
        // 显示提示
        _Log__WEBPACK_IMPORTED_MODULE_3__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_已保存命名规则'));
        _Toast__WEBPACK_IMPORTED_MODULE_6__["toast"].success(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_已保存命名规则'));
    }
    delete(index) {
        const list = Array.from(_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].namingRuleList);
        list.splice(index, 1);
...
/* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Toast */ "./src/ts/modules/Toast.ts");
/* harmony import */ var _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/Json2Blob */ "./src/ts/modules/utils/Json2Blob.ts");
...
class Settings {
    constructor() {
        ...
        // 以默认设置作为初始设置
        this.settings = _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].deepCopy(this.defaultSettings);
        this.restore();
        this.bindEvents();
    }
    bindEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.settingChange, () => {
            localStorage.setItem(_config_Config__WEBPACK_IMPORTED_MODULE_4__["default"].settingStoreName, JSON.stringify(this.settings));
        });
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.resetSettings, () => {
            this.reset();
        });
    ...
    restore() {
        ...
        const savedSettings = localStorage.getItem(_config_Config__WEBPACK_IMPORTED_MODULE_4__["default"].settingStoreName);
        if (savedSettings) {
    ...
    assignSettings(data) {
        const origin = _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].deepCopy(data);
        for (const [key, value] of Object.entries(origin)) {
            this.setSetting(key, value);
        }
    }
    exportSettings() {
        const blob = _utils_Json2Blob__WEBPACK_IMPORTED_MODULE_7__["Json2Blob"].convert(this.settings);
        const url = URL.createObjectURL(blob);
        _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].downloadFile(url, _config_Config__WEBPACK_IMPORTED_MODULE_4__["default"].name + ` Settings.json`);
    }
    async importSettings() {
        const loadedJSON = (await _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].loadJSONFile().catch((err) => {
    ...
    reset(data) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.resetSettingsEnd);
    }
    tipError(key) {
    ...
    setSetting(key, value) {
        ...
        if (Array.isArray(this.defaultSettings[key])) {
            if (this.stringArrayKey.includes(key)) {
                // 字符串转换成 string[]
                if (valueType === 'string') {
                    value = _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].string2array(value);
                }
            }
        ...
        // 触发设置变化的事件
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.settingChange, { name: key, value: value });
    }
}
...
class CheckNew {
    ...
    async checkNew() {
        ...
        if (this.bigger(latestVer, manifestVer)) {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.hasNewVer);
        }
    }
...
/* harmony import */ var _ToWebM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ToWebM */ "./src/ts/modules/ugoira/ToWebM.ts");
/* harmony import */ var _ToGIF__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ToGIF */ "./src/ts/modules/ugoira/ToGIF.ts");
/* harmony import */ var _ToAPNG__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ToAPNG */ "./src/ts/modules/ugoira/ToAPNG.ts");
...
/***/ "./src/ts/modules/utils/CreateCSV.ts":
/*!*******************************************!*\
  !*** ./src/ts/modules/utils/CreateCSV.ts ***!
  \*******************************************/
...
/***/ "./src/ts/modules/utils/Json2Blob.ts":
/*!*******************************************!*\
  !*** ./src/ts/modules/utils/Json2Blob.ts ***!
  \*******************************************/
/*! exports provided: Json2Blob */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Json2Blob", function() { return Json2Blob; });
class Json2Blob {
    static convert(data) {
