...
class InitFollowingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.userInfoList = []; // 储存关注用户列表，包含 id 和用户名
        this.downUserList = false; // 下载关注用户列表的标记
    ...
    addCrawlBtns() {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_下载关注用户列表')).addEventListener('click', () => {
