...
class InitPageBase {
    ...
    async readyCrawl() {
        ...
        _TitleBar__WEBPACK_IMPORTED_MODULE_10__["titleBar"].changeTitle('↑');
        this.getWantPage();
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    reAddResult() {
        ...
        _TitleBar__WEBPACK_IMPORTED_MODULE_13__["titleBar"].changeTitle('→');
    }
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        ...
        this.idList = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type);
