...
const langText = {
    ...
    _全部: ['全部', '全部', 'All', '全部'],
    _任一: ['任一', '任一', 'One', '任一'],
    _颜色主题: ['颜色主题', '颜色主题', '颜色主题', '颜色主题'],
    _管理设置: ['管理设置', '管理设置', '管理设置', '管理设置'],
    ...
    async save(data) {
        ...
        if (await _Filter__WEBPACK_IMPORTED_MODULE_0__["filter"].check(filterOpt)) {
            ...
            const seriesOrder = body.seriesNavData
                ? '#' + body.seriesNavData.order
                : '';
            let ext = _setting_Settings__WEBPACK_IMPORTED_MODULE_2__["settings"].novelSaveAs;
            let metaArr = [];
            let meta = '';
...
class Settings {
    ...
    bindEvents() {
        ...
        // 重置设置按钮
        {
            const el = _Form__WEBPACK_IMPORTED_MODULE_4__["form"].querySelector('#resetSettings');
            if (el) {
                el.addEventListener('click', () => {
                    const result = window.confirm(_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_是否重置设置'));
                    if (result) {
        ...
        // 导出设置按钮
        {
            const el = _Form__WEBPACK_IMPORTED_MODULE_4__["form"].querySelector('#exportSettings');
            if (el) {
                el.addEventListener('click', () => {
                    this.exportSettings();
                });
        ...
        // 导入设置按钮
        {
            const el = _Form__WEBPACK_IMPORTED_MODULE_4__["form"].querySelector('#importSettings');
            if (el) {
                el.addEventListener('click', () => {
                    this.importSettings();
                });
    ...
    saveTextInput(name) {
        const el = _Form__WEBPACK_IMPORTED_MODULE_4__["form"][name];
    ...
    saveRadio(name) {
        const radios = _Form__WEBPACK_IMPORTED_MODULE_4__["form"][name];
    ...
    ListenChange() {
        ...
        // 保存命名规则
        const userSetNameInput = _Form__WEBPACK_IMPORTED_MODULE_4__["form"].userSetName;
