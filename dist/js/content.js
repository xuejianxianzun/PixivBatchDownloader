/******/ ;(function (modules) {
  ...
  \*******************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _DownloadStates__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./DownloadStates */ './src/ts/modules/DownloadStates.ts'
        )
        /* harmony import */ var _Resume__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
        ...
        class DownloadControl {
          constructor() {
            ...
            this.skipTipEL = document.createElement('span') // 显示跳过的文件数量
            this.convertTipEL = document.createElement('span') // 转换动图时显示提示文本
          ...
          skipFile() {
            this.skipCount++
            this.skipTipEL.innerHTML = _Lang__WEBPACK_IMPORTED_MODULE_4__[
              'lang'
            ].transl('_已跳过n个文件', this.skipCount.toString())
          }
          resetSkipTip() {
            this.skipCount = 0
          ...
          setDownloaded() {
            this.downloaded = _DownloadStates__WEBPACK_IMPORTED_MODULE_10__[
              'downloadStates'
            ].downloadedCount()
            this.LogDownloadStates()
            // 设置下载进度信息
    ...
    <button class="pauseDownload" type="button" style="background:${
      _Colors__WEBPACK_IMPORTED_MODULE_6__['Colors'].yellow
    };"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__['lang'].transl(
              '_下载按钮2'
            )}</button>
    ...
    <span class="convert_tip warn"></span>
            ...
            this.skipTipEL = el.querySelector('.skip_tip')
          ...
          startDownload() {
            ...
            if (
              !this.downloadPause &&
              !_Resume__WEBPACK_IMPORTED_MODULE_11__['resume'].flag
            ) {
              // 初始化下载状态列表
          ...
          createDownload(progressBarIndex) {
            const index = _DownloadStates__WEBPACK_IMPORTED_MODULE_10__[
              'downloadStates'
        ...
        class DownloadStates {
          ...
          bindEvent() {
            window.addEventListener(
              ...
              async (ev) => {
                if (
                  ev.detail.data.initiator !==
                  _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].InitiatorList.resume
                ) {
                  // 当正常抓取完毕时，初始化下载状态列表。
  ...
  \**********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Filter {
          ...
          bindEvent() {
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].events.crawlFinish,
              async (ev) => {
                if (
                  ev.detail.data.initiator ===
                  _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].InitiatorList.resume
                ) {
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./EVT */ './src/ts/modules/EVT.ts'
        )
        ...
        class InitPageBase {
          ...
          init() {
            ...
            this.initElse()
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].events
                .pageSwitchedTypeChange,
              () => {
                this.destroy()
              }
          ...
          // 作品个数/页数的输入不合法
          getWantPageError() {
            _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].events.crawlError
            )
          ...
          checkWantPageInput(crawlPartTip, crawlAllTip) {
            const temp = parseInt(
              _Settings__WEBPACK_IMPORTED_MODULE_11__['form'].setWantPage.value
            )
            // 如果比 1 小，并且不是 -1，则不通过
            ...
            if (temp >= 1) {
              _Log__WEBPACK_IMPORTED_MODULE_9__['log'].warning(
          ...
          checkWantPageInputGreater0() {
            const result = _API__WEBPACK_IMPORTED_MODULE_7__[
              'API'
            ].checkNumberGreater0(
              _Settings__WEBPACK_IMPORTED_MODULE_11__['form'].setWantPage.value
            )
          ...
          // 获取作品张数设置
          getFirstFewImages() {
            const result = _Settings__WEBPACK_IMPORTED_MODULE_11__[
              'setting'
            ].getFirstFewImages()
            if (result === undefined) {
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].fire(
          ...
          getMultipleSetting() {
            // 获取作品张数设置
            if (
              _Settings__WEBPACK_IMPORTED_MODULE_11__['form']
          ...
          async readyCrawl() {
            // 检查是否可以开始抓取
            if (
              !_Store__WEBPACK_IMPORTED_MODULE_8__['store'].states.allowWork
            ) {
              window.alert(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                  '_当前任务尚未完成2'
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].events.crawlStart
            )
            _Log__WEBPACK_IMPORTED_MODULE_9__['log'].clear()
            _Log__WEBPACK_IMPORTED_MODULE_9__['log'].success(
          ...
          getIdListFinished() {
            ...
            if (
              _Store__WEBPACK_IMPORTED_MODULE_8__['store'].idList.length === 0
            ) {
              return this.noResult()
            }
            _Log__WEBPACK_IMPORTED_MODULE_9__['log'].log(
              _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                '_当前作品个数',
                _Store__WEBPACK_IMPORTED_MODULE_8__[
                  'store'
                ].idList.length.toString()
              )
            )
            ...
            if (
              _Store__WEBPACK_IMPORTED_MODULE_8__['store'].idList.length <=
          ...
          async getWorksData(idData) {
            idData =
              idData ||
              _Store__WEBPACK_IMPORTED_MODULE_8__['store'].idList.shift()
            const id = idData.id
            try {
              // 发起请求
              if (idData.type === 'novels') {
                const data = await _API__WEBPACK_IMPORTED_MODULE_7__[
                  'API'
                ].getNovelData(id)
          ...
          crawlFinished() {
            if (
              _Store__WEBPACK_IMPORTED_MODULE_8__['store'].result.length === 0
            ) {
              return this.noResult()
            }
            this.sortResult()
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].events.crawlFinish
            )
          }
          // 网络请求状态异常时输出提示
          logErrorStatus(status, id) {
            switch (status) {
              case 0:
                _Log__WEBPACK_IMPORTED_MODULE_9__['log'].error(
                  id +
                    ': ' +
                    _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                      '_作品页状态码0'
          ...
          noResult() {
            _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_10__['EVT'].events.crawlEmpty
            )
          ...
          bindEvent() {
            ...
            window.addEventListener(
              ...
              async (ev) => {
                if (
                  ev.detail.data.initiator ===
                  _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].InitiatorList.resume
                ) {
                  this.store()
                }
              }
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../TitleBar */ './src/ts/modules/TitleBar.ts'
        )
        /* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../Settings */ './src/ts/modules/Settings.ts'
        )
    ...
    `
            ...
            this.addBookmark = (event) => {
              ...
              // 如果设置了不启用快速收藏，则把 tag 设置为空
              if (
                _Settings__WEBPACK_IMPORTED_MODULE_12__['form'].quickBookmarks
                  .checked === false
              ) {
                data.tags = []
              }
          ...
          initElse() {
            ...
            this.setPreviewResult(
              _Settings__WEBPACK_IMPORTED_MODULE_12__['form'].previewResult
                .checked
            )
            window.addEventListener(
        ...
        `
          ...
          async filterResult(callback) {
            ...
            try {
              for (
                var _b = __asyncValues(this.resultMeta), _c;
          ...
          reAddResult(removedResult) {
            ...
            this.resultMeta.forEach((data) => {
              const dlCount = _Settings__WEBPACK_IMPORTED_MODULE_12__[
                'setting'
            ...
            _TitleBar__WEBPACK_IMPORTED_MODULE_11__['titleBar'].change('→')
          }
