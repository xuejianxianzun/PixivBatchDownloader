...
/* harmony import */ var _modules_DownloadButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/DownloadButton */ "./src/ts/modules/DownloadButton.ts");
/* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _modules_setting_FormSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/setting/FormSettings */ "./src/ts/modules/setting/FormSettings.ts");
/* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/InitPage */ "./src/ts/modules/InitPage.ts");
/* harmony import */ var _modules_DownloadControl__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/DownloadControl */ "./src/ts/modules/DownloadControl.ts");
/* harmony import */ var _modules_ListenPageSwitch__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/ListenPageSwitch */ "./src/ts/modules/ListenPageSwitch.ts");
/* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/Tip */ "./src/ts/modules/Tip.ts");
/* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_Tip__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _modules_TitleBar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _modules_output_OutputPanel__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/output/OutputPanel */ "./src/ts/modules/output/OutputPanel.ts");
/* harmony import */ var _modules_output_PreviewFileName__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/output/PreviewFileName */ "./src/ts/modules/output/PreviewFileName.ts");
/* harmony import */ var _modules_output_ShowURLs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/output/ShowURLs */ "./src/ts/modules/output/ShowURLs.ts");
/* harmony import */ var _modules_MsgBox__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/MsgBox */ "./src/ts/modules/MsgBox.ts");
/* harmony import */ var _modules_CheckNew__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/CheckNew */ "./src/ts/modules/CheckNew.ts");
/* harmony import */ var _modules_ShowWhatIsNew__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/ShowWhatIsNew */ "./src/ts/modules/ShowWhatIsNew.ts");
/* harmony import */ var _modules_ExportResult2CSV__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/ExportResult2CSV */ "./src/ts/modules/ExportResult2CSV.ts");
/* harmony import */ var _modules_ExportResult__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/ExportResult */ "./src/ts/modules/ExportResult.ts");
/* harmony import */ var _modules_ExportLST__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/ExportLST */ "./src/ts/modules/ExportLST.ts");
/*
...
class CenterPanel {
    ...
    addCenterPanel() {
      ...
      `;
        ...
        const donateId = _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].flag === 0 ? 'zanzhu' : 'patreon';
...
class CreateCSV {
    ...
    create(data) {
        ...
        const name = data.fileName || _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].getTitle();
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].downloadFile(url, _API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(name) + '.csv');
        return url;
    }
    UTF8BOM() {
...
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./setting/Settings */ "./src/ts/modules/setting/Settings.ts");
...
/* harmony import */ var _FileName__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FileName */ "./src/ts/modules/FileName.ts");
...
class Deduplication {
    ...
    createRecord(resultId) {
        let name = _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].userSetName;
        // 查找这个抓取结果，获取其文件名
        for (const result of _Store__WEBPACK_IMPORTED_MODULE_7__["store"].result) {
            if (result.id === resultId) {
                name = _FileName__WEBPACK_IMPORTED_MODULE_8__["fileName"].getFileName(result);
                break;
            }
        }
        return {
    ...
    async check(resultId) {
        ...
        return new Promise(async (resolve, reject) => {
            // 如果未启用去重，直接返回不重复
            if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].deduplication) {
            ...
            if (data === null) {
                ...
                // 查询到了对应的记录，根据策略进行判断
                if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].dupliStrategy === 'loose') {
                    // 如果是宽松策略（只考虑 id），返回重复
                    return resolve(true);
                }
                else {
    ...
    async importRecord() {
        ...
        t = window.setInterval(() => {
            ...
            if (stored >= total) {
                _Log__WEBPACK_IMPORTED_MODULE_4__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_完成'));
    ...
    exportTestFile(number) {
        ...
        const blob = new Blob([str], { type: 'application/json' });
        const url = URL.createObjectURL(blob);
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].downloadFile(url, `record-test-${number}.json`);
    }
}
...
class ExportResult {
    ...
    bindEvents() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.outputResult, () => {
            this.output();
        });
    }
    output() {
        const str = JSON.stringify(_Store__WEBPACK_IMPORTED_MODULE_3__["store"].result, null, 2);
        const blob = new Blob([str], { type: 'application/json' });
        const url = URL.createObjectURL(blob);
        _DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].downloadFile(url, `result-${_API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(_DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].getTitle())}-${_Store__WEBPACK_IMPORTED_MODULE_3__["store"].crawlCompleteTime.getTime()}.json`);
    }
}
new ExportResult();
...
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Config */ "./src/ts/modules/Config.ts");
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./States */ "./src/ts/modules/States.ts");
/* harmony import */ var _DateFormat__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DateFormat */ "./src/ts/modules/DateFormat.ts");
...
class FileName {
    ...
    getFileName(data) {
        // 为空时使用 {id}
        let result = _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].userSetName || '{id}';
        // 配置所有命名标记
        const cfg = {
            '{p_title}': {
            ...
            '{date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_5__["DateFormat"].format(data.date, _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{task_date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_5__["DateFormat"].format(_Store__WEBPACK_IMPORTED_MODULE_2__["store"].crawlCompleteTime, _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{type}': {
                value: _Config__WEBPACK_IMPORTED_MODULE_3__["default"].illustTypes[data.type],
                prefix: '',
                safe: true,
            },
            '{series_title}': {
        ...
        // 替换命名规则里的特殊字符
        result = _API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(result);
        // 上一步会把斜线 / 替换成全角的斜线 ／，这里再替换回来，否则就不能建立文件夹了
        result = result.replace(/／/g, '/');
        // 判断这个作品是否要去掉序号
        const noSerialNo = cfg['{p_num}'].value === 0 && _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].noSerialNo;
        // 把命名规则的标记替换成实际值
        for (const [key, val] of Object.entries(cfg)) {
            if (result.includes(key)) {
                ...
                // 处理标记值中的特殊字符
                if (!val.safe) {
                    once = _API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(once);
                }
                // 添加标记名称
                if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].tagNameToFileName) {
        ...
        if (_States__WEBPACK_IMPORTED_MODULE_4__["states"].quickDownload &&
            _Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length === 1 &&
            !_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].alwaysFolder) {
            const index = result.lastIndexOf('/');
            result = result.substr(index + 1, result.length);
        }
        // 处理为多图作品自动建立文件夹的情况
        // 多图作品如果只下载前 1 张，不会为它自动建立文件夹。大于 1 张才会自动建立文件夹
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].multipleImageDir && data.dlCount > 1) {
            ...
            let addString = '';
            if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].multipleImageFolderName === '1') {
                // 使用作品 id 作为文件夹名
                addString = data.idNum.toString();
            }
            else if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].multipleImageFolderName === '2') {
                // 遵从命名规则，使用文件名做文件夹名
        ...
        if (ugoiraFormat.includes(data.ext) && data.ugoiraInfo) {
            data.ext = _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].ugoiraSaveAs;
        }
        // 如果是小说，那么此时根据用户设置的动图保存格式，更新其后缀名
        if (data.type === 3) {
            data.ext = _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].novelSaveAs;
        }
        const extResult = '.' + data.ext;
        // 处理文件名长度限制
        // 去掉文件夹部分，只处理 文件名+后缀名 部分
        // 理论上文件夹部分也可能会超长，但是实际使用中几乎不会有人这么设置，所以不处理
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].fileNameLengthLimitSwitch) {
            let limit = Number.parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].fileNameLengthLimit);
...
/* harmony import */ var _Mute__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Mute */ "./src/ts/modules/Mute.ts");
...
class Filter {
    constructor() {
        ...
        this._BMKNumMin = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumMin);
        this._BMKNumMax = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumMax);
        this._BMKNumAverage = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumAverage);
        this._sizeMin = 0;
    ...
    getDownType() {
        // 如果全部排除则取消任务
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType0 &&
            !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType1 &&
            !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType2 &&
            !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType3) {
            this.throwError(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除了所有作品类型'));
        }
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType0 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_插画');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType1 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_漫画');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType2 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_动图');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downType3 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_小说');
        if (notDownTip) {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    getDownTypeByImgCount() {
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downSingleImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_单图作品');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downMultiImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_多图作品');
        if (notDownTip) {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    ...
    getDownTypeByColor() {
        // 如果全部排除则取消任务
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downColorImg && !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBlackWhiteImg) {
            this.throwError(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除了所有作品类型'));
        }
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downColorImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_彩色图片');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBlackWhiteImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_黑白图片');
        if (notDownTip) {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    ...
    getDownTypeByBmked() {
        // 如果全部排除则取消任务
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downNotBookmarked && !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBookmarked) {
            this.throwError(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除了所有作品类型'));
        }
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downNotBookmarked ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_未收藏');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBookmarked ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_已收藏');
        if (notDownTip) {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    ...
    // 获取必须包含的tag
    getIncludeTag() {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].needTagSwitch) {
            return;
        }
        this._needTag = this.getTagString(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].needTag);
        if (this._needTag) {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置了必须tag之后的提示') + this._needTag);
        }
    }
    // 获取要排除的tag
    getExcludeTag() {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].notNeedTagSwitch) {
            return;
        }
        this._notNeedTag = this.getTagString(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].notNeedTag);
        if (this._notNeedTag) {
    ...
    getSetWh() {
        ...
        const width = _API__WEBPACK_IMPORTED_MODULE_2__["API"].checkNumberGreater0(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].setWidth);
        const height = _API__WEBPACK_IMPORTED_MODULE_2__["API"].checkNumberGreater0(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].setHeight);
    ...
    // 获取输入的收藏数
    getBMKNum() {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumSwitch) {
            return;
        }
        const min = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumMin);
        const max = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumMax);
        const average = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumAverage);
        if (min >= 0) {
            this._BMKNumMin = min;
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_收藏数大于') + min);
        }
        if (max >= 0) {
            this._BMKNumMax = max;
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_收藏数小于') + max);
        }
        if (average >= 0 && _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumAverageSwitch) {
            this._BMKNumAverage = average;
            this.logTip(`${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_日均收藏数量')} >= ${average}`);
        }
    }
    // 获取宽高比设置
    getRatio() {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].ratioSwitch) {
            return '0';
        }
        let result = _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].ratio;
        if (result === '1') {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置了宽高比之后的提示', _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_横图')));
        }
        else if (result === '2') {
            this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置了宽高比之后的提示', _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_竖图')));
        }
        else if (result === '3') {
            // 由用户输入
            const typeNum = parseFloat(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].userRatio);
            if (isNaN(typeNum)) {
                const msg = _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_宽高比必须是数字');
                this.throwError(msg);
            }
            else {
                this.logTip(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_输入宽高比') + _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].userRatio);
            }
        }
        return result;
    }
    // 获取 id 范围设置
    getIdRange() {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRangeSwitch) {
            return;
        }
        const result = _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRange;
        ...
        if (result === '1') {
            this.logTip(`id > ${_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRangeInput}`);
        }
        if (result === '2') {
            this.logTip(`id < ${_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRangeInput}`);
        }
    ...
    getPostDate() {
        ...
        // 判断是否是有效的时间格式
        const postDateStart = new Date(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].postDateStart);
        const postDateEnd = new Date(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].postDateEnd);
        ...
        if (isNaN(postDateStart.getTime()) || isNaN(postDateEnd.getTime())) {
            ...
            this.logTip(`${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_时间范围')}: ${_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].postDateStart} - ${_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].postDateEnd}`);
        }
    }
    // 获取文件体积设置
    getSize() {
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].sizeSwitch) {
            let min = parseFloat(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].sizeMin);
            isNaN(min) && (min = 0);
            let max = parseFloat(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].sizeMax);
            isNaN(max) && (min = 100);
    ...
    checkPageCount(illustType, pageCount) {
        ...
        if (pageCount === 1) {
            return _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downSingleImg;
        }
        if (pageCount > 1) {
            return _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downMultiImg;
        }
        return false;
    }
    // 检查过滤黑白图像设置
    async checkBlackWhite(imgUrl) {
        ...
        if (!imgUrl || (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downColorImg && _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBlackWhiteImg)) {
            return true;
        }
    ...
    checkDownTypeByBmked(bookmarked) {
        ...
        else if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downNotBookmarked && !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].downBookmarked) {
            // 只下载未收藏
            return !bookmarked;
        }
        return true;
    ...
    // 检查收藏数要求
    checkBMK(bmk, date) {
        if (bmk === undefined || !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumSwitch) {
            return true;
        }
        // 检查收藏数量是否达到设置的最大值、最小值范围
        const checkNumber = bmk >= this._BMKNumMin && bmk <= this._BMKNumMax;
        // 如果没有设置日均收藏，就直接返回收藏数量的检查结果
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].BMKNumAverageSwitch || date === undefined) {
            return checkNumber;
        }
        // 检查日均收藏
    ...
    checkExcludeTag(tags) {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].notNeedTagSwitch || !this._notNeedTag || tags === undefined) {
            return true;
        }
        let result = true;
    ...
    checkRatio(width, height) {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].ratio === '1') {
            return width / height > 1;
        }
        else if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].ratio === '2') {
            return width / height < 1;
        }
        else {
            return width / height >= parseFloat(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].userRatio);
        }
    }
    // 检查 id 范围设置
    checkIdRange(id) {
        if (id === undefined || !_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRangeSwitch) {
            return true;
        }
        const nowId = parseInt(id.toString());
        const setId = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRangeInput);
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRange === '1') {
            // 大于
            return nowId > setId;
        }
        else if (_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].idRange === '2') {
            // 小于
            return nowId < setId;
        }
        else {
    ...
    checkDebut(yes_rank) {
        if (!_States__WEBPACK_IMPORTED_MODULE_4__["states"].debut || yes_rank === undefined) {
            return true;
        }
        return yes_rank === 0;
    }
    ...
    // 检查文件体积
    checkSize(size) {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].sizeSwitch || size === undefined) {
            return true;
        }
    ...
    checkMuteUser(userId) {
        ...
        return !_Mute__WEBPACK_IMPORTED_MODULE_7__["mute"].checkUser(userId);
    }
    checkMuteTag(tags) {
        if (tags === undefined) {
            return true;
        ...
        return !tags.some(_Mute__WEBPACK_IMPORTED_MODULE_7__["mute"].checkTag.bind(_Mute__WEBPACK_IMPORTED_MODULE_7__["mute"]));
    }
    // 在日志区域输出提示
    logTip(str) {
        if (!this.showTip) {
...
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SelectWork */ "./src/ts/modules/SelectWork.ts");
// 初始化旧版收藏页面
...
class InitBookmarkLegacyPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        new _SelectWork__WEBPACK_IMPORTED_MODULE_10__["SelectWork"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
...
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SelectWork */ "./src/ts/modules/SelectWork.ts");
// 初始化新版收藏页面
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        new _SelectWork__WEBPACK_IMPORTED_MODULE_8__["SelectWork"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
...
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./SelectWork */ "./src/ts/modules/SelectWork.ts");
...
class InitFollowingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        new _SelectWork__WEBPACK_IMPORTED_MODULE_9__["SelectWork"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
...
/* harmony import */ var _Mute__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Mute */ "./src/ts/modules/Mute.ts");
// 初始化所有页面抓取流程的基类
...
class InitPageBase {
    ...
    init() {
        ...
        this.addAnyElement();
        this.initAny();
        if (!_States__WEBPACK_IMPORTED_MODULE_10__["states"].addEvented) {
            this.bindCommonEvent();
            _States__WEBPACK_IMPORTED_MODULE_10__["states"].addEvented = true;
        }
    }
    ...
    checkWantPageInput(crawlPartTip, crawlAllTip) {
        const temp = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage);
        // 如果比 1 小，并且不是 -1，则不通过
    ...
    checkWantPageInputGreater0(max, page) {
        const result = _API__WEBPACK_IMPORTED_MODULE_3__["API"].checkNumberGreater0(_setting_Settings__WEBPACK_IMPORTED_MODULE_8__["settings"].setWantPage);
        if (result.result) {
            const r = result.value > max ? max : result.value;
            if (page) {
                _Log__WEBPACK_IMPORTED_MODULE_5__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_从本页开始下载x页', r.toString()));
            }
            else {
                _Log__WEBPACK_IMPORTED_MODULE_5__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_从本页开始下载x个', r.toString()));
            }
            return r;
        }
        else {
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_11__["BookmarkAllWorks"]();
    ...
    addAnyElement() {
        ...
        this.bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_11__["BookmarkAllWorks"](bookmarkAllBtn);
...
class QuickBookmark {
    ...
    bookmark(type, id) {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].widthTag === '1') {
        ...
        // 调用添加收藏的 api
        _API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(type, id, tags, _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].restrict === '1', _Token__WEBPACK_IMPORTED_MODULE_3__["token"].token)
...
class SelectWork {
    constructor() {
        ...
        this.half = 10;
        this.show = false;
        this.tempHide = false; // 打开下载面板时临时隐藏。这个变量只会影响选择器的 display
        this.btn = document.createElement('button');
    ...
    addBtn() {
        this.btn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_手动选择作品'), [
...
class States {
    constructor() {
        ...
        this.addEvented = false; // 因为页面无刷新切换，可能导致重复添加事件，所以使用这个标记避免重复添加
        this.bindEvents();
    }
    bindEvents() {
        const idle = [
...
class InitArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        ...
        new _SelectWork__WEBPACK_IMPORTED_MODULE_14__["SelectWork"]();
    }
    initImgViewer() {
...
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../SelectWork */ "./src/ts/modules/SelectWork.ts");
...
class InitBookmarkDetailPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        new _SelectWork__WEBPACK_IMPORTED_MODULE_7__["SelectWork"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
        _setting_Options__WEBPACK_IMPORTED_MODULE_4__["options"].setWantPageTip({
...
/* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../States */ "./src/ts/modules/States.ts");
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../SelectWork */ "./src/ts/modules/SelectWork.ts");
// 初始化 artwork 排行榜页面
...
class InitRankingArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        ...
        new _SelectWork__WEBPACK_IMPORTED_MODULE_11__["SelectWork"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
        this.maxCount = 500;
...
/* harmony import */ var _SelectWork__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../SelectWork */ "./src/ts/modules/SelectWork.ts");
// 初始化 artwork 搜索页
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        ...
        new _SelectWork__WEBPACK_IMPORTED_MODULE_17__["SelectWork"]();
    }
    destroy() {
...
const langText = {
    ...
    _未收藏: ['未收藏', 'ブックマークされていない', 'Not bookmarked', '未收藏'],
    _下载之后收藏作品: [
        '下载之后收藏作品',
        'ダウンロードした作品をブックマークする',
...
class InitNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    */
    initAny() {
        ...
        new _SelectWork__WEBPACK_IMPORTED_MODULE_13__["SelectWork"]();
    }
    initQuickBookmark() {
...
class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    // 搜索页把下载任务按收藏数从高到低下载
    sortResult() {
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].resultMeta.sort(_API__WEBPACK_IMPORTED_MODULE_5__["API"].sortByProperty('bmk'));
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.sort(_API__WEBPACK_IMPORTED_MODULE_5__["API"].sortByProperty('bmk'));
    }
}
    ...
    make(data, saveMeta = true) {
        return new Promise((resolve, reject) => {
            ...
            new EpubMaker()
                ...
                .withAuthor(_API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(data.userName))
                ...
                .withTitle(_API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(data.title))
    ...
    output(content, title = _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_输出信息')) {
        ...
        if (content) {
            ...
            return _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].sendMsg({
                msg: _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_没有数据可供使用'),
                type: 'error',
            });
        }
    }
...
class Form {
    ...
    bindEvents() {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('namingBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].green, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导出抓取结果')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.outputResult);
        }, false);
        // 重置设置按钮
        {
...
class FormSettings {
    ...
    ListenChange() {
        ...
        this.form.setWantPage.addEventListener('change', () => {
            ...
            temp[_PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].type] = this.form.setWantPage.value;
    ...
    restoreWantPage() {
        ...
        if (want !== '' && want !== undefined) {
            ...
            _Settings__WEBPACK_IMPORTED_MODULE_2__["settings"].setWantPage = want;
        }
    }
    // 读取设置，恢复表单里的设置项
    restoreFormSettings() {
  ...
  <ul class="namingRuleList"></ul>
    ...
    handleChange() {
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.settingChange, {
            name: 'namingRuleList',
            value: _Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].namingRuleList,
        });
    }
    createList() {
        const htmlArr = [];
...
class Settings {
    ...
    exportSettings() {
        ...
        const blob = new Blob([str], { type: 'application/json' });
        const url = URL.createObjectURL(blob);
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].downloadFile(url, `pixiv_batch_downloader-settings.json`);
    }
    async importSettings() {
        const loadedJSON = (await _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].loadJSONFile().catch((err) => {
            return _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].sendMsg({
                type: 'error',
                msg: err,
            });
...
class ConvertUgoira {
    ...
    setMaxCount() {
        this.maxCount = parseInt(_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].convertUgoiraThread) || 1;
    }
    set count(num) {
        this._count = num;
