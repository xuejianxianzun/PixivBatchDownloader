...
/* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/InitPage */ "./src/ts/modules/InitPage.ts");
...
/* harmony import */ var _modules_RightIcon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/RightIcon */ "./src/ts/modules/RightIcon.ts");
/* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Tip */ "./src/ts/modules/Tip.ts");
/* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_Tip__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_Output__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Output */ "./src/ts/modules/Output.ts");
/* harmony import */ var _modules_Support__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/Support */ "./src/ts/modules/Support.ts");
/*
...
class DownloadControl {
    ...
    listenEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.convertChange, (ev) => {
            ...
            if (count > 0) {
                this.convertText = _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_转换任务提示', count.toString());
            }
            else {
                this.convertText = '';
            }
...
class FileName {
    ...
    getFileName(data) {
        ...
        // 判断这个作品是否要去掉序号
        const noSerialNo = cfg['{p_num}'].value === 0 &&
        ...
        if ((data.ext === 'webm' || data.ext === 'gif') && data.ugoiraInfo) {
            ...
            data.ext = _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].ugoiraSaveAs.value;
        }
        result += '.' + data.ext;
        return result;
    }
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendCenterBtns() {
        ...
        if (isOldPage) {
            const downRecmdBtn = _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取推荐作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取推荐作品Title')]]);
    ...
    async getIdList() {
        let data;
        try {
            data = await _API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), this.tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
    ...
    getRecommendedList() {
        ...
        for (const li of elements) {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(_API__WEBPACK_IMPORTED_MODULE_1__["API"].getIllustId(a.href));
        }
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
...
class InitIndexPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendCenterBtns() {
        this.downIdButton = _DOM__WEBPACK_IMPORTED_MODULE_5__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_输入id进行抓取'), [['id', 'down_id_button']]);
    }
    appendElseEl() {
        // 用于输入id的输入框
    ...
    getIdList() {
        ...
        for (const id of idValue) {
            ...
            if (isNaN(nowId) || nowId < 22 || nowId > 99999999) {
                _Log__WEBPACK_IMPORTED_MODULE_7__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_id不合法'), 0, false);
            }
            else {
                _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(nowId.toString());
            }
        }
        this.getIdListFinished();
    }
    ...
    async getIdList() {
        ...
        for (const nowData of useData) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_4__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(nowData.illustId);
            }
        }
...
class InitPageBase {
    ...
    getMultipleSetting() {
        // 获取作品张数设置
        if (_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].firstFewImagesSwitch.checked) {
    ...
    getDLCount(pageCount) {
        if (_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].firstFewImagesSwitch.checked && this.firstFewImages <= pageCount) {
...
/* harmony import */ var _CenterPanel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Settings */ "./src/ts/modules/Settings.ts");
/* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./FastScreen */ "./src/ts/modules/FastScreen.ts");
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.showCount = () => {
            ...
            _Log__WEBPACK_IMPORTED_MODULE_10__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_调整完毕', count));
    ...
    initElse() {
        this.hotBar();
        this.setPreviewResult(_Settings__WEBPACK_IMPORTED_MODULE_13__["form"].previewResult.checked);
    ...
    appendCenterBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_15__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].green, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始筛选'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始筛选Title')],
        ]).addEventListener('click', () => {
            this.startScreen();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_15__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].red, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_在结果中筛选'), [
    ...
    destroy() {
        ...
        // 离开下载页面时，取消设置“不自动下载”
        _Store__WEBPACK_IMPORTED_MODULE_9__["store"].states.notAutoDownload = false;
    }
    startScreen() {
        if (!_Store__WEBPACK_IMPORTED_MODULE_9__["store"].states.allowWork) {
    ...
    async getSearchData(p) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_8__["API"].getSearchData(_PageInfo__WEBPACK_IMPORTED_MODULE_4__["pageInfo"].getPageTag, this.worksType, p, this.option);
    ...
    async getIdList() {
        ...
        for (const nowData of data) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_7__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_9__["store"].idList.push(nowData.illustId);
            }
        }
        this.listPageFinished++;
    ...
    setPreviewResult(value) {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_9__["store"].states.notAutoDownload = value ? true : false;
    }
}
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    readyGetIdList() {
        ...
        this.tag = _PageInfo__WEBPACK_IMPORTED_MODULE_8__["pageInfo"].getPageTag;
        if (!this.tag) {
            this.getIdList();
        }
        else {
    ...
    async getIdListByTag(type) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByTypeWithTag(_DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].getUserId(), type, this.tag, this.offset, this.requsetNumber);
        data.body.works.forEach((data) => _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.push(data.id));
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
        this.offset = 0;
...
class InitWorksPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    getWantPage() {
        if (_Store__WEBPACK_IMPORTED_MODULE_5__["store"].states.quickDownload) {
            ...
            if (!this.crawlRelated) {
                ...
                this.crawlNumber = this.checkWantPageInput(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg3'), crawlAllTip);
            }
            else {
                // 相关作品的提示
    ...
    nextStep() {
        ...
        else if (_Store__WEBPACK_IMPORTED_MODULE_5__["store"].states.quickDownload) {
            // 快速下载
            _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.push(_API__WEBPACK_IMPORTED_MODULE_9__["API"].getIllustId(window.location.href));
    ...
    async getIdList() {
        ...
        if (this.crawlNumber !== -1) {
            ...
            if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.sort(function (x, y) {
    ...
    async getRelatedList() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_5__["store"].idList.concat(recommendIdList);
...
/* harmony import */ var _SaveSettings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./SaveSettings */ "./src/ts/modules/SaveSettings.ts");
/* harmony import */ var _SettingHTML__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SettingHTML */ "./src/ts/modules/SettingHTML.ts");
...
class Settings {
    constructor() {
        ...
        this.form = _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].useSlot('form', _SettingHTML__WEBPACK_IMPORTED_MODULE_6__["default"]);
        ...
        this.bindEvents();
        new _SaveSettings__WEBPACK_IMPORTED_MODULE_5__["SaveSettings"](this.form);
    ...
    bindEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.crawlFinish, () => {
            if (!_Store__WEBPACK_IMPORTED_MODULE_4__["store"].states.notAutoDownload) {
                this.activeTab(1);
            }
        });
        // 预览文件名
...
const langText = {
    ...
    _彩色图片: ['彩色图片', 'カラー画像', 'Color picture', '彩色图片'],
    _黑白图片: ['黑白图片', '白黒画像', 'Black and white pictures', '黑白图片'],
    _不保存图片因为颜色设置: ['图片 {} 没有被保存，因为它的颜色不符合设定。', '色が設定と一致しないため、画像 {} は保存されませんでした。', 'The image {} was not saved because its colors do not match the settings.', '图片 {} 没有被保存，因为它的颜色不符合设定。'],
    _xzNew500: [
        '新增设置项：<br>彩色图片；黑白图片。',
        '新たな機能を追加されました：カラー画像；白黒画像。<br>',
