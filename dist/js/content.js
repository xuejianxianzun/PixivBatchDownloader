...
class InitIndexPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendCenterBtns() {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_5__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].green, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_清空已保存的抓取结果')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.clearSavedCrawl);
        });
    }
    appendElseEl() {
        // 用于输入id的输入框
...
class InitPageBase {
    ...
    init() {
        ...
        this.appendElseEl();
        this.initElse();
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_10__["EVT"].events.pageTypeChange, () => {
            this.destroy();
        });
    }
    // 各个子类私有的初始化内容
...
class Log {
    constructor() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].events.pageTypeChange, () => {
            if (_Store__WEBPACK_IMPORTED_MODULE_2__["store"].states.allowWork) {
                this.clear();
            }
        });
...
class Resume {
    ...
    async clearSavedCrawl() {
        ...
        window.alert(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_下载记录已清除'));
    }
...
class Settings {
    constructor() {
        ...
        this.form = _DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].useSlot('form', _FormHTML__WEBPACK_IMPORTED_MODULE_7__["default"]);
