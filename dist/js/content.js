/******/ ;(function (modules) {
  ...
  \*******************************************/
    ...
    <span class="convert_tip warn"></span>
          ...
          startDownload() {
            // 如果正在下载中，或无结果，则不予处理
            if (
              _States__WEBPACK_IMPORTED_MODULE_13__['states'].busy ||
              _Store__WEBPACK_IMPORTED_MODULE_2__['store'].result.length === 0
            ) {
              return
            }
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./States */ './src/ts/modules/States.ts'
        )
        // 初始化所有页面抓取流程的基类
        ...
        class Settings {
          ...
          bindEvents() {
            ...
            for (const ev of [
              ...
              window.addEventListener(ev, () => {
                if (
                  !_States__WEBPACK_IMPORTED_MODULE_5__['states']
                    .notAutoDownload
                ) {
                  this.activeTab(1)
                }
...
*/
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _States__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ../States */ './src/ts/modules/States.ts'
        )
        // 初始化 artwork 搜索页
    ...
    `
        ...
        `
          ...
          destroy() {
            ...
            // 离开下载页面时，取消设置“不自动下载”
            _States__WEBPACK_IMPORTED_MODULE_15__[
              'states'
