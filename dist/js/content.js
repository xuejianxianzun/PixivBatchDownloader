/******/ ;(function (modules) {
  ...
  \*******************************/
      ...
      <div class="centerWrap ${
        'lang_' + _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].type
      }">
        ...
        class CheckUnsupportBrowser {
          ...
          check() {
            for (const func of Object.values(this.rules)) {
              if (func()) {
                return _Log__WEBPACK_IMPORTED_MODULE_0__['log'].warning(
                  this.tipText
                )
              }
            }
        ...
        class FileName {
          ...
          createPNum(data) {
            ...
            if (data.type === 0 || data.type === 1) {
              ...
              // 根据需要在前面填充 0
              return _setting_Settings__WEBPACK_IMPORTED_MODULE_0__['settings']
                .zeroPadding
                ? p.padStart(
                    _setting_Settings__WEBPACK_IMPORTED_MODULE_0__['settings']
                      .zeroPaddingLength,
          ...
          getFileName(data) {
            ...
            const cfg = {
              ...
              '{p_num}': {
                value: !allNameRule.includes('{p_num}')
                  ? null
                  : this.createPNum(data),
                prefix: '',
                safe: true,
              },
              '{rank}': {
  ...
  \****************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _crawlMixedPage_InitBookmarkNewPage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ./crawlMixedPage/InitBookmarkNewPage */ './src/ts/crawlMixedPage/InitBookmarkNewPage.ts'
        )
        ...
        /* harmony import */ var _crawlNovelPage_InitNewNovelPage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ./crawlNovelPage/InitNewNovelPage */ './src/ts/crawlNovelPage/InitNewNovelPage.ts'
        )
        /* harmony import */ var _crawlArtworkPage_InitArtworkSeriesPage__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ./crawlArtworkPage/InitArtworkSeriesPage */ './src/ts/crawlArtworkPage/InitArtworkSeriesPage.ts'
        )
        /* harmony import */ var _crawlMixedPage_InitFollowingPage__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
        ...
        class InitPage {
          ...
          initPage() {
            switch (_PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].type) {
              ...
              case _PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].list
                .NewArtworkBookmark:
                return new _crawlMixedPage_InitBookmarkNewPage__WEBPACK_IMPORTED_MODULE_12__[
                  'InitBookmarkNewPage'
                ]()
              case _PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].list
                .Discover:
              ...
              case _PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].list
                .NewNovel:
                return new _crawlNovelPage_InitNewNovelPage__WEBPACK_IMPORTED_MODULE_19__[
                  'InitNewNovelPage'
                ]()
              case _PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].list
                .ArtworkSeries:
                return new _crawlArtworkPage_InitArtworkSeriesPage__WEBPACK_IMPORTED_MODULE_20__[
                  'InitArtworkSeriesPage'
                ]()
              case _PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].list
                .Following:
                return new _crawlMixedPage_InitFollowingPage__WEBPACK_IMPORTED_MODULE_21__[
                  'InitFollowingPage'
                ]()
              default:
                return
  ...
  \********************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class ShowBigThumb {
          constructor() {
            // 延迟时间。鼠标在缩略图上停留指定时间，才会加载大缩略图，避免浪费资源
            this.delay = 200
  ...
  \********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _MouseOverThumbnail__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
  ...
  <use xlink:href="#icon-fangda"></use>
          ...
          bindEvents() {
            ...
            _MouseOverThumbnail__WEBPACK_IMPORTED_MODULE_4__[
              'mouseOverThumbnail'
            ].onEnter((el, ev) => {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ShowBigThumb__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/ __webpack_require__.n(
          _ShowBigThumb__WEBPACK_IMPORTED_MODULE_12__
        )
  ...
  \******************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitBookmarkNewPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          'InitPageBase'
        ] {
          constructor() {
            super()
          ...
          nextStep() {
            ...
            this.crawlWorksMaxNumber =
              this.crawlNumber * (this.newVer ? 60 : 20)
            // 设置 API 里发起请求的页数
            const p = _utils_Utils__WEBPACK_IMPORTED_MODULE_9__[
              'Utils'
            ].getURLSearchField(location.href, 'p')
          ...
          async getIdList() {
            ...
            try {
              data = await _API__WEBPACK_IMPORTED_MODULE_6__[
                'API'
              ].getBookmarkNewWorkData(this.type, p, this.r18)
            } catch (error) {
              this.getIdList()
              return
            }
            ...
            if (!this.newVer) {
              ...
              const needCrawl =
                this.crawlWorksMaxNumber - this.crawledWorksNumber
        ...
        class ExportResult2CSV {
          ...
          create(data) {
            ...
            for (const d of data) {
              ...
              const index =
                (_a = d.index) !== null && _a !== void 0
                  ? _a
                  : _Tools__WEBPACK_IMPORTED_MODULE_1__['Tools'].getResultIndex(
                      d
                    )
              if (index > 0) {
                continue
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Store {
          ...
          addResult(data) {
            ...
            const useList =
              data.type === 3 ? this.novelIDList : this.artworkIDList
