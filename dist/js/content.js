...
class FileName {
    ...
    getFileName(data) {
        ...
        const cfg = {
            ...
            '{type}': {
                value: _config_Config__WEBPACK_IMPORTED_MODULE_2__["Config"].worksTypeName[data.type],
                prefix: '',
                safe: true,
            },
            '{series_title}': {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderByType) {
            ...
            if (allSwitch[data.type]) {
                const folder = _config_Config__WEBPACK_IMPORTED_MODULE_2__["Config"].worksTypeName[data.type];
...
class ViewBigImage {
  ...
  <use xlink:href="#icon-fangda"></use>
    ...
    findWorkId(el) {
        ...
        const href = a.href;
        return _Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].getIllustId(href);
    }
    // 显示放大按钮
    showBtn(target) {
...
/* harmony import */ var _download_QuickDownload__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./download/QuickDownload */ "./src/ts/download/QuickDownload.ts");
...
/* harmony import */ var _ViewBigImage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ViewBigImage */ "./src/ts/ViewBigImage.ts");
/* harmony import */ var _output_OutputPanel__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./output/OutputPanel */ "./src/ts/output/OutputPanel.ts");
/* harmony import */ var _output_PreviewFileName__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./output/PreviewFileName */ "./src/ts/output/PreviewFileName.ts");
/* harmony import */ var _output_ShowURLs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./output/ShowURLs */ "./src/ts/output/ShowURLs.ts");
/* harmony import */ var _download_ExportResult2CSV__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./download/ExportResult2CSV */ "./src/ts/download/ExportResult2CSV.ts");
/* harmony import */ var _download_ExportResult__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./download/ExportResult */ "./src/ts/download/ExportResult.ts");
/* harmony import */ var _download_ImportResult__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./download/ImportResult */ "./src/ts/download/ImportResult.ts");
/* harmony import */ var _download_ExportLST__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./download/ExportLST */ "./src/ts/download/ExportLST.ts");
/* harmony import */ var _CheckNewVersion__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./CheckNewVersion */ "./src/ts/CheckNewVersion.ts");
/* harmony import */ var _ShowWhatIsNew__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./ShowWhatIsNew */ "./src/ts/ShowWhatIsNew.ts");
/* harmony import */ var _ShowHowToUse__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./ShowHowToUse */ "./src/ts/ShowHowToUse.ts");
/*
...
class InitSearchArtworkPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    destroy() {
        ...
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.settingChange, this.onSettingChange);
        // 离开下载页面时，取消设置“不自动下载”
...
class SaveNamingRule {
  ...
  <ul class="namingRuleList"></ul>
    ...
    select(rule) {
        ...
        Object(_Settings__WEBPACK_IMPORTED_MODULE_4__["setSetting"])('userSetName', rule);
    }
    createList() {
        const htmlArr = [];
...
class Store {
    ...
    addResult(data) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.addResult, workData);
        // 把该作品里的每个文件的数据添加到结果里
        if (workData.type === 3) {
            // 小说作品直接添加
