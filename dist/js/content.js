            ...
            if ((arg.data.type === 0 || arg.data.type === 1) &&
                ...
                if (!result) {
                    ...
                    return this.skip({
                        ...
                        tabId: 0,
                        uuid: false,
                    }, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_不保存图片因为颜色设置', arg.id));
                }
            }
            // 向浏览器发送下载任务
...
class FileName {
    ...
    getFileName(data) {
        ...
        // 判断这个作品是否要去掉序号
        const noSerialNo = cfg['{p_num}'].value === 0 && _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].noSerialNo.checked;
        // 把命名规则的标记替换成实际值
...
class Filter {
    ...
    // 获取文件体积设置
    getSize() {
        this.sizeSwitch = _Settings__WEBPACK_IMPORTED_MODULE_0__["form"].sizeSwitch.checked;
        if (this.sizeSwitch) {
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        ...
        if (data.body.works.length === 0 ||
            ...
            data.body.works.forEach((data) => this.idList.push({
                type: _API__WEBPACK_IMPORTED_MODULE_1__["API"].getWorkType(data.illustType),
                id: data.id,
            }));
    ...
    getRecommendedList() {
        ...
        for (const li of elements) {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push({
                type: 'unkown',
                id: _API__WEBPACK_IMPORTED_MODULE_1__["API"].getIllustId(a.href),
            });
        }
        this.getIdListFinished();
    }
...
class InitPageBase {
    ...
    getIdListFinished() {
        ...
        console.log(_Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList);
    ...
    async getWorksData(id) {
        id = id || _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.shift().id;
        let data;
        try {
            // 发起请求
    ...
    appendCenterBtns() {
        ...
        if (debutModes.includes(mode)) {
            _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取首次登场的作品'), [
                ...
                console.log(_Settings__WEBPACK_IMPORTED_MODULE_6__["form"].debut.value);
                this.readyCrawl();
            });
        }
    }
