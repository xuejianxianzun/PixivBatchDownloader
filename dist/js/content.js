...
class FileName {
    ...
    getFileName(data) {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].multipleImageDir && data.dlCount > _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].multipleImageFolderNumber) {
...
class Filter {
    ...
    getIdRange() {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].idRange === '1') {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(`id > ${_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].idRangeInput}`);
        }
        else {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(`id < ${_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].idRangeInput}`);
        }
    ...
    checkIncludeTag(tags) {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].needTagSwitch || _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].needTag.length === 0 || tags === undefined) {
            return true;
        }
        let result = false;
    ...
    checkExcludeTag(tags) {
        if (!_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].notNeedTagSwitch || _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].notNeedTag.length === 0 || tags === undefined) {
            return true;
        }
        let result = true;
...
class Settings {
    constructor() {
        ...
        this.stringArrayKey = ['namingRuleList', 'blockList', 'needTag', 'notNeedTag'];
        // 以默认设置作为初始设置
