/******/ ;(function (modules) {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _modules_Toast__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./modules/Toast */ './src/ts/modules/Toast.ts'
        )
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Deduplication {
          ...
          bindEvents() {
            ...
            // 监听清空下载记录的事件
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].list.clearDownloadRecord,
              () => {
                this.clearRecords()
                this.existedIdList = []
              }
          ...
          clearRecords() {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].list.sendToast,
              {
                text: _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
                  '_下载记录已清除'
                ),
          ...
          // 导入下载记录
          async importRecord() {
            const record = await _DOM__WEBPACK_IMPORTED_MODULE_0__['DOM']
              .loadJSONFile()
              .catch((err) => {
            ...
            window.addEventListener(
              ...
              () => {
                _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
                  ...
                  {
                    text: _Lang__WEBPACK_IMPORTED_MODULE_4__['lang'].transl(
                      '_下载完毕2'
                    ),
                    bgColorType: 'green',
                  }
          ...
          output() {
            ...
            if (
              ...
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
                _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].list.sendToast,
                {
                  text: _Lang__WEBPACK_IMPORTED_MODULE_3__['lang'].transl(
                    '_没有数据可供使用'
                  ),
                  bgColorType: 'error',
                }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitPageBase {
          ...
          async readyCrawl() {
            ...
            if (_States__WEBPACK_IMPORTED_MODULE_9__['states'].busy) {
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].fire(
                _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].list.sendToast,
                {
                  text: _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                    '_当前任务尚未完成'
                  ),
                  bgColorType: 'error',
                }
  ...
  \*******************************/
    ...
    */
          add(str, level, br, keepShow) {
            ...
            if (level > -1) {
              span.style.color =
                _Colors__WEBPACK_IMPORTED_MODULE_3__['Colors'][
                  this.level[level]
                ]
            }
            while (br > 0) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class SaveUserCover {
          ...
          async saveUserCover() {
            ...
            if (bgData === null) {
              return _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].fire(
                _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].list.sendToast,
                {
                  text: _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                    '_没有数据可供使用'
          ...
          output(
            ...
            if (content) {
              ...
              return _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
                _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].list.sendToast,
                {
                  text: _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl(
                    '_没有数据可供使用'
                  ),
                  bgColorType: 'error',
                }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Settings {
          constructor() {
            ...
            // 以默认设置作为初始设置
            this.settings = _Tools__WEBPACK_IMPORTED_MODULE_2__[
              'Tools'
          ...
          assignSettings(data) {
            const origin = _Tools__WEBPACK_IMPORTED_MODULE_2__[
              'Tools'
            ].deepCopy(data)
          ...
          setSetting(key, value, fireEvt = true) {
            ...
            if (valueType === 'string') {
              value = _ConvertOldSettings__WEBPACK_IMPORTED_MODULE_3__[
                'convertOldSettings'
              ].convert(key, value)
            }
            // 将传入的值转换成选项对应的类型
            ...
            if (Array.isArray(this.defaultSettings[key])) {
              if (this.stringArrayKey.includes(key)) {
                // 字符串转换成 string[]
                if (valueType === 'string') {
                  value = _Tools__WEBPACK_IMPORTED_MODULE_2__[
                    'Tools'
                  ].string2array(value)
                }
              }
