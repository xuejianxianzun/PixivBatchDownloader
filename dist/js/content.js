...
/* harmony import */ var _download_MergeNovel__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./download/MergeNovel */ "./src/ts/download/MergeNovel.ts");
/* harmony import */ var _download_SaveWorkMeta__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./download/SaveWorkMeta */ "./src/ts/download/SaveWorkMeta.ts");
/* harmony import */ var _CheckNewVersion__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./CheckNewVersion */ "./src/ts/CheckNewVersion.ts");
/* harmony import */ var _ShowWhatIsNew__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./ShowWhatIsNew */ "./src/ts/ShowWhatIsNew.ts");
/* harmony import */ var _ShowHowToUse__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./ShowHowToUse */ "./src/ts/ShowHowToUse.ts");
/* harmony import */ var _CheckUnsupportBrowser__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./CheckUnsupportBrowser */ "./src/ts/CheckUnsupportBrowser.ts");
/* harmony import */ var _ShowNotification__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./ShowNotification */ "./src/ts/ShowNotification.ts");
/*
...
class InitSearchArtworkPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    `;
        ...
        new _crawlMixedPage_CrawlTagList__WEBPACK_IMPORTED_MODULE_20__["CrawlTagList"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
        _setting_Options__WEBPACK_IMPORTED_MODULE_3__["options"].setWantPageTip({
...
class CrawlTagList {
    constructor() {
        ...
        this.onDownloadComplete = () => {
            window.setTimeout(() => {
                console.log('states.crawlTagList', _store_States__WEBPACK_IMPORTED_MODULE_4__["states"].crawlTagList);
    ...
    addCrawlBtns() {
        _Tools__WEBPACK_IMPORTED_MODULE_0__["Tools"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, '抓取标签列表').addEventListener('click', () => {
  ...
  `;
    ...
    bindEvents() {
        ...
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.downloadComplete, this.onDownloadComplete);
...
class InitSearchNovelPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        new _crawlMixedPage_CrawlTagList__WEBPACK_IMPORTED_MODULE_15__["CrawlTagList"]();
    }
    addCrawlBtns() {
