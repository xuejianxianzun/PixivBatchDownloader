...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    readyGetIdList() {
        ...
        // 设置 tag
        if (parseInt(_API__WEBPACK_IMPORTED_MODULE_1__["API"].getURLField(location.href, 'untagged')) === 1) {
            // 在“未分类”页面时
            this.tag = '未分類';
        }
        else {
            this.tag = _API__WEBPACK_IMPORTED_MODULE_1__["API"].getURLField(location.href, 'tag');
        }
        // 判断是公开收藏还是非公开收藏
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
// 初始化搜索页
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    destroy() {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_15__["DOM"].removeEl(fastScreen);
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    readyGetIdList() {
        ...
        if (location.href.includes('member.php?id=')) {
            ...
            // 作品列表页
            if (_API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLField(location.href, 'type') === 'illust') {
                // 插画分类
                this.listType = 1;
            }
            else if (_API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLField(location.href, 'type') === 'manga') {
                // 漫画分类
                this.listType = 2;
            }
            else if (_API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLField(location.href, 'tag')) {
                // url 里没有标识插画还是漫画，但是有 tag，则是在用户首页点击了 tag，需要同时获取插画和漫画
                this.listType = 4;
            }
        }
        // 是否带有 tag
        this.tag = decodeURI(_API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLField(location.href, 'tag'));
