/******/ ;(function (modules) {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _modules_DownloadButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./modules/DownloadButton */ './src/ts/modules/DownloadButton.ts'
        )
        /* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./modules/CenterPanel */ './src/ts/modules/CenterPanel.ts'
        )
        /* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  \***************************************/
      ...
      <a class="gray1" href="javascript:void()" id="resetOption">${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_重置设置')}</a>
      ...
      `
          ...
          bindEvents() {
            ...
            for (const ev of [
              ...
              window.addEventListener(ev, () => {
                if (
                  !_States__WEBPACK_IMPORTED_MODULE_3__['states']
                    .quickDownload &&
                  !_States__WEBPACK_IMPORTED_MODULE_3__['states']
                    .notAutoDownload
                ) {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.openCenterPanel,
              () => {
                this.show()
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.closeCenterPanel,
              () => {
                this.close()
              }
            )
          ...
          show() {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.centerPanelOpened
            )
          }
          // 隐藏中间区域
          close() {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.centerPanelClosed
            )
          }
        }
        new CenterPanel()
  ...
  \*****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _IndexedDB__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        class Deduplication {
          constructor() {
            ...
            this.IDB = new _IndexedDB__WEBPACK_IMPORTED_MODULE_3__[
              'IndexedDB'
            ]()
            this.init()
          }
          ...
          createRecord(resultId) {
            let name =
              _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].userSetName.value
            // 查找这个抓取结果，获取其文件名
            for (const result of _Store__WEBPACK_IMPORTED_MODULE_4__['store']
              .result) {
              if (result.id === resultId) {
                name = _FileName__WEBPACK_IMPORTED_MODULE_5__[
                  'fileName'
                ].getFileName(result)
                break
              }
          ...
          bindEvent() {
            ...
            // 当有文件下载完成时，存储这个任务的记录
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.downloadSuccess,
              (ev) => {
          ...
          async check(resultId) {
            return new Promise(async (resolve, reject) => {
              // 如果未启用去重，直接返回不重复
              if (
                _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].deduplication
                  .checked === false
              ) {
                resolve(false)
              }
              ...
              if (data === null) {
                ...
                // 查询到了对应的记录，根据策略进行判断
                if (
                  _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].dupliStrategy
                    .value === 'loose'
                ) {
                  // 如果是宽松策略（只考虑 id），返回重复
                  resolve(true)
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class DeleteWorks {
          constructor(worksSelectors) {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.worksUpdate,
              () => {
                if (this.delMode) {
          ...
          allowWork() {
            return _Store__WEBPACK_IMPORTED_MODULE_4__['store'].states.allowWork
          }
          // 清除多图作品的按钮
              ...
              .addEventListener(
                ...
                () => {
                  ...
                  _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].fire(
                    _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events
                      .closeCenterPanel
                  )
                  this.clearMultiple()
                  callback()
  ...
  \************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ugoira_ConvertUgoira__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          ...
          async download(arg) {
            ...
            xhr.addEventListener('progress', async (event) => {
              ...
              if (this.sizeCheck === undefined) {
                this.sizeCheck = await _Filter__WEBPACK_IMPORTED_MODULE_6__[
                  'filter'
            ...
            xhr.addEventListener('loadend', async () => {
                ...
                if (convertExt.includes(arg.data.ext) && arg.data.ugoiraInfo) {
                  try {
                    if (arg.data.ext === 'webm') {
                      file = await _ugoira_ConvertUgoira__WEBPACK_IMPORTED_MODULE_4__[
                        'converter'
              ...
              if (
                ...
                const result = await _Filter__WEBPACK_IMPORTED_MODULE_6__[
                  'filter'
                ].check({
                  mini: blobUrl,
                })
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class DownloadButton {
          ...
          bindEvents() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.centerPanelClosed,
              () => {
                this.show()
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.centerPanelOpened,
              () => {
                this.hide()
              }
            )
  ...
  \*******************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Resume__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    <span class="convert_tip warn"></span>
          ...
          setDownloadThread() {
            const setThread = parseInt(
              _Settings__WEBPACK_IMPORTED_MODULE_6__['form'].downloadThread
                .value
            )
            if (
              setThread < 1 ||
          ...
          readyDownload() {
            ...
            // 检查 不自动开始下载 的标记
            if (
              _States__WEBPACK_IMPORTED_MODULE_13__['states'].notAutoDownload
            ) {
              return
            }
            const autoDownload =
              _Settings__WEBPACK_IMPORTED_MODULE_6__['form'].quietDownload
                .checked
            // 视情况自动开始下载
            if (
              autoDownload ||
              _States__WEBPACK_IMPORTED_MODULE_13__['states'].quickDownload
            ) {
              this.startDownload()
            }
          }
          ...
          startDownload() {
            // 如果正在下载中，或无结果，则不予处理
            if (
              !_States__WEBPACK_IMPORTED_MODULE_13__['states'].allowWork ||
              _Store__WEBPACK_IMPORTED_MODULE_2__['store'].result.length === 0
            ) {
              return
            }
            if (
              !this.downloadPause &&
              !_Resume__WEBPACK_IMPORTED_MODULE_12__['resume'].flag
            ) {
        ...
        class FastScreen {
          ...
          openFastScreenLink(secondTag) {
            ...
            const newURL = location.href.replace(
              encodeURIComponent(
                _PageInfo__WEBPACK_IMPORTED_MODULE_2__['pageInfo'].tag
              ),
              fullTag
            )
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class FileName {
          ...
          getFileName(data) {
            // 为空时使用 {id}
            let result =
              _Settings__WEBPACK_IMPORTED_MODULE_3__['form'].userSetName
                .value || '{id}'
            // 配置所有命名标记
            const cfg = {
              '{p_title}': {
                value:
                  _Store__WEBPACK_IMPORTED_MODULE_4__['store'].pageInfo
                    .pageTitle,
                prefix: '',
                safe: false,
              },
              '{p_tag}': {
                value:
                  _Store__WEBPACK_IMPORTED_MODULE_4__['store'].pageInfo.pageTag,
                prefix: '',
                safe: false,
              },
              '{id}': {
            ...
            const noSerialNo =
              cfg['{p_num}'].value === 0 &&
              _Settings__WEBPACK_IMPORTED_MODULE_3__['form'].noSerialNo.checked
            // 把命名规则的标记替换成实际值
            for (const [key, val] of Object.entries(cfg)) {
              if (result.includes(key)) {
                ...
                // 添加标记名称
                if (
                  _Settings__WEBPACK_IMPORTED_MODULE_3__['form']
            ...
            if (
              ...
              _Store__WEBPACK_IMPORTED_MODULE_4__['store'].result.length ===
                1 &&
              _Settings__WEBPACK_IMPORTED_MODULE_3__['form'].alwaysFolder
                .checked === false
            ) {
            ...
            if (
              _Settings__WEBPACK_IMPORTED_MODULE_3__['form'].multipleImageDir
                .checked &&
              data.dlCount > 1
            ) {
            ...
            if (
              _Settings__WEBPACK_IMPORTED_MODULE_3__['form']
                .fileNameLengthLimitSwitch.checked
            ) {
              let limit = Number.parseInt(
                _Settings__WEBPACK_IMPORTED_MODULE_3__['form']
                  .fileNameLengthLimit.value
              )
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Filter {
          ...
          init() {
            ...
            this.filterBMKNum =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].BMKNumSwitch.checked
            this.filterBMKNum && this.getBMKNum()
            // 获取是否设置了只下载书签作品
            this.onlyBmk = this.getOnlyBmk()
            // 获取是否设置了宽高条件
            this.setWHSwitch =
              _Settings__WEBPACK_IMPORTED_MODULE_0__['form'].setWHSwitch.checked
            if (this.setWHSwitch) {
              this.filterWh = this.getSetWh()
            }
            // 获取宽高比设置
            if (
              _Settings__WEBPACK_IMPORTED_MODULE_0__['form'].ratioSwitch.checked
            ) {
            ...
            this.needTagSwitch =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].needTagSwitch.checked
            if (this.needTagSwitch) {
              this.includeTag = this.getIncludeTag()
            }
            // 获取要排除的tag
            this.notNeedTagSwitch =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].notNeedTagSwitch.checked
          ...
          getDownType() {
            ...
            this.downType3 =
              _Settings__WEBPACK_IMPORTED_MODULE_0__['form'].downType3.checked
            // 如果全部排除则取消任务
            if (
              !this.downType0 &&
              !this.downType1 &&
            ...
            notDownTip += this.downType3
              ? ''
              : _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_小说')
            if (notDownTip) {
          ...
          getDownTypeByImgCount() {
            this.downSingleImg =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].downSingleImg.checked
            this.downMultiImg =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].downMultiImg.checked
            let notDownTip = ''
            notDownTip += this.downSingleImg
              ? ''
              : _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_单图作品')
            notDownTip += this.downMultiImg
              ? ''
              : _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_多图作品')
            if (notDownTip) {
              _Log__WEBPACK_IMPORTED_MODULE_2__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl(
                  '_checkNotdownTypeResult'
          ...
          getDownTypeByColor() {
            this.downColorImg =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].downColorImg.checked
            this.downBlackWhiteImg =
              _Settings__WEBPACK_IMPORTED_MODULE_0__[
                'form'
              ].downBlackWhiteImg.checked
            // 如果全部排除则取消任务
            ...
            let notDownTip = ''
            notDownTip += this.downColorImg
              ? ''
              : _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_彩色图片')
            notDownTip += this.downBlackWhiteImg
              ? ''
              : _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_黑白图片')
            if (notDownTip) {
              _Log__WEBPACK_IMPORTED_MODULE_2__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl(
                  '_checkNotdownTypeResult'
          ...
          getSetWh() {
            ...
            if (checkWidth.value > 0 || checkHeight.value > 0) {
              ...
              _Log__WEBPACK_IMPORTED_MODULE_2__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_1__['lang'].transl('_宽度设置') +
                  result.width +
                  result.andOr
                    .replace(
                      '|',
          ...
          checkRatio(width, height) {
            if (
              !_Settings__WEBPACK_IMPORTED_MODULE_0__['form'].ratioSwitch
                .checked
            ) {
              return true
            }
          ...
          checkSize(size) {
            if (
              !_Settings__WEBPACK_IMPORTED_MODULE_0__['form'].sizeSwitch
                .checked ||
              size === undefined
            ) {
              return true
          ...
          bindEvent() {
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].events.crawlStart,
              () => {
                this.init()
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].events.resume,
              () => {
  ...
  <div class="tabsContnet">
    ...
    <div class="con">
      ...
      &nbsp;&nbsp;
      <a class="gray1" id="clearDownloadRecords" href="javascript:void(0)">${_Lang__WEBPACK_IMPORTED_MODULE_0__[
        'lang'
      ].transl('_清除下载记录')}</a>
      </span>
      </p>
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_4__['DOM']
              ...
              .addEventListener('click', () => {
                _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_7__['EVT'].events
                    .clearSavedCrawl
                )
              })
          }
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _artwork_SaveArtworkData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./artwork/SaveArtworkData */ './src/ts/modules/artwork/SaveArtworkData.ts'
        )
        /* harmony import */ var _novel_SaveNovelData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        class InitPageBase {
          ...
          init() {
            ...
            this.initElse()
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events
                .pageSwitchedTypeChange,
              () => {
                this.destroy()
              }
          ...
          getWantPageError() {
            _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.crawlError
            )
          ...
          checkWantPageInput(crawlPartTip, crawlAllTip) {
            const temp = parseInt(
              _Settings__WEBPACK_IMPORTED_MODULE_10__['form'].setWantPage.value
            )
            // 如果比 1 小，并且不是 -1，则不通过
          ...
          checkWantPageInputGreater0() {
            const result = _API__WEBPACK_IMPORTED_MODULE_6__[
              'API'
            ].checkNumberGreater0(
              _Settings__WEBPACK_IMPORTED_MODULE_10__['form'].setWantPage.value
            )
          ...
          // 获取作品张数设置
          getFirstFewImages() {
            const result = _Settings__WEBPACK_IMPORTED_MODULE_10__[
              'setting'
            ].getFirstFewImages()
            if (result === undefined) {
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
          ...
          getMultipleSetting() {
            // 获取作品张数设置
            if (
              _Settings__WEBPACK_IMPORTED_MODULE_10__['form']
                .firstFewImagesSwitch.checked
            ) {
          ...
          async readyCrawl() {
            // 检查是否可以开始抓取
            if (
              !_Store__WEBPACK_IMPORTED_MODULE_7__['store'].states.allowWork
            ) {
              window.alert(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                  '_当前任务尚未完成2'
            ...
            _Log__WEBPACK_IMPORTED_MODULE_8__['log'].success(
              _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl('_任务开始0')
            )
            this.getWantPage()
            this.getMultipleSetting()
            _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.crawlStart
            )
            // 进入第一个抓取方法
            this.nextStep()
          }
          ...
          getIdListFinished() {
            ...
            if (
              _Store__WEBPACK_IMPORTED_MODULE_7__['store'].idList.length === 0
            ) {
              return this.noResult()
            }
          ...
          async getWorksData(idData) {
            idData =
              idData ||
              _Store__WEBPACK_IMPORTED_MODULE_7__['store'].idList.shift()
            const id = idData.id
            try {
              // 发起请求
              if (idData.type === 'novels') {
                const data = await _API__WEBPACK_IMPORTED_MODULE_6__[
                  'API'
                ].getNovelData(id)
                await _novel_SaveNovelData__WEBPACK_IMPORTED_MODULE_5__[
                  'saveNovelData'
                ].save(data)
              } else {
                const data = await _API__WEBPACK_IMPORTED_MODULE_6__[
                ...
                await _artwork_SaveArtworkData__WEBPACK_IMPORTED_MODULE_4__[
                  'saveArtworkData'
                ].save(data)
              }
          ...
          crawlFinished() {
            if (
              _Store__WEBPACK_IMPORTED_MODULE_7__['store'].result.length === 0
            ) {
              return this.noResult()
            }
            this.sortResult()
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.crawlFinish
            )
          }
          // 网络请求状态异常时输出提示
          ...
          noResult() {
            _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.crawlEmpty
            )
            _Log__WEBPACK_IMPORTED_MODULE_8__['log'].error(
              _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
                '_抓取结果为零'
        ...
        class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          appendCenterBtns() {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_7__['DOM']
              ...
              .addEventListener('click', () => {
                _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.saveAvatarIcon
                )
              })
          }
          setFormOption() {
          ...
          readyGetIdList() {
            ...
            _PageInfo__WEBPACK_IMPORTED_MODULE_8__['pageInfo'].tag
              ? this.getIdListByTag()
              : this.getIdList()
            _Log__WEBPACK_IMPORTED_MODULE_6__['log'].log(
              _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl('_正在抓取')
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class OutputCSV {
          constructor() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.outputCSV,
              () => {
                this.beforeCreate()
              }
            )
          ...
          beforeCreate() {
            // 如果没有数据则不执行
            if (
              _Store__WEBPACK_IMPORTED_MODULE_4__['store'].resultMeta.length ===
                0 &&
              _Store__WEBPACK_IMPORTED_MODULE_4__['store'].result.length === 0
            ) {
              alert(
            ...
            data = _Store__WEBPACK_IMPORTED_MODULE_4__['store'].resultMeta
        ...
        class PageInfo {
          ...
          store() {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_2__[
              'store'
            ].pageInfo.pageTitle = this._title
            _Store__WEBPACK_IMPORTED_MODULE_2__[
              'store'
            ].pageInfo.pageTag = this._tag
          }
          // 获取当前页面的一些信息，用于文件名中
          getPageInfo() {
            this.reset()
  ...
  <span class="loaded"></span>
            ...
            this.allProgressBar = []
            this.loadedText = _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
              '_已下载'
            )
          ...
          setProgress(index, data) {
            ...
            bar.loaded.textContent = `${Math.floor(
              data.loaded / 1024
            )}/${Math.floor(data.total / 1024)} KiB`
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class QuickBookmark {
          ...
          async init() {
            ...
            if (
              !_API__WEBPACK_IMPORTED_MODULE_0__['API'].getToken() ||
              !_Settings__WEBPACK_IMPORTED_MODULE_2__['form'].quickBookmarks
                .checked
            ) {
              return
            }
          ...
          bindEvent() {
            ...
            this.btn.addEventListener(
              ...
              () => {
                ...
                _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.QuickDownload
                )
              },
              false
            )
  ...
  \**********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _DownloadStates__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./DownloadStates */ './src/ts/modules/DownloadStates.ts'
        )
        ...
        class Resume {
          ...
          async restoreData() {
            ...
            if (data) {
              _DownloadStates__WEBPACK_IMPORTED_MODULE_4__[
                'downloadStates'
              ].replace(data.states)
            }
            // 恢复模式就绪
          ...
          bindEvent() {
            ...
            // 清空已保存的抓取结果
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.clearSavedCrawl,
              () => {
                this.flag = false
  ...
  \******************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class SaveAvatarIcon {
          ...
          bindEvents() {
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].events.saveAvatarIcon,
              () => {
                this.saveAvatarIcon()
              }
            )
          ...
          async saveAvatarIcon() {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_4__['EVT'].events.closeCenterPanel
            )
          }
        }
        new SaveAvatarIcon()
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Settings {
          ...
          bindEvents() {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_2__['DOM']
              .addBtn(
                'namingBtns',
                _Colors__WEBPACK_IMPORTED_MODULE_3__['Colors'].green,
                _Lang__WEBPACK_IMPORTED_MODULE_4__['lang'].transl('_导出csv')
              )
              .addEventListener(
                'click',
                () => {
                  _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
                    _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.outputCSV
                  )
                },
                false
              )
          ...
          getDLCount(pageCount) {
            if (
              form.firstFewImagesSwitch.checked &&
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class States {
          constructor() {
            ...
            this.allowWork = true
            this.quickDownload = false // 快速下载标记。如果这次下载是快速下载，则为 true
            this.notAutoDownload = false // 如果为 true，那么下载器在抓取完成后，不回自动开始下载。这样需要用户手动点击下载按钮才开始下载。
            this.bindEvent()
          }
          bindEvent() {
            window.addEventListener(
...
*/
        ...
        class TitleBar {
          ...
          bindEvent() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.worksUpdate,
              () => {
                this.set('waiting')
              }
            )
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.downloadStart,
              () => {
                this.set('downloading')
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.downloadComplete,
              () => {
                this.set('completed')
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.downloadPause,
              () => {
                this.set('paused')
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.downloadStop,
              () => {
                this.set('stopped')
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.crawlEmpty,
              () => {
                this.reset()
              }
            )
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        */
          ...
          initElse() {
            ...
            // 页面切换再次初始化
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].events
                .pageSwitchedTypeNotChange,
              this.initQuickBookmark
            )
            window.addEventListener(
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].events.QuickDownload,
              this.startQuickDownload
            )
          }
          initImgViewer() {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_8__['DOM']
              ...
              .addEventListener('click', () => {
                _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].events.saveAvatarIcon
                )
              })
          }
          setFormOption() {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitRankingArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          appendCenterBtns() {
            ...
            let mode = _API__WEBPACK_IMPORTED_MODULE_2__[
              'API'
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../Settings */ './src/ts/modules/Settings.ts'
        )
        /* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../FastScreen */ './src/ts/modules/FastScreen.ts'
        )
        /* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../DOM */ './src/ts/modules/DOM.ts'
        )
        /* harmony import */ var _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    `
            ...
            this.addBookmark = (event) => {
              ...
              // 如果设置了不启用快速收藏，则把 tag 设置为空
              if (
                _Settings__WEBPACK_IMPORTED_MODULE_11__['form'].quickBookmarks
                  .checked === false
              ) {
                data.tags = []
              }
          ...
          initElse() {
            ...
            this.setPreviewResult(
              _Settings__WEBPACK_IMPORTED_MODULE_11__['form'].previewResult
                .checked
            )
            window.addEventListener(
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].events.crawlStart,
              () => {
        ...
        `
          ...
          appendCenterBtns() {
            _DOM__WEBPACK_IMPORTED_MODULE_13__['DOM']
              .addBtn(
                'crawlBtns',
                _Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].green,
            ...
            // 添加收藏本页所有作品的功能
            const bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__[
              'BookmarkAllWorks'
            ]()
          ...
          async filterResult(callback) {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].events.closeCenterPanel
            )
          ...
          reAddResult(removedResult) {
            ...
            this.resultMeta.forEach((data) => {
              const dlCount = _Settings__WEBPACK_IMPORTED_MODULE_11__[
                'setting'
          ...
          async getSearchData(p) {
            let data = await _API__WEBPACK_IMPORTED_MODULE_8__[
              ...
              _PageInfo__WEBPACK_IMPORTED_MODULE_4__['pageInfo'].tag,
              this.worksType,
              p,
              this.option
            )
        ...
        class SaveArtworkData {
          async save(data) {
            ...
            if (
              ...
              let seriesTitle = body.seriesNavData
                ? body.seriesNavData.title
                : ''
              let seriesOrder = body.seriesNavData
              ...
              if (body.illustType !== 2) {
                // 插画或漫画
                // 下载该作品的前面几张
                const dlCount = _Settings__WEBPACK_IMPORTED_MODULE_2__[
                  'setting'
                ...
                const ext =
                  _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].ugoiraSaveAs
  ...
  \***********************************************/
    ...
    */
          initElse() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_9__['EVT'].events.QuickDownload,
              this.startQuickDownload
            )
          }
          initQuickBookmark() {
  ...
  \*****************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../FastScreen */ './src/ts/modules/FastScreen.ts'
        )
        ...
        class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          appendCenterBtns() {
            _DOM__WEBPACK_IMPORTED_MODULE_10__['DOM']
              .addBtn(
                'crawlBtns',
                _Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].green,
                _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl('_开始抓取'),
          ...
          // 获取搜索页的数据。因为有多处使用，所以进行了封装
          async getSearchData(p) {
            let data = await _API__WEBPACK_IMPORTED_MODULE_6__[
              'API'
            ].getNovelSearchData(
              _PageInfo__WEBPACK_IMPORTED_MODULE_4__['pageInfo'].tag,
              p,
          ...
          // 组织要请求的 url 中的参数
          initFetchURL() {
            let p = _API__WEBPACK_IMPORTED_MODULE_6__['API'].getURLSearchField(
              location.href,
              'p'
            )
            this.startpageNo = parseInt(p) || 1
            ...
            this.option = {}
            this.allOption.forEach((param) => {
              let value = _API__WEBPACK_IMPORTED_MODULE_6__[
                'API'
              ].getURLSearchField(location.href, param)
              if (value !== '') {
                this.option[param] = value
          ...
          // 搜索页把下载任务按收藏数从高到低下载
          sortResult() {
            _Store__WEBPACK_IMPORTED_MODULE_7__['store'].resultMeta.sort(
              _API__WEBPACK_IMPORTED_MODULE_6__['API'].sortByProperty('bmk')
            )
            _Store__WEBPACK_IMPORTED_MODULE_7__['store'].result.sort(
              _API__WEBPACK_IMPORTED_MODULE_6__['API'].sortByProperty('bmk')
            )
          }
        }
        ...
        class SaveNovelData {
          async save(data) {
            ...
            if (
              ...
              // 保存作品在排行榜上的编号
              let rank = ''
              let testRank = _Store__WEBPACK_IMPORTED_MODULE_1__[
                'store'
              ].getRankList(body.id)
              if (testRank !== undefined) {
                rank = '#' + testRank
              ...
              let seriesOrder = body.seriesNavData
                ...
                : ''
              let ext =
                _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].novelSaveAs.value
              let metaArr = []
              let meta = ''
              if (
                _Settings__WEBPACK_IMPORTED_MODULE_2__['form'].saveNovelMeta
                  .checked
              ) {
  ...
  \************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ToWebM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./ToWebM */ './src/ts/modules/ugoira/ToWebM.ts'
        )
        /* harmony import */ var _ToGIF__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./ToGIF */ './src/ts/modules/ugoira/ToGIF.ts'
        )
        /* harmony import */ var _ToAPNG__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        class ConvertUgoira {
          constructor() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.convertSuccess,
              () => {
                this.complete()
              }
            )
            ...
            return new Promise(async (resolve, reject) => {
              const t = window.setInterval(async () => {
                if (this._count < this.maxCount) {
                  ...
                  if (type === 'gif') {
                    resolve(
                      _ToGIF__WEBPACK_IMPORTED_MODULE_2__['toGIF'].convert(
                        file,
                        info
                      )
                    )
                    ...
                    resolve(
                      _ToAPNG__WEBPACK_IMPORTED_MODULE_3__['toAPNG'].convert(
                        file,
                        info
                      )
                    )
                    ...
                    resolve(
                      _ToWebM__WEBPACK_IMPORTED_MODULE_1__['toWebM'].convert(
                        file,
                        info
                      )
                    )
        ...
        class ToAPNG {
          async convert(file, info) {
            return new Promise(async (resolve, reject) => {
              ...
              _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].fire(
                _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].events.convertSuccess
              )
              resolve(blob)
            })
          }
