...
class CenterPanel {
    ...
    addCenterPanel() {
      ...
      <p class="centerWrap_title blue"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_下载设置')}</p>
      <div class="btns">
...
class FileName {
    ...
    getFileName(data) {
        ...
        if (_Settings__WEBPACK_IMPORTED_MODULE_1__["form"].multipleImageDir.checked && data.dlCount > 1) {
            ...
            let addString = '';
            if (_Settings__WEBPACK_IMPORTED_MODULE_1__["form"].multipleImageFolderName.value === '1') {
                // 使用作品 id 作为文件夹名
                addString = data.idNum.toString();
            }
            else if (_Settings__WEBPACK_IMPORTED_MODULE_1__["form"].multipleImageFolderName.value === '2') {
                // 遵从命名规则，使用文件名做文件夹名
...
class InitPageBase {
    ...
    async readyCrawl() {
        ...
        _PageInfo__WEBPACK_IMPORTED_MODULE_11__["pageInfo"].store();
        // 进入第一个抓取方法
        this.nextStep();
    }
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
// 初始化搜索页
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    `;
        ...
        this.addBookmark = (event) => {
            const data = event.detail.data;
            const tagString = _Settings__WEBPACK_IMPORTED_MODULE_14__["form"].quickBookmarks.checked ? data.tags : '';
            _API__WEBPACK_IMPORTED_MODULE_9__["API"].addBookmark(data.id.toString(), tagString, _API__WEBPACK_IMPORTED_MODULE_9__["API"].getToken(), false);
    ...
    appendElseEl() {
        const deleteWorks = new _DeleteWorks__WEBPACK_IMPORTED_MODULE_6__["DeleteWorks"](`.${this.listClass}`);
...
class InitWorksPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    destroy() {
        ...
        // 解除切换页面时初始化图片查看器
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].events.pageSwitch, this.initImgViewer);
    }
    getWantPage() {
...
class PageInfo {
    ...
    store() {
        this.getPageInfo();
        _Store__WEBPACK_IMPORTED_MODULE_2__["store"].pageInfo.pageTitle = this.pageTitle;
        _Store__WEBPACK_IMPORTED_MODULE_2__["store"].pageInfo.pageTag = this.pageTag;
    }
    // 获取当前页面的一些信息，用于文件名中
    getPageInfo() {
        this.reset();
...
class QuickBookmark {
    ...
    readyQuickBookmark() {
        this.quickBookmarkEl.addEventListener('click', () => {
            ;
            document.querySelector(`.${this.likeBtnClass}`).click(); // 自动点赞
            let tagString = '';
            // 如果设置了快速收藏，则获取 tag
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _CenterPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _SaveSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SaveSettings */ "./src/ts/modules/SaveSettings.ts");
/* harmony import */ var _SettingHTML__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SettingHTML */ "./src/ts/modules/SettingHTML.ts");
...
class Settings {
    constructor() {
        ...
        this.form = _CenterPanel__WEBPACK_IMPORTED_MODULE_2__["centerPanel"].useSlot('form', _SettingHTML__WEBPACK_IMPORTED_MODULE_4__["default"]);
        ...
        this.bindEvents();
        new _SaveSettings__WEBPACK_IMPORTED_MODULE_3__["SaveSettings"](this.form);
