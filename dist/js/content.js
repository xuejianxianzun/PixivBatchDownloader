...
class Mute {
    ...
    // 此模块不会在初始化时获取设置，这是为了避免增加一次无谓的请求。
    // 当执行此模块的 check 方法时，才会主动获取设置
    // 不过其他模块也可以在必要的时候（如开始抓取时）直接执行此方法，预先获取设置，为后面的流程做准备
...
class FormSettings {
        ...
        for (const name of this.inputFileds.text) {
            ...
            if (name === 'userSetName') {
                this.form.userSetName.addEventListener('focus', (ev) => {
                    Object(_Settings__WEBPACK_IMPORTED_MODULE_2__["setSetting"])(name, this.form.userSetName.value);
                });
            }
    ...
    saveTextInput(name) {
        ...
        el.addEventListener('change', () => {
            ...
            Object(_Settings__WEBPACK_IMPORTED_MODULE_2__["setSetting"])('setWidthAndOr', '');
        });
    }
