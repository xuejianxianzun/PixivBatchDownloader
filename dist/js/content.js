/******/ ;(function (modules) {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _modules_setting_Settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./modules/setting/Settings */ './src/ts/modules/setting/Settings.ts'
        )
        /* harmony import */ var _modules_PageType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./modules/PageType */ './src/ts/modules/PageType.ts'
        )
        /* harmony import */ var _modules_QuickDownload__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./modules/QuickDownload */ './src/ts/modules/QuickDownload.ts'
        )
        /* harmony import */ var _modules_DownloadButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./modules/DownloadButton */ './src/ts/modules/DownloadButton.ts'
        )
        /* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./modules/CenterPanel */ './src/ts/modules/CenterPanel.ts'
        )
        /* harmony import */ var _modules_setting_FormSettings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./modules/setting/FormSettings */ './src/ts/modules/setting/FormSettings.ts'
        )
        /* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./modules/InitPage */ './src/ts/modules/InitPage.ts'
        )
        /* harmony import */ var _modules_DownloadControl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./modules/DownloadControl */ './src/ts/modules/DownloadControl.ts'
        )
        /* harmony import */ var _modules_ListenPageSwitch__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ./modules/ListenPageSwitch */ './src/ts/modules/ListenPageSwitch.ts'
        )
        /* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./modules/Tip */ './src/ts/modules/Tip.ts'
        )
        /* harmony import */ var _modules_Tip__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/ __webpack_require__.n(
          _modules_Tip__WEBPACK_IMPORTED_MODULE_10__
        )
        /* harmony import */ var _modules_TitleBar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./modules/TitleBar */ './src/ts/modules/TitleBar.ts'
        )
        /* harmony import */ var _modules_ViewBigImage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ./modules/ViewBigImage */ './src/ts/modules/ViewBigImage.ts'
        )
        /* harmony import */ var _modules_output_OutputPanel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ./modules/output/OutputPanel */ './src/ts/modules/output/OutputPanel.ts'
        )
        /* harmony import */ var _modules_output_PreviewFileName__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./modules/output/PreviewFileName */ './src/ts/modules/output/PreviewFileName.ts'
        )
        /* harmony import */ var _modules_output_ShowURLs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./modules/output/ShowURLs */ './src/ts/modules/output/ShowURLs.ts'
        )
        /* harmony import */ var _modules_CheckNew__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./modules/CheckNew */ './src/ts/modules/CheckNew.ts'
        )
        /* harmony import */ var _modules_ShowWhatIsNew__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./modules/ShowWhatIsNew */ './src/ts/modules/ShowWhatIsNew.ts'
        )
        /* harmony import */ var _modules_ExportResult2CSV__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./modules/ExportResult2CSV */ './src/ts/modules/ExportResult2CSV.ts'
        )
        /* harmony import */ var _modules_ExportResult__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ./modules/ExportResult */ './src/ts/modules/ExportResult.ts'
        )
        /* harmony import */ var _modules_ImportResult__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ./modules/ImportResult */ './src/ts/modules/ImportResult.ts'
        )
        /* harmony import */ var _modules_ExportLST__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
          /*! ./modules/ExportLST */ './src/ts/modules/ExportLST.ts'
        )
        /* harmony import */ var _modules_ShowHowToUse__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
  ...
  \***************************************/
      ...
      `
            ...
            const donateId =
              _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].flag === 'zh-cn'
                ? 'zanzhu'
                : 'patreon'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Deduplication {
          ...
          async exportRecord() {
            ...
            _Tools__WEBPACK_IMPORTED_MODULE_7__['Tools'].downloadFile(
              url,
              `record-${_Tools__WEBPACK_IMPORTED_MODULE_7__[
                'Tools'
          ...
          // 导入下载记录
          async importRecord() {
            const record = await _Tools__WEBPACK_IMPORTED_MODULE_7__['Tools']
              .loadJSONFile()
              .catch((err) => {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class DeleteWorks {
          ...
          addManuallyDeleteBtn(callback = () => {}) {
            ...
            this.delBtn = _DOM__WEBPACK_IMPORTED_MODULE_3__[
              'DOM'
            ].addBtn(
              'crawlBtns',
              _Colors__WEBPACK_IMPORTED_MODULE_2__['Colors'].bgRed,
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class ExportResult {
          ...
          output() {
            ...
            const blob = new Blob([str], { type: 'application/json' })
            const url = URL.createObjectURL(blob)
            _Tools__WEBPACK_IMPORTED_MODULE_4__['Tools'].downloadFile(
              url,
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class FileName {
          ...
          getFileName(data) {
            ...
            // 替换命名规则里的特殊字符
            result = _Tools__WEBPACK_IMPORTED_MODULE_5__[
              'Tools'
            ...
            for (const [key, val] of Object.entries(cfg)) {
              if (result.includes(key)) {
                ...
                // 替换标记值中的特殊字符
                if (!val.safe) {
                  once = _Tools__WEBPACK_IMPORTED_MODULE_5__[
                    'Tools'
          ...
          sort(flag) {
            if (this.allList[flag]) {
              this.allList[flag].sort(
                _Tools__WEBPACK_IMPORTED_MODULE_1__['Tools'].sortByProperty(
                  'page',
                  'asc'
                )
              )
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class ImportResult {
          ...
          async import() {
            const loadedJSON = await _Tools__WEBPACK_IMPORTED_MODULE_2__[
              'Tools'
            ]
              .loadJSONFile()
              .catch((err) => {
        ...
        class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          addAnyElement() {
            ...
            if (_Token__WEBPACK_IMPORTED_MODULE_8__['token'].token) {
              const btn = _DOM__WEBPACK_IMPORTED_MODULE_7__[
                'DOM'
              ].addBtn(
                'otherBtns',
                _Colors__WEBPACK_IMPORTED_MODULE_2__['Colors'].bgGreen,
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./Tools */ './src/ts/modules/Tools.ts'
        )
        // 初始化所有页面抓取流程的基类
          ...
          getFlag(value) {
            ...
            if (!value) {
              const savedSettings = localStorage.getItem(
                _Config__WEBPACK_IMPORTED_MODULE_3__['default'].settingStoreName
              )
              if (savedSettings) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class QuickDownload {
          ...
          sendDownload() {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].list.QuickDownload
            )
            const isNovel = window.location.href.includes('/novel')
            const idList = [
              {
                type: isNovel ? 'novels' : 'unknown',
                id: _API__WEBPACK_IMPORTED_MODULE_0__['API'].getIllustId(
        ...
        class ShowWhatIsNew {
          ...
          show() {
            ...
            if (
              ...
              _MsgBox__WEBPACK_IMPORTED_MODULE_2__['msgBox'].show(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(this.newTag),
                {
                  title:
...
*/
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ImgViewer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
  ...
  <use xlink:href="#icon-fangda"></use>
          ...
          bindEvents() {
            ...
            // 页面切换时隐藏按钮
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_2__['EVT'].list.pageSwitch,
              () => {
                this.hiddenBtn()
              }
            )
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class VipSearchOptimize {
          ...
          async stopCrawl(data, ajaxThread) {
            ...
            // 判断收藏数量是否不符合要求
            const check = await _filter_Filter__WEBPACK_IMPORTED_MODULE_4__[
              'filter'
            ].check({
          ...
          setVipOptimize() {
            ...
            // 判断 order 方式
            const order = _API__WEBPACK_IMPORTED_MODULE_2__[
              'API'
            ...
            return _setting_Settings__WEBPACK_IMPORTED_MODULE_3__['settings']
              .BMKNumSwitch
          }
          isVip() {
            ...
            if (this.crawlNumber !== -1) {
              ...
              if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_5__['store'].idList
                  .sort(
                    _Tools__WEBPACK_IMPORTED_MODULE_11__[
                      'Tools'
                    ].sortByProperty('id')
                  )
                  .reverse()
            ...
            if (this.crawlNumber !== -1) {
              ...
              if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_4__['store'].idList
                  .sort(
                    _Tools__WEBPACK_IMPORTED_MODULE_9__['Tools'].sortByProperty(
                      'id'
                    )
                  )
                  .reverse()
    ...
    `
          ...
          output(
            ...
            if (
              ...
              _Tools__WEBPACK_IMPORTED_MODULE_3__['Tools'].downloadFile(
                url,
                fileName
              )
              // 禁用复制按钮
        ...
        class FormSettings {
          ...
          restoreDate(name) {
            if (
              ...
              const date =
                _Settings__WEBPACK_IMPORTED_MODULE_2__['settings'][name]
              this.form[name].value = _DateFormat__WEBPACK_IMPORTED_MODULE_3__[
                'DateFormat'
  ...
  \********************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Settings {
          ...
          assignSettings(data) {
            const origin = _Tools__WEBPACK_IMPORTED_MODULE_1__[
              'Tools'
            ].deepCopy(data)
          ...
          async importSettings() {
            const loadedJSON = await _Tools__WEBPACK_IMPORTED_MODULE_1__[
              'Tools'
            ]
              .loadJSONFile()
              .catch((err) => {
          ...
          setSetting(key, value) {
            ...
            if (Array.isArray(this.defaultSettings[key])) {
              if (this.stringArrayKey.includes(key)) {
                // 字符串转换成 string[]
                if (valueType === 'string') {
                  value = _Tools__WEBPACK_IMPORTED_MODULE_1__[
                    'Tools'
                  ].string2array(value)
                }
              }
