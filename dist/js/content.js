        ...
        for (const d of data) {
            ...
            for (const field of this.fieldCfg) {
                if (field.name === 'fileName') {
                    ...
                    // 对于某些字段，将其内容特殊化处理
                    if (field.name === 'type') {
                        result = _Config__WEBPACK_IMPORTED_MODULE_3__["default"].illustTypes[result];
                    }
...
/* harmony import */ var _DateFormat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DateFormat */ "./src/ts/modules/DateFormat.ts");
...
class FileName {
    ...
    getFileName(data) {
        ...
        const cfg = {
            ...
            '{date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_4__["DateFormat"].format(data.date, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{task_date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_4__["DateFormat"].format(_Store__WEBPACK_IMPORTED_MODULE_1__["store"].crawlCompleteTime, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{type}': {
                value: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].illustTypes[data.type],
                prefix: '',
                safe: true,
            },
            '{series_title}': {
        ...
        // 替换命名规则里的特殊字符
        result = _Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].replaceUnsafeStr(result);
        ...
        for (const [key, val] of Object.entries(cfg)) {
            if (result.includes(key)) {
                ...
                // 替换标记值中的特殊字符
                if (!val.safe) {
                    once = _Tools__WEBPACK_IMPORTED_MODULE_5__["Tools"].replaceUnsafeStr(once);
                }
                // 添加标记名称
        ...
        if (_States__WEBPACK_IMPORTED_MODULE_3__["states"].quickDownload &&
            _Store__WEBPACK_IMPORTED_MODULE_1__["store"].result.length === 1 &&
            !_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].alwaysFolder) {
...
class ShowWhatIsNew {
    ...
    show() {
        ...
        if (window.location.host.includes('pixiv.net') && value !== this.newTag) {
            _MsgBox__WEBPACK_IMPORTED_MODULE_2__["msgBox"].show(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl(this.newTag), {
...
const formHtml = `<form class="settingForm">
    <div class="tabsContnet">
      ...
      <span class="beautify_checkbox"></span>
      <label for="setDownNotBookmarked"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_未收藏')}&nbsp;</label>
      <input type="checkbox" name="downBookmarked" id="setDownBookmarked" class="need_beautify checkbox_common" checked>
      <span class="beautify_checkbox"></span>
      <label for="setDownBookmarked"> ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_已收藏')}&nbsp;</label>
      </p>
      ...
      <span class="has_tip settingNameStyle1" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_日均收藏数量的提示')}">
    ...
    <p class="option" data-no="13">
      ...
      <p class="tip tipWithBtn" id="tipCreateFolder">
        <span class="left">
        ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_设置文件夹名的提示')}<strong>{user}/{id}</strong>
        </span>
        <span class="right">
      ...
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_为作品创建单独的文件夹')}</span>
    ...
    <div class="tabsContnet">
      ...
      <input type="text" name="blockList" class="setinput_style1 blue setinput_tag" placeholder="${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_用户ID必须是数字')}">
      </span>
      </p>

      <p class="option" data-no="39">
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_针对特定用户屏蔽tag')}</span>
      ...
      <button type="button" class="gray1 textButton showDateTip">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_提示')}</button>
      </p>
      <p class="dateFormatTip tip" style="display:none">
      <span>${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_日期格式提示')}</span>
      <br>
      ...
      <span class="beautify_radio"></span>
      <label for="userSetLang1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_自动检测')}</label>
      &nbsp;
      ...
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_管理设置')}</span>
      <button class="textButton gray1" type="button" id="exportSettings">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_导出设置')}</button>
      <button class="textButton gray1" type="button" id="importSettings">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_导入设置')}</button>
