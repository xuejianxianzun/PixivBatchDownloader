...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() {
        this.hotBar();
        this.setPreviewResult(_setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].previewResult);
    ...
    setPreviewResult(value) {
        ...
        _States__WEBPACK_IMPORTED_MODULE_16__["states"].notAutoDownload = value ? true : false;
    }
    // 返回包含作品列表的 ul 元素
    getWorksWrap() {
