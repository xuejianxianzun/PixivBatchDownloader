/******/ ;(function(modules) {
  ...
  \************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _BeautifyForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./BeautifyForm */ './src/ts/modules/BeautifyForm.ts'
        )
  ...
  <span class="beautify_radio"></span>
  <label for="checkFavNum0">  ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
    'lang'
  ].transl('_不限制')}&nbsp; </label>
  <input type="radio" name="checkFavNum" id="checkFavNum1" class="need_beautify radio" value="1">
  <span class="beautify_radio"></span>
  <label for="checkFavNum1">  ${_Lang__WEBPACK_IMPORTED_MODULE_0__[
    'lang'
  ].transl('_大于')}&nbsp; </label>
  ...
  <span class="beautify_radio"></span>
  <label for="idRange0">  ${_Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
    '_不限制'
  )}&nbsp; </label>
  ...
  <input type="hidden" name="debut" value="0">
            ...
            new _BeautifyForm__WEBPACK_IMPORTED_MODULE_5__['BeautifyForm'](
              this.form
            )
          }
          // 把下拉框的选择项插入到文本框里
