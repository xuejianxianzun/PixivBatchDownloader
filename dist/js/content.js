...
/* harmony import */ var _modules_setting_Settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _modules_PageType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _modules_QuickDownload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/QuickDownload */ "./src/ts/modules/QuickDownload.ts");
/* harmony import */ var _modules_DownloadButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/DownloadButton */ "./src/ts/modules/DownloadButton.ts");
/* harmony import */ var _modules_CenterPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _modules_setting_FormSettings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/setting/FormSettings */ "./src/ts/modules/setting/FormSettings.ts");
/* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/InitPage */ "./src/ts/modules/InitPage.ts");
/* harmony import */ var _modules_DownloadControl__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/DownloadControl */ "./src/ts/modules/DownloadControl.ts");
/* harmony import */ var _modules_ListenPageSwitch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/ListenPageSwitch */ "./src/ts/modules/ListenPageSwitch.ts");
...
/* harmony import */ var _modules_ImportResult__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/ImportResult */ "./src/ts/modules/ImportResult.ts");
...
/* harmony import */ var _modules_ShowHowToUse__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/ShowHowToUse */ "./src/ts/modules/ShowHowToUse.ts");
/*
...
class FastScreen {
    ...
    openFastScreenLink(secondTag) {
        ...
        const nowTag = _API__WEBPACK_IMPORTED_MODULE_0__["API"].getTagFromURL();
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addAnyElement() {
        ...
        bookmarkAllBtn.addEventListener('click', async () => {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag = _API__WEBPACK_IMPORTED_MODULE_4__["API"].getTagFromURL();
...
class Lang {
    ...
    bindEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.settingChange, () => {
            ...
            this.setFlag();
            if (this.flag !== old) {
                _MsgBox__WEBPACK_IMPORTED_MODULE_3__["msgBox"].show(this.transl('_变更语言后刷新页面的提示'));
            }
        });
    }
    setFlag() {
...
class MsgBox {
    ...
    create(data) {
        ...
        <button class="btn" type="button">${data.btn || 'OK'}</button>
      `;
        // theme.register(el)
        document.body.insertAdjacentElement('afterbegin', el);
...
class QuickBookmark {
    ...
    async bookmark(type, id) {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].widthTag === 'yes') {
            const data = await _API__WEBPACK_IMPORTED_MODULE_0__["API"].getArtworkData(id);
    ...
    getEditBookmarkLink() {
        if (this.isNovel) {
            return `/novel/bookmark_add.php?id=${_API__WEBPACK_IMPORTED_MODULE_0__["API"].getNovelId()}`;
        }
        else {
            return `/bookmark_add.php?type=illust&illust_id=${_API__WEBPACK_IMPORTED_MODULE_0__["API"].getIllustId()}`;
        }
    }
    // 如果这个作品已收藏，则改变快速收藏按钮
    bookmarked() {
...
class QuickDownload {
    constructor() {
        this.show = true; // 是否显示
        // 指定在哪些页面类型里启用
        this.enablePageType = [_PageType__WEBPACK_IMPORTED_MODULE_3__["pageType"].list.Artwork, _PageType__WEBPACK_IMPORTED_MODULE_3__["pageType"].list.Novel];
        this.addBtn();
        this.setVisible();
        this.bindEvents();
    }
    addBtn() {
        ...
        this.btn.textContent = '↓';
        this.btn.setAttribute('title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_快速下载本页') + ' (Alt + Q)');
        document.body.insertAdjacentElement('afterbegin', this.btn);
    }
    bindEvents() {
        // 点击按钮启动快速下载
        ...
        const idList = [
            {
                ...
                id: _API__WEBPACK_IMPORTED_MODULE_0__["API"].getIllustId(window.location.href),
            },
        ];
        _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.downloadIdList, idList);
    }
    setVisible() {
...
class VipSearchOptimize {
    ...
    async stopCrawl(data, ajaxThread) {
        ...
        if (!this.vipSearchOptimize || !_setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].BMKNumSwitch) {
            return false;
        }
        // 连续多少个作品没有达到要求，则停止抓取
        ...
        // 判断收藏数量是否不符合要求
        const check = await _filter_Filter__WEBPACK_IMPORTED_MODULE_4__["filter"].check({
    ...
    setVipOptimize() {
        ...
        // 判断 order 方式
        const order = _API__WEBPACK_IMPORTED_MODULE_2__["API"].getURLSearchField(window.location.href, 'order');
        // 无排序方式
        if (!order) {
            return false;
        }
        ...
        return _setting_Settings__WEBPACK_IMPORTED_MODULE_3__["settings"].BMKNumSwitch;
    }
    isVip() {
...
class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    // 组织要请求的 url 中的参数
    initFetchURL() {
        let p = _API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 从页面 url 中获取可以使用的选项
        this.option = {};
        this.allOption.forEach((param) => {
            let value = _API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLSearchField(location.href, param);
            if (value !== '') {
                this.option[param] = value;
            }
        });
