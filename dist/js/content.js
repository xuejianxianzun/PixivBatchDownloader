  ...
  \*******************************************/
    ...
    <span class="convert_tip warn"></span>
          ...
          readyDownload() {
            ...
            this.setDownloaded = _DownloadStates__WEBPACK_IMPORTED_MODULE_10__[
              'downloadStates'
            ].downloadedCount()
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class FileName {
          ...
          getFileName(data) {
            // 为空时使用 {id}
            let result =
              _Settings__WEBPACK_IMPORTED_MODULE_1__['form'].userSetName
                .value || '{id}'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Resume {
          ...
          async initDB() {
            return new Promise((resolve, reject) => {
              const request = indexedDB.open(
                _Config__WEBPACK_IMPORTED_MODULE_0__['default'].dbName,
                2
              )
              request.onupgradeneeded = (ev) => {
                // 创建表和索引
                const metaStore = request.result.createObjectStore(
                  this.metaName,
                  {
                    keyPath: 'id',
                  }
                ...
                const dataStore = request.result.createObjectStore(
                  this.dataName,
                  {
                    keyPath: 'id',
                  }
                ...
                const statesStore = request.result.createObjectStore(
                  this.statesName,
                  {
                    keyPath: 'id',
                  }
          ...
          bindEvent() {
            ...
            // 当有文件下载完成时，更新下载状态
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.downloadSucccess,
              () => {
          ...
          async saveTaskData() {
            return new Promise(async (resolve, reject) => {
              ...
              let data = {
                ...
                data: _Store__WEBPACK_IMPORTED_MODULE_2__['store'].result.slice(
                  this.getPartTotal(),
