...
class CrawlRankingPage extends _CrawlPageBase__WEBPACK_IMPORTED_MODULE_0__["CrawlPageBase"] {
    ...
    async getIdList() {
        ...
        for (const data of contents) {
            ...
            if (_Settings__WEBPACK_IMPORTED_MODULE_1__["form"].debut.value === '0' && data.rank > this.crawlNumber) {
                complete = true;
                break;
            }
    ...
    resetGetIdListStatus() {
        this.listPageFinished = 0;
        _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].debut.value = '0';
    }
    destroy() { }
}
...
class DeleteWorks {
    constructor(worksSelectors) {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].events.worksUpdate, () => {
            if (this.delMode) {
    ...
    addClearMultipleBtn(selector, callback = () => { }) {
        ...
        _UI__WEBPACK_IMPORTED_MODULE_4__["ui"].addCenterButton(_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].red, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除多图作品'), [
    ...
    addClearUgoiraBtn(selector, callback = () => { }) {
        ...
        _UI__WEBPACK_IMPORTED_MODULE_4__["ui"].addCenterButton(_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].red, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除动图作品'), [
    ...
    addManuallyDeleteBtn(callback = () => { }) {
        ...
        const delBtn = _UI__WEBPACK_IMPORTED_MODULE_4__["ui"].addCenterButton(_Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].red, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品Title')]]);
...
class DownloadControl {
  ...
  <span class="download_fileName"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_已下载')}&nbsp;&nbsp;<span class="loaded">0/0</span>KB
    ...
    <ul class="centerWrap_down_list">
        ...
        const el = _UI__WEBPACK_IMPORTED_MODULE_6__["ui"].useSlot('downloadArea', html);
        if (!el) {
...
class InitIndexPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendElseEl() {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_5__["DOM"].insertToHead(this.downIdInput);
...
class InitPageBase {
    ...
    destroy() {
        this.destroySelf();
        _UI__WEBPACK_IMPORTED_MODULE_1__["ui"].clearCenterButtons();
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendCenterBtns() {
        ...
        _UI__WEBPACK_IMPORTED_MODULE_4__["ui"].addCenterButton(_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].red, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_在结果中筛选'), [
