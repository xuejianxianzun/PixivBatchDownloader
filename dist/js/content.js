/******/ ;(function (modules) {
        ...
        class Filter {
          ...
          throwError(msg) {
            _EVT__WEBPACK_IMPORTED_MODULE_3__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_3__['EVT'].events.crawlError
            )
          ...
          getIncludeTag() {
            ...
            const result = this.getTagString(
              _setting_Settings__WEBPACK_IMPORTED_MODULE_5__['settings'].needTag
            )
            if (result) {
              _Log__WEBPACK_IMPORTED_MODULE_1__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
          ...
          getSetWh() {
            ...
            const checkWidth = _API__WEBPACK_IMPORTED_MODULE_2__[
              'API'
            ].checkNumberGreater0(
              _setting_Settings__WEBPACK_IMPORTED_MODULE_5__['settings']
                .setWidth
            )
            const checkHeight = _API__WEBPACK_IMPORTED_MODULE_2__[
              'API'
            ].checkNumberGreater0(
              _setting_Settings__WEBPACK_IMPORTED_MODULE_5__['settings']
                .setHeight
            ...
            if (checkWidth.value > 0 || checkHeight.value > 0) {
              ...
              _Log__WEBPACK_IMPORTED_MODULE_1__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl('_宽度设置') +
                  result.width +
                  result.andOr
                    .replace(
                      '|',
          ...
          checkDownType(illustType) {
            if (illustType === undefined) {
              ...
              switch (illustType) {
                case 0:
                  return _setting_Settings__WEBPACK_IMPORTED_MODULE_5__[
                    'settings'
                  ].downType0
                    ? true
                    : false
          ...
          bindEvent() {
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_3__['EVT'].events.crawlStart,
              () => {
                this.init()
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_3__['EVT'].events.resume,
              () => {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitPageBase {
          ...
          init() {
            ...
            this.initAny()
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].events
                .pageSwitchedTypeChange,
              () => {
                this.destroy()
              }
          ...
          getWantPageError() {
            _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_6__['EVT'].events.crawlError
            )
            const msg = _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
              '_参数不合法'
            )
          ...
          getMultipleSetting() {
            ...
            if (
              ...
              this.firstFewImages = _setting_SettingAPI__WEBPACK_IMPORTED_MODULE_9__[
                'settingAPI'
              ].getFirstFewImages()
              _Log__WEBPACK_IMPORTED_MODULE_5__['log'].warning(
                _Lang__WEBPACK_IMPORTED_MODULE_0__['lang'].transl(
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _SaveAvatarIcon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_7__['DOM']
              ...
              .addEventListener('click', () => {
                _EVT__WEBPACK_IMPORTED_MODULE_8__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_8__['EVT'].events.saveAvatarIcon
                )
              })
          }
          setFormOption() {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Store {
          ...
          addResult(data) {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.addResult,
              result
            )
            if (result.type === 3) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class Support {
          ...
          showNew() {
            ...
            const newTag =
              _Config__WEBPACK_IMPORTED_MODULE_3__['default'].newTag
...
*/
  ...
  \*********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _setting_SettingAPI__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../setting/SettingAPI */ './src/ts/modules/setting/SettingAPI.ts'
        )
          ...
          constructor() {
            ...
            this.showCount = () => {
              const count =
                ...
                _Store__WEBPACK_IMPORTED_MODULE_8__['store'].resultMeta.length
              if (count > 0) {
    ...
    `
            ...
            this.addBookmark = (event) => {
              ...
              _API__WEBPACK_IMPORTED_MODULE_7__['API'].addBookmark(
                'illusts',
                data.id.toString(),
                data.tags,
                false,
                _API__WEBPACK_IMPORTED_MODULE_7__['API'].getToken()
              )
            ...
            this.onCrawlFinish = () => {
              this.resultMeta = [
                ..._Store__WEBPACK_IMPORTED_MODULE_8__['store'].resultMeta,
              ]
              // 显示作品数量
              const count =
                this.resultMeta.length ||
              ...
              // 解绑创建作品元素的事件
              window.removeEventListener(
                _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.addResult,
                this.createWork
              )
              setTimeout(() => {
                _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].fire(
            ...
            this.onSettingChange = (event) => {
              ...
              if (this.causeResultChange.includes(data.name)) {
                this.reAddResult()
                _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].fire(
                  _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.resultChange
                )
              }
            }
            this.init()
          ...
          initAny() {
            ...
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.clearMultiple,
              this.clearMultiple
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.clearUgoira,
              this.clearUgoira
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.deleteWork,
              this.deleteWork
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.settingChange,
        ...
        `
          ...
          async filterResult(callback) {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_5__['EVT'].events.closeCenterPanel
            )
          ...
          reAddResult() {
            ...
            for (let data of this.resultMeta) {
              const dlCount = _setting_SettingAPI__WEBPACK_IMPORTED_MODULE_11__[
                'settingAPI'
          ...
          screenInResult() {
            ...
            this.filterResult((data) => {
              ...
              return _Filter__WEBPACK_IMPORTED_MODULE_6__['filter'].check(
                filterOpt
              )
            })
          }
          ...
          async getSearchData(p) {
            let data = await _API__WEBPACK_IMPORTED_MODULE_7__[
              ...
              _Store__WEBPACK_IMPORTED_MODULE_8__['store'].tag,
              this.worksType,
              p,
              this.option
            )
        ...
        */
            ...
            let p = _API__WEBPACK_IMPORTED_MODULE_7__['API'].getURLSearchField(
              location.href,
              'p'
            )
            this.startpageNo = parseInt(p) || 1
            ...
            this.allOption.forEach((param) => {
              let value = _API__WEBPACK_IMPORTED_MODULE_7__[
                'API'
          ...
          // 搜索页把下载任务按收藏数从高到低下载
          sortResult() {
            _Store__WEBPACK_IMPORTED_MODULE_8__['store'].resultMeta.sort(
              _API__WEBPACK_IMPORTED_MODULE_7__['API'].sortByProperty('bmk')
            )
            _Store__WEBPACK_IMPORTED_MODULE_8__['store'].result.sort(
              _API__WEBPACK_IMPORTED_MODULE_7__['API'].sortByProperty('bmk')
            )
          }
        ...
        class Options {
          ...
          setWantPage(arg) {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_0__[
              ...
              _EVT__WEBPACK_IMPORTED_MODULE_0__['EVT'].events.settingChange,
              { name: 'setWantPage', value: arg.value }
            )
          }
        }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class SettingAPI {
          ...
          getFirstFewImages() {
            ...
            // 如果用户输入的数字不合法（不大于0）
            _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].fire(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].events.crawlError
            )
            const msg =
              _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
                '_下载前几张图片'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class SaveSettings {
          ...
          ListenOptionChange() {
            ...
            // 保存命名规则
            const userSetNameInput =
              _Form__WEBPACK_IMPORTED_MODULE_1__['form'].userSetName
          ...
          restoreBoolean(name) {
            ...
            if (this.settings[name] !== undefined) {
              _Form__WEBPACK_IMPORTED_MODULE_1__['form'][
                name
              ...
              _Form__WEBPACK_IMPORTED_MODULE_1__['form'][
                name
              ].checked = this.optionDefault[name]
            }
          ...
          restoreString(name) {
            ...
            if (this.settings[name] !== undefined) {
              _Form__WEBPACK_IMPORTED_MODULE_1__['form'][
                name
              ].value = this.settings[name].toString()
            } else {
              // 否则使用默认值
              _Form__WEBPACK_IMPORTED_MODULE_1__['form'][
                name
              ].value = this.optionDefault[name].toString()
            }
          }
