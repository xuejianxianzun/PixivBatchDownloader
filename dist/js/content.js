  ...
  \**********************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        class Filter {
          ...
          getDownType() {
            this.downType0 =
              _UI__WEBPACK_IMPORTED_MODULE_0__['ui'].form.downType0.checked
            this.downType1 =
              _UI__WEBPACK_IMPORTED_MODULE_0__['ui'].form.downType1.checked
            this.downType2 =
              _UI__WEBPACK_IMPORTED_MODULE_0__['ui'].form.downType2.checked
            // 如果全部排除则取消任务
          ...
          restoreBoolean(name) {
            ...
            if (this.needSaveOpts[name] !== undefined) {
              _UI__WEBPACK_IMPORTED_MODULE_0__['ui'].form[
                name
              ].checked = this.needSaveOpts[name]
            } else {
              // 否则使用默认值
              _UI__WEBPACK_IMPORTED_MODULE_0__['ui'].form[
                name
              ].checked = this.needSaveOptsDefault[name]
            }
