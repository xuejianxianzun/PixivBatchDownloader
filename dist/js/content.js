...
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Config */ "./src/ts/modules/Config.ts");
// 下载控制
...
class DownloadControl {
    ...
    readyDownload() {
        ...
        // 视情况自动开始下载
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_6__["settings"].quietDownload || _States__WEBPACK_IMPORTED_MODULE_13__["states"].quickDownload) {
            this.startDownload();
        }
    }
    // 开始下载
    ...
    setDownloadThread() {
        ...
        if (setThread < 1 ||
            setThread > _Config__WEBPACK_IMPORTED_MODULE_14__["default"].downloadThreadMax ||
            isNaN(setThread)) {
            // 如果数值非法，则重设为默认值
            this.thread = _Config__WEBPACK_IMPORTED_MODULE_14__["default"].downloadThreadMax;
        }
        else {
