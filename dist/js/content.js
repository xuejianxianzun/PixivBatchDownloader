      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class BookmarkAllWorks {
          constructor() {
            ...
            this.idList = []
            this.bookmarKData = []
            this.btn = _DOM__WEBPACK_IMPORTED_MODULE_1__['DOM'].addBtn(
              'otherBtns',
        ...
        class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          getWantPage() {
            this.crawlNumber = this.checkWantPageInput(
              ...
              _Lang__WEBPACK_IMPORTED_MODULE_4__['lang'].transl('_下载所有页面')
            )
          }
          nextStep() {
            if (window.location.pathname.includes('/novel')) {
...
*/
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ThemeColor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../ThemeColor */ './src/ts/modules/ThemeColor.ts'
        )
        ...
        class Form {
          constructor() {
            ...
            // 激活第一个选项卡
            this.activeTab(0)
            _ThemeColor__WEBPACK_IMPORTED_MODULE_6__['themeColor'].register(
              this.form
            )
          }
          // 设置表单上美化元素的状态
  ...
  \********************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./Form */ './src/ts/modules/setting/Form.ts'
        )
        ...
        class Settings {
          ...
          ListenChange() {
            ...
            // 保存 wantPageArr
            _Form__WEBPACK_IMPORTED_MODULE_2__[
              'form'
            ].setWantPage.addEventListener('change', () => {
              const temp = Array.from(this.settings.wantPageArr)
              temp[_PageType__WEBPACK_IMPORTED_MODULE_1__['pageType'].type] =
                _Form__WEBPACK_IMPORTED_MODULE_2__['form'].setWantPage.value
            ...
            const userSetNameInput =
              _Form__WEBPACK_IMPORTED_MODULE_2__['form'].userSetName
          ...
          restoreBoolean(name) {
            ...
            if (this.settings[name] !== undefined) {
              _Form__WEBPACK_IMPORTED_MODULE_2__['form'][
                name
