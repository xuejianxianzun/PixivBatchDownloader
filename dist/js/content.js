/******/ ;(function (modules) {
  ...
  \********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _MouseOverThumbnail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        ...
        class ShowBigThumb {
          ...
          bindEvents() {
            _MouseOverThumbnail__WEBPACK_IMPORTED_MODULE_1__[
              'mouseOverThumbnail'
            ].onEnter((el, id) => {
              console.log(id)
              this.workId = id
          ...
          showWrap() {
            ...
            if (cfg.left < 0) {
              ...
              const num =
                window.innerWidth - 17 - (cfg.left + cfg.width + this.border)
              if (num < 0) {
