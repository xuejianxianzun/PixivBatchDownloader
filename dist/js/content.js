...
class CreateCSV {
    ...
    create(data) {
        ...
        const name = data.fileName || _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].getTitle();
        _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].downloadFile(url, _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].replaceUnsafeStr(name) + '.csv');
        return url;
    }
    UTF8BOM() {
...
class DeleteWorks {
    ...
    addClearMultipleBtn(selector, callback = () => { }) {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除多图作品'), [
    ...
    addClearUgoiraBtn(selector, callback = () => { }) {
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_清除动图作品'), [
    ...
    addManuallyDeleteBtn(callback = () => { }) {
        ...
        this.delBtn = _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_手动删除作品Title')]]);
...
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Config */ "./src/ts/modules/Config.ts");
...
class DownloadControl {
    ...
    <button class="startDownload" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgBlue};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_开始下载')}</button>
    <button class="pauseDownload" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgYellow};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_暂停下载')}</button>
    <button class="stopDownload" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgRed};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_停止下载')}</button>
    <button class="copyUrl" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgGreen};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_复制url')}</button>
    </div>
    ...
    setDownloadThread() {
        ...
        if (setThread < 1 ||
            setThread > _Config__WEBPACK_IMPORTED_MODULE_15__["default"].downloadThreadMax ||
            isNaN(setThread)) {
            // 如果数值非法，则重设为默认值
            this.thread = _Config__WEBPACK_IMPORTED_MODULE_15__["default"].downloadThreadMax;
        }
        else {
    ...
    setDownloaded() {
        ...
        if (this.downloaded === _Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length) {
            ...
            this.reset();
            this.setDownStateText(_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_下载完毕'), _Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].textSuccess);
        }
    ...
    // 设置下载状态文本，默认颜色为主题蓝色
    setDownStateText(text, color = _Colors__WEBPACK_IMPORTED_MODULE_5__["Colors"].bgBlue) {
...
/* harmony import */ var _CreateCSV__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./CreateCSV */ "./src/ts/modules/CreateCSV.ts");
        ...
        for (const d of data) {
            ...
            for (const field of this.fieldCfg) {
                if (field.name === 'fileName') {
                    ...
                    // 对于某些字段，将其内容特殊化处理
                    if (field.name === 'type') {
                        result = _Config__WEBPACK_IMPORTED_MODULE_3__["default"].worksTypeName[result];
                    }
...
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Config */ "./src/ts/modules/Config.ts");
...
class FileName {
    ...
    getFileName(data) {
        ...
        const cfg = {
            ...
            '{type}': {
                value: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].worksTypeName[data.type],
                prefix: '',
                safe: true,
            },
            '{series_title}': {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].createFolderByType) {
            ...
            if (allSwitch[data.type]) {
                const folder = _Config__WEBPACK_IMPORTED_MODULE_2__["default"].worksTypeName[data.type];
...
class InitBookmarkLegacyPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
        // 添加下载推荐作品的按钮
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_抓取推荐作品'), [
    ...
    addAnyElement() {
        ...
        if (_Token__WEBPACK_IMPORTED_MODULE_3__["token"].token) {
            const btn = _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_给未分类作品添加添加tag'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_给未分类作品添加添加tag')]]);
    ...
    async getIdList() {
        let data;
        try {
            data = await _API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].getUserId(), this.type, _Store__WEBPACK_IMPORTED_MODULE_7__["store"].tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取'), [
    ...
    addAnyElement() {
        ...
        if (_Token__WEBPACK_IMPORTED_MODULE_8__["token"].token) {
            const btn = _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_给未分类作品添加添加tag'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_给未分类作品添加添加tag')]]);
    ...
    async getIdList() {
        let data;
        try {
            data = await _API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].getUserId(), this.type, _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
...
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _CreateCSV__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CreateCSV */ "./src/ts/modules/CreateCSV.ts");
...
class InitFollowingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_7__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_下载用户列表')).addEventListener('click', () => {
...
class InitHomePage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        this.downIdButton = _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_输入id进行抓取'), [['id', 'down_id_button']]);
    }
    addAnyElement() {
        // 用于输入id的输入框
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_清空已保存的抓取结果')).addEventListener('click', () => {
...
class InitPageBase {
    ...
    // 添加抓取区域的按钮
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_开始抓取'), [
...
class InitPixivisionPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        ...
        if (type === 'illustration' || type === 'manga' || type === 'cosplay') {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取该页面的图片')).addEventListener('click', () => {
                this.readyCrawl();
            }, false);
        }
    }
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    // 添加中间按钮
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    addAnyElement() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveAvatarImage);
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户封面')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveUserCover);
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像为图标'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_保存用户头像为图标说明')]]).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.saveAvatarIcon);
        });
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
    ...
    async getIdList() {
        ...
        let idList = await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type);
    ...
    async getIdListByTag() {
        ...
        const offset = this.getOffset();
        const requsetNumber = this.getRequsetNumber();
        let data = await _API__WEBPACK_IMPORTED_MODULE_4__["API"].getUserWorksByTypeWithTag(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), flag, _Store__WEBPACK_IMPORTED_MODULE_5__["store"].tag, offset, requsetNumber);
...
const langText = {
    ...
    _任务开始0: ['任务开始', '工作開始', 'Task starts', 'タスクが開始されます'],
    _排除作品类型: [
        '排除作品类型：',
        '排除作品類型：',
...
class QuickDownload {
    ...
    sendDownload() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.downloadIdList, idList);
    }
    setVisible() {
...
class SelectWork {
    ...
    addBtn() {
        this.controlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_手动选择作品'));
        this.updateControlBtn();
        this.clearBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgRed, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_清空选择的作品'));
        this.clearBtn.style.display = 'none';
        this.clearBtn.addEventListener('click', () => {
            this.clearIdList();
        });
        this.crawlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__["DOM"].addBtn('selectWorkBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取选择的作品'));
    ...
    show() {
        ...
        if (_Tools__WEBPACK_IMPORTED_MODULE_3__["Tools"].isPixiv() && value !== this.flag) {
            _MsgBox__WEBPACK_IMPORTED_MODULE_2__["msgBox"].show(this.msg, {
                title: _Config__WEBPACK_IMPORTED_MODULE_1__["default"].name + ` ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_最近更新')}`,
                btn: _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_我知道了'),
            });
...
/* harmony import */ var _Colors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Colors */ "./src/ts/modules/Colors.ts");
...
/* harmony import */ var _PageType__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PageType */ "./src/ts/modules/PageType.ts");
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _ImgViewer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ImgViewer */ "./src/ts/modules/ImgViewer.ts");
/* harmony import */ var _setting_Settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./setting/Settings */ "./src/ts/modules/setting/Settings.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Tools */ "./src/ts/modules/Tools.ts");
...
class InitAreaRankingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initAny() { }
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取本页作品'), [
...
class InitArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_从本页开始抓取new')).addEventListener('click', () => {
            this.crawlDirection = -1;
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_从本页开始抓取old')).addEventListener('click', () => {
            this.crawlDirection = 1;
            this.readyCrawl();
        });
        const downRelatedBtn = _DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取相关作品'));
    ...
    async getRelatedList() {
        let data = await _API__WEBPACK_IMPORTED_MODULE_9__["API"].getRelatedData(_Tools__WEBPACK_IMPORTED_MODULE_11__["Tools"].getIllustId());
...
class InitBookmarkDetailPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取相似图片'), [
    ...
    // 获取相似的作品列表
    async getIdList() {
        let data = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getRecommenderData(_Tools__WEBPACK_IMPORTED_MODULE_7__["Tools"].getIllustId(), this.crawlNumber);
...
class InitBookmarkNewArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
...
class InitDiscoverPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取当前作品'), [
...
class InitRankingArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取本排行榜作品'), [
        ...
        if (debutModes.includes(mode)) {
            _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取首次登场的作品'), [['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_抓取首次登场的作品Title')]]).addEventListener('click', () => {
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始筛选'), [
        ...
        _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_在结果中筛选'), [
    ...
    addAnyElement() {
        ...
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_14__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
    ...
    async getSearchData(p) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_8__["API"].getSearchData(_Store__WEBPACK_IMPORTED_MODULE_9__["store"].tag, this.worksType, p, this.option);
...
class InitSeriesPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_4__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
...
class Filter {
    ...
    getDownType() {
        ...
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downType0 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_插画');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downType1 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_漫画');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downType2 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_动图');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downType3 ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_小说');
        if (notDownTip) {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    getDownTypeByImgCount() {
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downSingleImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_单图作品');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downMultiImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_多图作品');
        if (notDownTip) {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    ...
    getDownTypeByColor() {
        ...
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downColorImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_彩色图片');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downBlackWhiteImg ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_黑白图片');
        if (notDownTip) {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
    ...
    getDownTypeByBmked() {
        ...
        let notDownTip = '';
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downNotBookmarked ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_未收藏');
        notDownTip += _setting_Settings__WEBPACK_IMPORTED_MODULE_4__["settings"].downBookmarked ? '' : _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_已收藏');
        if (notDownTip) {
            _Log__WEBPACK_IMPORTED_MODULE_1__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_排除作品类型') + notDownTip);
        }
    }
...
class InitNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    */
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_6__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_从本页开始抓取new')).addEventListener('click', () => {
            this.crawlDirection = -1;
            this.readyCrawl();
        });
        _DOM__WEBPACK_IMPORTED_MODULE_6__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_从本页开始抓取old')).addEventListener('click', () => {
            this.crawlDirection = 1;
            this.readyCrawl();
        });
    }
...
class InitNovelSeriesPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_5__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取系列小说')).addEventListener('click', () => {
            this.readyCrawl();
        });
    }
    initAny() { }
...
class InitRankingNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取本排行榜作品'), [
...
class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgBlue, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取'), [
            ['title', _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始抓取') + _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_默认下载多页')],
        ]).addEventListener('click', () => {
            this.readyCrawl();
        });
    ...
    addAnyElement() {
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
    ...
    // 获取搜索页的数据。因为有多处使用，所以进行了封装
    async getSearchData(p) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getNovelSearchData(_Store__WEBPACK_IMPORTED_MODULE_6__["store"].tag, p, this.option);
...
class PreviewFileName {
    ...
    previewFileName() {
        ...
        for (let i = 0; i < length; i++) {
            ...
            if (length < _Config__WEBPACK_IMPORTED_MODULE_4__["default"].outputMax) {
...
class Form {
    ...
    bindEvents() {
        ...
        // 导出 csv
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('exportResult', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导出csv')).addEventListener('click', () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.outputCSV);
        }, false);
        // 导出抓取结果
        _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('exportResult', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_导出抓取结果')).addEventListener('click', () => {
...
const formHtml = `<form class="settingForm">
    ...
    <p class="option" data-no="13">
      ...
      ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_命名标记type')} ${_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName.join(', ')}
      <br>
      ...
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeIllust" class="has_tip" data-tip="${_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[0]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_插画')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeManga" id="createFolderByTypeManga" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeManga" class="has_tip" data-tip="${_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[1]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_漫画')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeUgoira" id="createFolderByTypeUgoira" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeUgoira" class="has_tip" data-tip="${_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[2]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_动图')}&nbsp;</label>

      <input type="checkbox" name="createFolderByTypeNovel" id="createFolderByTypeNovel" class="need_beautify checkbox_common">
      <span class="beautify_checkbox"></span>
      <label for="createFolderByTypeNovel" class="has_tip" data-tip="${_Config__WEBPACK_IMPORTED_MODULE_0__["default"].worksTypeName[3]}"> ${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_小说')}&nbsp;</label>
      </span>
      </p>
...
class Settings {
    ...
    bindEvents() {
        // 当设置发生变化时进行本地存储
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.settingChange, () => {
            localStorage.setItem(_Config__WEBPACK_IMPORTED_MODULE_4__["default"].settingStoreName, JSON.stringify(this.settings));
        });
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.resetSettings, () => {
            this.reset();
        });
    ...
    // 读取保存的设置，合并到当前设置上
    restoreSettings() {
        const savedSettings = localStorage.getItem(_Config__WEBPACK_IMPORTED_MODULE_4__["default"].settingStoreName);
        if (savedSettings) {
    ...
    exportSettings() {
        ...
        const blob = new Blob([str], { type: 'application/json' });
        const url = URL.createObjectURL(blob);
        _Tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].downloadFile(url, `pixiv_batch_downloader-settings.json`);
    }
