...
/* harmony import */ var _modules_ExportCSV__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/ExportCSV */ "./src/ts/modules/ExportCSV.ts");
...
class ExportCSV {
    constructor() {
        ...
        this.getFileName = (arg) => {
            return _FileName__WEBPACK_IMPORTED_MODULE_6__["fileName"].getFileName(arg);
        };
        // 定义要保存的字段
        this.fieldCfg = [
            {
            ...
            },
            {
                ...
                q: false,
                toString: (arg) => {
                    return _Config__WEBPACK_IMPORTED_MODULE_4__["default"].illustTypes[arg];
                },
            },
            {
                name: 'page',
