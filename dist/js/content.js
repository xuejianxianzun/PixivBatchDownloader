            ...
            if (totalCheck) {
                ...
                if (jsInfo.illustType !== 2) {
                    ...
                    for (let i = 0; i < pNo; i++) {
                        ...
                        store.addResult(id + '_p' + i, nowUrl, title, nowAllTag, tagWithTranslation, user, userid, fullWidth, fullHeight, ext, bmk, jsInfo.createDate.split('T')[0], jsInfo.illustType, rank, {});
                    }
                    this.outputImgNum();
                }
                    ...
                    store.addResult(id, info.body.originalSrc, title, nowAllTag, tagWithTranslation, user, userid, fullWidth, fullHeight, ext, bmk, jsInfo.createDate.split('T')[0], jsInfo.illustType, rank, ugoiraInfo);
                    this.outputImgNum();
                }
            }
...
class CrawlSearchPage extends CrawlPageBase {
    ...
    async getListPage() {
        ...
        if (this.listPageFinished === this.wantPage ||
