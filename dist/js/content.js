/******/ ;(function (modules) {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _InitPage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
  ...
  \**********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _pageFunciton_FastScreen__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
        ...
        /* harmony import */ var _pageFunciton_BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
        ...
        /* harmony import */ var _utils_Utils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ../utils/Utils */ './src/ts/utils/Utils.ts'
        )
        /* harmony import */ var _store_IdListWithPageNo__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ../store/IdListWithPageNo */ './src/ts/store/IdListWithPageNo.ts'
        )
        /* harmony import */ var _Toast__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ../Toast */ './src/ts/Toast.ts'
        )
        /* harmony import */ var _MsgBox__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ../MsgBox */ './src/ts/MsgBox.ts'
        )
        // 初始化 artwork 搜索页
    ...
    `
            ...
            this.init()
            new _pageFunciton_FastScreen__WEBPACK_IMPORTED_MODULE_12__[
              'FastScreen'
            ]()
          }
          setFormOption() {
          ...
          addCrawlBtns() {
            _Tools__WEBPACK_IMPORTED_MODULE_13__['Tools']
              .addBtn(
                'crawlBtns',
                _config_Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].bgGreen,
          ...
          addAnyElement() {
            ...
            // 添加收藏本页所有作品的功能
            const bookmarkAllBtn = _Tools__WEBPACK_IMPORTED_MODULE_13__[
              'Tools'
            ].addBtn(
              'otherBtns',
              _config_Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].bgGreen,
            ...
            const bookmarkAll = new _pageFunciton_BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__[
              'BookmarkAllWorks'
            ](bookmarkAllBtn)
          ...
          async nextStep() {
            ...
            if (this.startpageNo > 1000) {
              _MsgBox__WEBPACK_IMPORTED_MODULE_19__['msgBox'].error(
                `${_Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
                  '_超出最大页码'
                )} ${this.maxCount}`
              )
        ...
        */
            ...
            let p = _utils_Utils__WEBPACK_IMPORTED_MODULE_16__[
              'Utils'
            ].getURLSearchField(location.href, 'p')
            this.startpageNo = parseInt(p) || 1
            // 从页面 url 中获取可以使用的选项
            ...
            this.allOption.forEach((param) => {
              let value = _utils_Utils__WEBPACK_IMPORTED_MODULE_16__[
                'Utils'
          ...
          async getIdList(p) {
            ...
            for (const nowData of data) {
              ...
              if (
                ...
                _store_IdListWithPageNo__WEBPACK_IMPORTED_MODULE_17__[
                  'idListWithPageNo'
                ].add(
                  this.flag,
                  {
          ...
          async filterResult(callback) {
            if (this.resultMeta.length === 0) {
              _Toast__WEBPACK_IMPORTED_MODULE_18__['toast'].error(
                _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
                  '_没有数据可供使用'
                )
              )
        ...
        `
                _utils_Utils__WEBPACK_IMPORTED_MODULE_16__['Utils'].addStyle(
                  style
                )
              }
            }, 300)
          ...
          checkIdList() {
            ...
            for (const str of array) {
              ...
              if (
                ...
                id < 22 ||
                id >
                  _config_Config__WEBPACK_IMPORTED_MODULE_6__['default']
                    .worksNumberLimit
              ) {
                console.log(
                  _Lang__WEBPACK_IMPORTED_MODULE_2__['lang'].transl(
  ...
  \**********************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class QuickBookmark {
          ...
          getEditBookmarkLink() {
            if (this.isNovel) {
              return `/novelPage/bookmark_add.php?id=${_Tools__WEBPACK_IMPORTED_MODULE_1__[
                'Tools'
              ].getNovelId()}`
            } else {
