        ...
        class BG {
          ...
          bindEvents() {
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].list.selectBG,
              () => {
                this.selectBG()
              }
            )
            window.addEventListener(
              _EVT__WEBPACK_IMPORTED_MODULE_1__['EVT'].list.clearBG,
              () => {
                this.clearBG()
              }
            )
          ...
          async selectBG() {
            const file = (
              await _Tools__WEBPACK_IMPORTED_MODULE_2__['Tools'].selectFile(
                '.jpg,.jpeg,.png,.bmp'
              )
            )[0]
          ...
          setDisplay() {
            this.el.style.display = _setting_Settings__WEBPACK_IMPORTED_MODULE_4__[
              'settings'
            ].bgDisplay
              ? 'block'
              : 'none'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class FastScreen {
          ...
          openFastScreenLink(secondTag) {
            ...
            const nowTag = _Tools__WEBPACK_IMPORTED_MODULE_3__[
              'Tools'
            ].getTagFromURL()
        ...
        class FileName {
          ...
          getFileName(data) {
            ...
            const cfg = {
              ...
              '{date}': {
                value: _DateFormat__WEBPACK_IMPORTED_MODULE_3__[
                  'DateFormat'
                ].format(
                  data.date,
                  _setting_Settings__WEBPACK_IMPORTED_MODULE_0__['settings']
            ...
            for (const [key, val] of Object.entries(cfg)) {
              if (result.includes(key)) {
                ...
                // 替换标记值中的特殊字符
                if (!val.safe) {
                  once = _Tools__WEBPACK_IMPORTED_MODULE_4__[
                    'Tools'
            ...
            if (
              ...
              for (const tag of _setting_Settings__WEBPACK_IMPORTED_MODULE_0__[
                ...
                if (workTags.includes(nowTag)) {
                  ...
                  const folder = _Tools__WEBPACK_IMPORTED_MODULE_4__[
                    'Tools'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitBookmarkLegacyPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          readyGetIdList() {
            ...
            this.isHide =
              _Tools__WEBPACK_IMPORTED_MODULE_11__['Tools'].getURLSearchField(
                location.href,
                'rest'
              ) === 'hide'
          ...
          getRecommendedList() {
            ...
            const getId =
              this.type === 'illusts'
                ...
                : _Tools__WEBPACK_IMPORTED_MODULE_11__['Tools'].getNovelId
            // 获取下方已经加载出来的作品
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitFollowingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          readyGet() {
            ...
            // 获取抓取开始时的页码
            const nowPage = _Tools__WEBPACK_IMPORTED_MODULE_9__[
              'Tools'
          ...
          crawlFinished() {
            ...
            if (
              ...
              _Store__WEBPACK_IMPORTED_MODULE_4__['store'].resultMeta.sort(
                _Tools__WEBPACK_IMPORTED_MODULE_18__['Tools'].sortUgoiraFirst
              )
        ...
        class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          addAnyElement() {
            ...
            bookmarkAllBtn.addEventListener('click', async () => {
              ...
              _Store__WEBPACK_IMPORTED_MODULE_5__[
                'store'
              ].tag = _Tools__WEBPACK_IMPORTED_MODULE_14__[
                'Tools'
              ].getTagFromURL()
          ...
          getOffset() {
            const nowPage = _Tools__WEBPACK_IMPORTED_MODULE_14__[
              'Tools'
            ].getURLSearchField(location.href, 'p') // 判断当前处于第几页，页码从 1 开始。也可能没有页码
            let offset = 0
            if (nowPage) {
  ...
  \*****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class QuickBookmark {
          ...
          getEditBookmarkLink() {
            if (this.isNovel) {
              return `/novel/bookmark_add.php?id=${_Tools__WEBPACK_IMPORTED_MODULE_5__[
                'Tools'
              ].getNovelId()}`
            } else {
              return `/bookmark_add.php?type=illust&illust_id=${_Tools__WEBPACK_IMPORTED_MODULE_5__[
                'Tools'
              ].getIllustId()}`
            }
          }
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class ShowWhatIsNew {
          ...
          show() {
            ...
            if (
              _Tools__WEBPACK_IMPORTED_MODULE_3__['Tools'].isPixiv() &&
              value !== this.flag
            ) {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class VipSearchOptimize {
          ...
          setVipOptimize() {
            ...
            // 判断 order 方式
            const order = _Tools__WEBPACK_IMPORTED_MODULE_4__[
              'Tools'
          ...
          async getIdList() {
            ...
            for (const el of allPicArea) {
              ...
              if (
                ...
                const id = _Tools__WEBPACK_IMPORTED_MODULE_7__[
                  'Tools'
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitNewArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          initFetchURL() {
            ...
            this.option.type =
              _Tools__WEBPACK_IMPORTED_MODULE_9__['Tools'].getURLSearchField(
                location.href,
                'type'
              ) || 'illust'
            // 是否是 R18 模式
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitRankingArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          addCrawlBtns() {
            ...
            const mode = _Tools__WEBPACK_IMPORTED_MODULE_11__[
              'Tools'
          ...
          nextStep() {
            ...
            this.option.worksType = _Tools__WEBPACK_IMPORTED_MODULE_11__[
              'Tools'
            ].getURLSearchField(location.href, 'content')
            this.option.date = _Tools__WEBPACK_IMPORTED_MODULE_11__[
              'Tools'
  ...
  \*********************************************************/
    ...
    `
        ...
        */
            ...
            let p = _Tools__WEBPACK_IMPORTED_MODULE_17__[
              'Tools'
            ].getURLSearchField(location.href, 'p')
            this.startpageNo = parseInt(p) || 1
            // 从页面 url 中获取可以使用的选项
            ...
            this.allOption.forEach((param) => {
              let value = _Tools__WEBPACK_IMPORTED_MODULE_17__[
                'Tools'
  ...
  \**********************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitBookmarkNewNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          getPageUrl() {
            // 设置起始页面
            const p = _Tools__WEBPACK_IMPORTED_MODULE_8__[
              'Tools'
            ].getURLSearchField(location.href, 'p')
            this.startpageNo = parseInt(p) || 1
  ...
  \*****************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          // 组织要请求的 url 中的参数
          initFetchURL() {
            let p = _Tools__WEBPACK_IMPORTED_MODULE_11__[
              'Tools'
            ].getURLSearchField(location.href, 'p')
            this.startpageNo = parseInt(p) || 1
            // 从页面 url 中获取可以使用的选项
            this.option = {}
            this.allOption.forEach((param) => {
              let value = _Tools__WEBPACK_IMPORTED_MODULE_11__[
                'Tools'
              ].getURLSearchField(location.href, param)
              if (value !== '') {
                this.option[param] = value
