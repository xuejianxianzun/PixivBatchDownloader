...
class FileName {
    ...
    getFileName(data) {
        ...
        const cfg = {
            ...
            '{date}': {
                value: !result.includes('{date}')
                    ? null
                    : _utils_DateFormat__WEBPACK_IMPORTED_MODULE_3__["DateFormat"].format(data.date, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{task_date}': {
                value: !result.includes('{task_date}')
                    ? null
                    : _utils_DateFormat__WEBPACK_IMPORTED_MODULE_3__["DateFormat"].format(_store_Store__WEBPACK_IMPORTED_MODULE_1__["store"].crawlCompleteTime, _setting_Settings__WEBPACK_IMPORTED_MODULE_0__["settings"].dateFormat),
                prefix: '',
                safe: false,
            },
            '{type}': {
        ...
        // 测试用例
        const testChar = ' / /// /123';
        console.log(this.removeStartChar(testChar));
        // 如果文件名的尾部是 / 则去掉
...
class InitSearchArtworkPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initFetchURL() {
        ...
        */
        ...
        // 如果没有指定搜索模式，则是精确匹配标签
        this.option.s_mode = (_b = this.option.s_mode) !== null && _b !== void 0 ? _b : 's_tag_full';
    }
...
class InitSearchNovelPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initFetchURL() {
        ...
        // 如果没有指定搜索模式，则是精确匹配标签
        this.option.s_mode = (_a = this.option.s_mode) !== null && _a !== void 0 ? _a : 's_tag_full';
    }
    // 计算应该抓取多少页
    async calcNeedCrawlPageCount() {
        let data = await this.getSearchData(1);
...
const formHtml = `<form class="settingForm">
    ...
    _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_必须大于0')}" >${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_多图作品的图片数量限制')}<span class="gray1"> ? </span></span>
      ...
      <span>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_任一')}&nbsp;</span>
