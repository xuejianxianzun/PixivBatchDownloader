...
class ExportResult {
    ...
    output() {
        ...
        const blob = new Blob([str], { type: 'application/json' });
        const url = URL.createObjectURL(blob);
        _DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].downloadFile(url, `result-${_API__WEBPACK_IMPORTED_MODULE_0__["API"].replaceUnsafeStr(_DOM__WEBPACK_IMPORTED_MODULE_2__["DOM"].getTitle())}-${new Date().getTime()}.json`);
    }
}
new ExportResult();
...
const formHtml = `<form class="settingForm">
  ...
  <div class="tabsContnet">
    ...
    <div class="con">
      ...
      <span class="settingNameStyle1">${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_日期格式')}<span class="gray1"> ? </span></span>
