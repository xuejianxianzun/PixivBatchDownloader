...
/* harmony import */ var _pageFunciton_FastScreen__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../pageFunciton/FastScreen */ "./src/ts/pageFunciton/FastScreen.ts");
/* harmony import */ var _Tools__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../Tools */ "./src/ts/Tools.ts");
/* harmony import */ var _pageFunciton_BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../pageFunciton/BookmarkAllWorks */ "./src/ts/pageFunciton/BookmarkAllWorks.ts");
/* harmony import */ var _store_States__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../store/States */ "./src/ts/store/States.ts");
/* harmony import */ var _utils_Utils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../utils/Utils */ "./src/ts/utils/Utils.ts");
/* harmony import */ var _store_IdListWithPageNo__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../store/IdListWithPageNo */ "./src/ts/store/IdListWithPageNo.ts");
...
class InitSearchArtworkPage extends _crawl_InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    `;
        ...
        this.init();
        new _pageFunciton_FastScreen__WEBPACK_IMPORTED_MODULE_12__["FastScreen"]();
    }
    setFormOption() {
        // 个数/页数选项的提示
        _setting_Options__WEBPACK_IMPORTED_MODULE_4__["options"].setWantPageTip({
    ...
    addCrawlBtns() {
        _Tools__WEBPACK_IMPORTED_MODULE_13__["Tools"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始筛选'), [
        ...
        _Tools__WEBPACK_IMPORTED_MODULE_13__["Tools"].addBtn('crawlBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_在结果中筛选'), [
    ...
    addAnyElement() {
        ...
        // 添加收藏本页所有作品的功能
        const bookmarkAllBtn = _Tools__WEBPACK_IMPORTED_MODULE_13__["Tools"].addBtn('otherBtns', _config_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].bgGreen, _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_收藏本页面的所有作品'));
        const bookmarkAll = new _pageFunciton_BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_14__["BookmarkAllWorks"](bookmarkAllBtn);
    ...
    destroy() {
        _Tools__WEBPACK_IMPORTED_MODULE_13__["Tools"].clearSlot('crawlBtns');
        _Tools__WEBPACK_IMPORTED_MODULE_13__["Tools"].clearSlot('otherBtns');
        ...
        // 离开下载页面时，取消设置“不自动下载”
        _store_States__WEBPACK_IMPORTED_MODULE_15__["states"].notAutoDownload = false;
    }
    getWantPage() {
    ...
    async nextStep() {
        ...
        if (this.startpageNo > 1000) {
            _MsgBox__WEBPACK_IMPORTED_MODULE_19__["msgBox"].error(`${_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_超出最大页码')} ${this.maxCount}`);
            return this.noResult();
        }
    ...
    initFetchURL() {
        ...
        */
        ...
        let p = _utils_Utils__WEBPACK_IMPORTED_MODULE_16__["Utils"].getURLSearchField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 从页面 url 中获取可以使用的选项
        this.option = {};
        this.allOption.forEach((param) => {
            let value = _utils_Utils__WEBPACK_IMPORTED_MODULE_16__["Utils"].getURLSearchField(location.href, param);
            if (value !== '') {
    ...
    async getIdList(p) {
        ...
        for (const nowData of data) {
            ...
            if (await _filter_Filter__WEBPACK_IMPORTED_MODULE_7__["filter"].check(filterOpt)) {
                _store_IdListWithPageNo__WEBPACK_IMPORTED_MODULE_17__["idListWithPageNo"].add(this.flag, {
        ...
        if (this.sendCrawlTaskCount + 1 <= this.needCrawlPageCount) {
            ...
            if (this.listPageFinished === this.needCrawlPageCount) {
                ...
                _store_IdListWithPageNo__WEBPACK_IMPORTED_MODULE_17__["idListWithPageNo"].store(this.flag);
                this.getIdListFinished();
            }
        }
    }
    ...
    // 搜索页把下载任务按收藏数从高到低下载
    sortResult() {
        _store_Store__WEBPACK_IMPORTED_MODULE_9__["store"].resultMeta.sort(_utils_Utils__WEBPACK_IMPORTED_MODULE_16__["Utils"].sortByProperty('bmk'));
        _store_Store__WEBPACK_IMPORTED_MODULE_9__["store"].result.sort(_utils_Utils__WEBPACK_IMPORTED_MODULE_16__["Utils"].sortByProperty('bmk'));
    }
    setNotAutoDownload() {
        // 如果设置了“预览搜索结果”，则不启用自动下载
        _store_States__WEBPACK_IMPORTED_MODULE_15__["states"].notAutoDownload = _setting_Settings__WEBPACK_IMPORTED_MODULE_11__["settings"].previewResult ? true : false;
    }
    // 返回包含作品列表的 ul 元素
    getWorksWrap() {
    ...
    async filterResult(callback) {
        if (this.resultMeta.length === 0) {
            _Toast__WEBPACK_IMPORTED_MODULE_18__["toast"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_没有数据可供使用'));
            return;
        }
    ...
    screenInResult() {
        if (_store_States__WEBPACK_IMPORTED_MODULE_15__["states"].busy) {
            _Toast__WEBPACK_IMPORTED_MODULE_18__["toast"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_当前任务尚未完成'));
            return;
        }
        _Log__WEBPACK_IMPORTED_MODULE_10__["log"].clear();
        this.getMultipleSetting();
    ...
    hotBar() {
        ...
        `;
                _utils_Utils__WEBPACK_IMPORTED_MODULE_16__["Utils"].addStyle(style);
            }
        }, 300);
    }
}
...
class Store {
    ...
    getDLCount(pageCount) {
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].firstFewImagesSwitch && _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].firstFewImages <= pageCount) {
            return _setting_Settings__WEBPACK_IMPORTED_MODULE_1__["settings"].firstFewImages;
        }
        return pageCount;
    }
