...
class CrawlPageBase {
    constructor() {
        ...
        获取作品信息完毕
        */
        this.maxCount = 1000; // 当前页面类型最多可以抓取多少个页面/作品
...
// 抓取作品页
class CrawlWorkPage extends CrawlPageBase {
    constructor() {
        super(...arguments);
...
class CrawlSearchPage extends CrawlPageBase {
    ...
    async getSearchData(p) {
        let data = await API.getSearchData(pageInfo.pageTag, this.worksType, p, this.option);
