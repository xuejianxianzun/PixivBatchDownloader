/******/ ;(function (modules) {
        ...
        class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          ...
          async getIdList() {
            ...
            if (
              ...
              data.body.works.forEach((data) =>
                this.idList.push({
                  type: _API__WEBPACK_IMPORTED_MODULE_1__['API'].getWorkType(
                    data.illustType
                  ),
                  id: data.id,
                })
          ...
          getRecommendedList() {
            ...
            for (const li of elements) {
              ...
              _Store__WEBPACK_IMPORTED_MODULE_6__['store'].idList.push({
                type: 'unkown',
                id: _API__WEBPACK_IMPORTED_MODULE_1__['API'].getIllustId(
                  a.href
                ),
              })
            }
  ...
  \****************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'InitNovelBookmarkNewPage',
          function () {
            return InitNovelBookmarkNewPage
          }
        )
        /* harmony import */ var _InitPageBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./InitPageBase */ './src/ts/modules/InitPageBase.ts'
        ...
        class InitNovelBookmarkNewPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          'InitPageBase'
        ] {
          constructor() {
            super()
  ...
  \*****************************************/
    ...
    */
          ...
          nextStep() {
            if (
              ...
              _Store__WEBPACK_IMPORTED_MODULE_4__['store'].idList.push({
                type: 'novels',
                id: _API__WEBPACK_IMPORTED_MODULE_6__['API'].getNovelId(
          ...
          async getIdList() {
            let type = ['novels']
            let idList = await _API__WEBPACK_IMPORTED_MODULE_6__[
              'API'
            ].getUserWorksByType(
            ...
            // 储存符合条件的 id
            let nowId = parseInt(
              _API__WEBPACK_IMPORTED_MODULE_6__['API'].getIllustId(
                window.location.href
              )
            )
            idList.forEach((id) => {
            ...
            if (this.crawlNumber !== -1) {
              ...
              if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_4__['store'].idList
                  .sort(
                    _API__WEBPACK_IMPORTED_MODULE_6__['API'].sortByProperty(
                      'id'
                    )
                  )
                  .reverse()
                ...
                _Store__WEBPACK_IMPORTED_MODULE_4__['store'].idList.sort(
                  _API__WEBPACK_IMPORTED_MODULE_6__['API'].sortByProperty('id')
                )
              }
              _Store__WEBPACK_IMPORTED_MODULE_4__[
                'store'
  ...
  \************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          __webpack_exports__,
          'InitNovelRankingPage',
          function () {
            return InitNovelRankingPage
          }
        )
        /* harmony import */ var _InitPageBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./InitPageBase */ './src/ts/modules/InitPageBase.ts'
        ...
        class InitNovelRankingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          'InitPageBase'
        ] {
          constructor() {
            super()
  ...
  \***********************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class InitNovelSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__[
          'InitPageBase'
        ] {
          constructor() {
            super()
  ...
  \************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _InitNovelPage__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./InitNovelPage */ './src/ts/modules/InitNovelPage.ts'
        )
        /* harmony import */ var _InitNovelSeriesPage__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./InitNovelSeriesPage */ './src/ts/modules/InitNovelSeriesPage.ts'
        )
        /* harmony import */ var _InitNovelSearchPage__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./InitNovelSearchPage */ './src/ts/modules/InitNovelSearchPage.ts'
        )
        /* harmony import */ var _InitNovelRankingPage__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./InitNovelRankingPage */ './src/ts/modules/InitNovelRankingPage.ts'
        )
        /* harmony import */ var _InitNovelBookmarkNewPage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./InitNovelBookmarkNewPage */ './src/ts/modules/InitNovelBookmarkNewPage.ts'
        )
        /* harmony import */ var _InitNewNovelPage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ./InitNewNovelPage */ './src/ts/modules/InitNewNovelPage.ts'
        )
        // 初始化页面，初始化抓取流程
        ...
        class InitPage {
          ...
          initPage() {
            switch (
              ...
              case 13:
                return new _InitNovelPage__WEBPACK_IMPORTED_MODULE_14__[
                  'InitNovelPage'
                ]()
              case 14:
                return new _InitNovelSeriesPage__WEBPACK_IMPORTED_MODULE_15__[
                  'InitNovelSeriesPage'
                ]()
              case 15:
                return new _InitNovelSearchPage__WEBPACK_IMPORTED_MODULE_16__[
                  'InitNovelSearchPage'
                ]()
              case 16:
                return new _InitNovelRankingPage__WEBPACK_IMPORTED_MODULE_17__[
                  'InitNovelRankingPage'
                ]()
              case 17:
                return new _InitNovelBookmarkNewPage__WEBPACK_IMPORTED_MODULE_18__[
                  'InitNovelBookmarkNewPage'
                ]()
              case 18:
                return new _InitNewNovelPage__WEBPACK_IMPORTED_MODULE_19__[
                  'InitNewNovelPage'
                ]()
              default:
  ...
  \****************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _SaveImageWorksData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./SaveImageWorksData */ './src/ts/modules/SaveImageWorksData.ts'
        )
        /* harmony import */ var _SaveNovelWorksData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./SaveNovelWorksData */ './src/ts/modules/SaveNovelWorksData.ts'
        )
        /* harmony import */ var _Filter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./Filter */ './src/ts/modules/Filter.ts'
        )
            ...
            try {
              ...
              if (idData.type === 'novels') {
                const data = await _API__WEBPACK_IMPORTED_MODULE_7__[
                  'API'
                ].getNovelWorksData(id)
                await _SaveNovelWorksData__WEBPACK_IMPORTED_MODULE_5__[
                  'saveNovelWorksData'
                ].save(data)
              } else {
                const data = await _API__WEBPACK_IMPORTED_MODULE_7__[
                  'API'
                ].getImageWorksData(id)
                await _SaveImageWorksData__WEBPACK_IMPORTED_MODULE_4__[
                  'saveImageWorksData'
                ].save(data)
              }
        ...
        `
          ...
          reAddResult() {
            ...
            this.resultMeta.forEach((data) => {
              const dlCount = _Settings__WEBPACK_IMPORTED_MODULE_13__[
                'setting'
        ...
        class PageType {
          ...
          getPageType() {
            ...
            if (
              ...
              window.location.pathname.startsWith('/novel/bookmark_new')
            ) {
              type = 17
  ...
  \************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _SettingHTML__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
        ...
        class Settings {
          constructor() {
            ...
            this.form = _DOM__WEBPACK_IMPORTED_MODULE_1__['DOM'].useSlot(
              'form',
              _SettingHTML__WEBPACK_IMPORTED_MODULE_7__['default']
            )
