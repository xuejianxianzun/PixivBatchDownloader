/******/ ;(function (modules) {
        ...
        class CreateCSV {
          ...
          create(data) {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_1__['DOM'].downloadFile(
              url,
              _API__WEBPACK_IMPORTED_MODULE_0__['API'].replaceUnsafeStr(name) +
                '.csv',
            )
            return url
          }
  ...
  \**********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Mute__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
        ...
        class Filter {
          ...
          checkMuteTag(tags) {
            ...
            return !tags.some(
              _Mute__WEBPACK_IMPORTED_MODULE_7__['mute'].checkTag.bind(
                _Mute__WEBPACK_IMPORTED_MODULE_7__['mute'],
              ),
            )
          }
          // 在日志区域输出提示
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        class SelectWork {
          constructor() {
            ...
            this.crawlBtn = document.createElement('button') // 开始抓取选择的作品的按钮，并且会退出选择模式
          ...
          addBtn() {
            this.controlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__[
              'DOM'
            ].addBtn(
              'selectWorkBtns',
              _Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].green,
            ...
            this.updateControlBtn()
            this.crawlBtn = _DOM__WEBPACK_IMPORTED_MODULE_0__[
              'DOM'
            ].addBtn(
              'selectWorkBtns',
              _Colors__WEBPACK_IMPORTED_MODULE_1__['Colors'].blue,
          ...
          addSelectedFlag(el, id) {
            ...
            if (el.parentElement) {
              const position = window.getComputedStyle(el.parentElement)[
                'position'
              ]
