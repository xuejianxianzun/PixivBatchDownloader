...
class OutputCSV {
    constructor() {
        this.separate = ','; // 分隔符
        this.CRLF = '\r\n'; // 换行符
        this.number2String = (arg) => { return arg.toString(); };
        this.array2String = (arg) => { return arg.join(','); };
        this.string2String = (arg) => { return arg; };
        // 定义要保存的字段
        this.fieldCfg = [
            {
                name: 'id',
            ...
            },
            {
                ...
                index: 'type',
                q: false,
                toString: (arg) => { return _Config__WEBPACK_IMPORTED_MODULE_3__["default"].illustTypes[arg]; }
            },
            {
                name: 'page',
                index: 'pageCount',
            ...
            },
            {
                ...
                index: 'bookmarked',
                q: false,
                toString: (arg) => { return arg ? 'yes' : 'no'; }
            },
            {
                name: 'width',
                index: 'fullWidth',
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.outputCSV, () => { this.beforeCreate(); });
    }
    beforeCreate() {
        // 如果没有数据则不执行
