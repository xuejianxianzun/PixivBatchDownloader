...
class BookmarkAllWorks {
    constructor() {
        ...
        this.idList = [];
        this.bookmarKData = [];
        this.btn = _DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].addBtn('otherBtns', _Colors__WEBPACK_IMPORTED_MODULE_2__["Colors"].green, _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_收藏本页面的所有作品'));
    }
    ...
    async addBookmarkAll() {
        return new Promise(async (resolve) => {
            ...
            for (const data of this.bookmarKData) {
                ...
                await _API__WEBPACK_IMPORTED_MODULE_0__["API"].addBookmark(this.type, data.id, _setting_Settings__WEBPACK_IMPORTED_MODULE_5__["settings"].quickBookmarks ? data.tags : [], data.restrict, _Token__WEBPACK_IMPORTED_MODULE_3__["token"].token);
                index++;
            }
            resolve();
        });
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addCrawlBtns() {
        ...
        // 添加收藏本页所有作品的功能
        const bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_15__["BookmarkAllWorks"]();
...
class InitSearchNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    addAnyElement() {
        // 添加收藏本页所有作品的功能
        const bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_10__["BookmarkAllWorks"]();
        bookmarkAll.btn.addEventListener('click', () => {
            const listWrap = this.getWorksWrap();
            if (listWrap) {
