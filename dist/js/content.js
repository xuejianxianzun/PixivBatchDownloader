...
class DownloadControl {
    ...
    <button class="copyUrl" type="button" style="background:${_Colors__WEBPACK_IMPORTED_MODULE_6__["Colors"].green};"> ${_Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_复制url')}</button>
    </div>
...
class FileName {
    ...
    getFileName(data) {
        // 为空时使用 {id}
        let result = _Settings__WEBPACK_IMPORTED_MODULE_1__["form"].userSetName.value || '{id}';
        ...
        // 替换命名规则里的特殊字符
        result = _API__WEBPACK_IMPORTED_MODULE_4__["API"].replaceUnsafeStr(result);
        ...
        for (const [key, val] of Object.entries(cfg)) {
            if (result.includes(key)) {
                ...
                // 处理标记值中的特殊字符
                if (!val.safe) {
                    once = _API__WEBPACK_IMPORTED_MODULE_4__["API"].replaceUnsafeStr(once);
                }
                // 添加标记名称
    ...
    async getWorksData(idData) {
        ...
        try {
            ...
            if (idData.type === 'novels') {
                const data = await _API__WEBPACK_IMPORTED_MODULE_7__["API"].getNovelData(id);
...
class Output {
    ...
    output(content, title = _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_输出信息')) {
        ...
        if (_Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length > _Config__WEBPACK_IMPORTED_MODULE_4__["default"].outputMax) {
            ...
            _DOM__WEBPACK_IMPORTED_MODULE_3__["DOM"].downloadFile(con, fileName);
            // 禁用复制按钮
...
class InitArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    initElse() {
        ...
        this.initImgViewer();
        // 页面切换再次初始化
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].events.pageSwitch, this.initQuickBookmark);
    ...
    destroy() {
        ...
        // 解除切换页面时绑定的事件
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_2__["EVT"].events.pageSwitch, this.initQuickBookmark);
...
/* harmony import */ var _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../BookmarkAllWorks */ "./src/ts/modules/BookmarkAllWorks.ts");
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    appendCenterBtns() {
        ...
        // 添加收藏本页所有作品的功能
        const bookmarkAll = new _BookmarkAllWorks__WEBPACK_IMPORTED_MODULE_16__["BookmarkAllWorks"]();
...
class InitNovelPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    destroy() {
        ...
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_9__["EVT"].events.pageSwitch, this.initQuickBookmark);
    }
    /*
    -1 抓取新作品
    0 不设置抓取方向
...
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Settings */ "./src/ts/modules/Settings.ts");
/* harmony import */ var _MakeEPUB__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MakeEPUB */ "./src/ts/modules/novel/MakeEPUB.ts");
    ...
    async save(data) {
        ...
        if (await _Filter__WEBPACK_IMPORTED_MODULE_0__["filter"].check(filterOpt)) {
            ...
            if (ext === 'txt') {
                ...
                try {
                    blob = await _MakeEPUB__WEBPACK_IMPORTED_MODULE_3__["makeEPUB"].make(data, content);
                }
                catch (_a) {
                    ext = 'txt';
                    blob = this.makeTXT(content);
