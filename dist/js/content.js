...
/* harmony import */ var _modules_Toast__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/Toast */ "./src/ts/modules/Toast.ts");
...
class BookmarkAllWorks {
    ...
    async startBookmark() {
        if (this.idList.length === 0) {
            _EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_没有数据可供使用'),
                bgColorType: 'error',
            });
            return;
        }
...
class BookmarksAddTag {
    ...
    async addTag(index, addList, tt) {
        ...
        if (index < addList.length - 1) {
            ...
            this.btn.removeAttribute('disabled');
            _EVT__WEBPACK_IMPORTED_MODULE_3__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_3__["EVT"].list.sendToast, {
                text: `✓ Complete`,
                bgColorType: 'green',
            });
        }
...
class Deduplication {
    ...
    clearRecords() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
            text: _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_下载记录已清除'),
            bgColorType: 'green',
        });
    }
    // 导出下载记录
    ...
    async importRecord() {
        ...
        t = window.setInterval(() => {
            ...
            if (stored >= total) {
                _Log__WEBPACK_IMPORTED_MODULE_2__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_完成'));
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].sendMsg({
            msg: `${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_导入下载记录')}<br>${_Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_完成')}`,
            type: 'success',
        });
...
class DownloadControl {
    ...
    listenEvents() {
        ...
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.downloadComplete, () => {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_下载完毕2'),
                bgColorType: 'green',
            });
...
class ExportLST {
    ...
    createLst() {
        if (_Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length === 0) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_4__["lang"].transl('_没有数据可供使用'),
                bgColorType: 'error',
            });
            return;
        }
...
class ExportResult {
    ...
    output() {
        ...
        if (_Store__WEBPACK_IMPORTED_MODULE_2__["store"].result.length === 0) {
            _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_没有数据可供使用'),
                bgColorType: 'error',
            });
            return;
        }
...
class ImgViewer {
    ...
    download() {
        ...
        if (_States__WEBPACK_IMPORTED_MODULE_5__["states"].busy) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_当前任务尚未完成2'),
                bgColorType: 'error',
            });
            return;
        }
...
class ImportResult {
    ...
    bindEvents() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.importResult, () => {
            if (_States__WEBPACK_IMPORTED_MODULE_3__["states"].busy) {
                _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
                    text: _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_当前任务尚未完成'),
                    bgColorType: 'error',
                });
                return;
            }
    ...
    async import() {
        ...
        if (!Array.isArray(loadedJSON) || !loadedJSON.length || !loadedJSON[0]) {
            return _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
                text: `Format error!`,
                bgColorType: 'error',
            });
        }
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
            text: _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_导入成功'),
            bgColorType: 'green',
        });
    }
}
...
class InitPageBase {
    ...
    async readyCrawl() {
        // 检查是否可以开始抓取
        if (_States__WEBPACK_IMPORTED_MODULE_9__["states"].busy) {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_当前任务尚未完成'),
                bgColorType: 'error',
            });
            return;
        }
...
class MsgBox {
    ...
    bindEvents() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.showMsg, (ev) => {
...
class SaveUserCover {
    ...
    async saveUserCover() {
        ...
        if (bgData === null) {
            return _EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_4__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_没有数据可供使用'),
                bgColorType: 'error',
            });
        }
...
class SelectWork {
    ...
    downloadSelect() {
        if (_States__WEBPACK_IMPORTED_MODULE_4__["states"].busy) {
            _EVT__WEBPACK_IMPORTED_MODULE_3__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_3__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_当前任务尚未完成'),
                bgColorType: 'error',
            });
            return;
        }
...
class ShowHowToUse {
    ...
    show() {
        _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].sendMsg({
            title: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].name,
            msg: _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_HowToUse'),
...
class ShowWhatIsNew {
    ...
    show() {
        ...
        if (window.location.host.includes('pixiv.net') && value !== this.newTag) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].sendMsg({
                title: _Config__WEBPACK_IMPORTED_MODULE_2__["default"].name + ` ${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_最近更新')}`,
...
class Toast {
    ...
    bindEvents() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, (ev) => {
            const data = ev.detail.data;
    ...
    create(arg) {
        ...
        // 设置文字颜色，优先使用 color
        span.style.color = arg.color ? arg.color : _Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"][arg.colorType];
        // 设置背景颜色，优先使用 color
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async nextStep() {
        ...
        if (this.startpageNo > 1000) {
            _EVT__WEBPACK_IMPORTED_MODULE_6__["EVT"].sendMsg({
                type: 'error',
                msg: `${_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_超出最大页码')} ${this.maxCount}`,
            });
            return this.noResult();
        }
  ...
  `;
    ...
    checkValue(uidInput, tagsInput) {
        ...
        if (!uidInput || !tagsInput || tags.length === 0) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].sendMsg({
                type: 'error',
                msg: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_必填项不能为空'),
            });
            return false;
        }
        ...
        if (!uid || isNaN(uid)) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].sendMsg({
                type: 'error',
                msg: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_用户ID必须是数字'),
            });
            return false;
        }
        return {
    ...
    addRule(uidInput, tagsInput) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.sendToast, {
            text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_添加成功'),
            bgColorType: 'green',
        });
    }
    // 更新规则
    ...
    updateRule(oldUid, uidInput, tagsInput, tip = true) {
        ...
        if (tip) {
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_更新成功'),
                bgColorType: 'green',
            });
        }
        this.addWrapShow = false;
...
class OutputPanel {
    ...
    output(content, title = _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_输出信息')) {
        ...
        if (content) {
            ...
            return _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
                text: _Lang__WEBPACK_IMPORTED_MODULE_1__["lang"].transl('_没有数据可供使用'),
                bgColorType: 'error',
            });
        }
    }
...
class SaveNamingRule {
  ...
  <ul class="namingRuleList"></ul>
    ...
    add(rule) {
        ...
        // 显示提示
        _EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].list.sendToast, {
            text: _Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_已保存命名规则'),
            bgColorType: 'green',
        });
    }
    delete(index) {
