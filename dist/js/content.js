...
class InitIndexPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    nextStep() {
        ...
        _Log__WEBPACK_IMPORTED_MODULE_6__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_开始获取作品页面'));
        this.getIdList();
    }
    getWantPage() { }
    getIdList() {
        ...
        for (const id of idValue) {
            ...
            if (isNaN(nowId) || nowId < 22 || nowId > 99999999) {
                _Log__WEBPACK_IMPORTED_MODULE_6__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_id不合法'), 0, false);
            }
            else {
...
class InitPageBase {
    ...
    crawlFinished() {
        ...
        this.sortResult();
        _Log__WEBPACK_IMPORTED_MODULE_9__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_共抓取到n个文件', _Store__WEBPACK_IMPORTED_MODULE_8__["store"].result.length.toString()));
    ...
    // 在抓取图片网址时，输出提示
    logImagesNo() {
        _Log__WEBPACK_IMPORTED_MODULE_9__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_共抓取到n个文件', _Store__WEBPACK_IMPORTED_MODULE_8__["store"].result.length.toString()), 1, false);
    }
    // 抓取结果为 0 时输出提示
    noResult() {
...
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../Settings */ "./src/ts/modules/Settings.ts");
...
class InitSearchArtworkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    `;
        ...
        this.addBookmark = (event) => {
            const data = event.detail.data;
            // 如果设置了不启用快速收藏，则把 tag 设置为空
            if (_Settings__WEBPACK_IMPORTED_MODULE_12__["form"].quickBookmarks.checked === false) {
                data.tags = [];
            }
    ...
    initElse() {
        this.hotBar();
        this.setPreviewResult(_Settings__WEBPACK_IMPORTED_MODULE_12__["form"].previewResult.checked);
    ...
    reAddResult(removedResult) {
        ...
        this.resultMeta.forEach((data) => {
            const dlCount = _Settings__WEBPACK_IMPORTED_MODULE_12__["setting"].getDLCount(data.pageCount);
