/******/ ;(function (modules) {
  ...
  \**********************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _DownloadStates__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./DownloadStates */ './src/ts/modules/DownloadStates.ts'
        )
        ...
        class Resume {
          ...
          async restoreData() {
            ...
            if (data) {
              _DownloadStates__WEBPACK_IMPORTED_MODULE_3__[
                'downloadStates'
              ].replace(data.states)
            }
            // 恢复模式就绪
          ...
          async saveTaskData() {
            return new Promise(async (resolve, reject) => {
              ...
              let data = {
                ...
                data: _Store__WEBPACK_IMPORTED_MODULE_1__['store'].result.slice(
                  this.getPartTotal(),
