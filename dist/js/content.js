...
/* harmony import */ var _modules_InitPage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/InitPage */ "./src/ts/modules/InitPage.ts");
...
class API {
    ...
    static getTagFromURL(url) {
        ...
        if (nowURL.pathname.includes('/bookmarks/artworks')) {
            ...
            const test = /\/bookmarks\/artworks\/(.[^\/|^\?|^&]*)/.exec(nowURL.pathname);
...
/***/ "./src/ts/modules/BeautifyForm.ts":
/*!****************************************!*\
  !*** ./src/ts/modules/BeautifyForm.ts ***!
  \****************************************/
/*! exports provided: BeautifyForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BeautifyForm", function() { return BeautifyForm; });
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _CenterPanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CenterPanel */ "./src/ts/modules/CenterPanel.ts");


// 中间面板添加按钮的区域
class CenterButtons {
    constructor() {
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.destroy, () => {
            this.clear();
        });
    }
    add(bg = '', text = '', attr = []) {
        ...
        _CenterPanel__WEBPACK_IMPORTED_MODULE_1__["centerPanel"].useSlot('centerBtns', e);
        return e;
    }
    clear() {
        _CenterPanel__WEBPACK_IMPORTED_MODULE_1__["centerPanel"].clearSlot('centerBtns');
    }
}
...
class CenterPanel {
    ...
    addCenterPanel() {
      ...
      <div class="btns">
      <a class="has_tip centerWrap_top_btn update" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_newver')}" href="https://chrome.google.com/webstore/detail/powerful-pixiv-downloader/dkndmhgdcmjdmkdonmbgjpijejdcilfh" target="_blank">
      ...
      <svg t="1574401005111" class="icon" widht="16" height="16" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2594" xmlns:xlink="http://www.w3.org/1999/xlink><defs><style type="text/css"></style></defs><path d="M0 520.886c0-69.368 13.51-135.697 40.498-199.02 26.987-63.323 63.322-117.826 109.006-163.51 45.65-45.65 100.154-81.985 163.51-109.006A502.289 502.289 0 0 1 512 8.92c69.335 0 135.663 13.477 198.986 40.497 63.356 26.988 117.86 63.323 163.51 109.007 45.684 45.65 82.02 100.154 109.006 163.51A502.289 502.289 0 0 1 1024 520.852c0 111.318-32.504 211.472-97.511 300.494-64.975 88.989-148.48 150.825-250.484 185.476-5.351 0-9.348-0.99-11.99-2.973-2.676-1.982-4.196-3.997-4.526-6.012a59.458 59.458 0 0 1-0.495-8.984 7.663 7.663 0 0 1-0.991-3.006v-128.99c0-40.63-14.336-75.314-43.008-103.986 76.667-13.345 134.011-41.819 171.999-85.487 37.987-43.669 57.013-96.52 57.013-158.522 0-58.005-18.663-108.346-56.022-150.99 13.345-42.678 11-87.668-6.97-135.003-18.697-1.322-39.011 1.85-61.01 9.513-22 7.663-38.318 14.831-49.02 21.47-10.637 6.673-20.316 13.016-28.97 19.027-38.68-10.669-81.854-16.02-129.486-16.02-47.7 0-90.509 5.351-128.529 16.02-7.333-5.35-15.855-11.164-25.5-17.507-9.68-6.342-26.493-14.005-50.507-22.99-23.982-9.018-45.65-12.85-65.008-11.495-18.663 47.996-20.645 93.646-5.979 136.984-36.665 42.678-54.998 92.986-54.998 150.99 0 62.002 18.663 114.689 55.99 157.994 37.326 43.339 94.67 72.01 171.998 86.016a142.303 142.303 0 0 0-39.969 70.029c-56.683 13.972-96.355 3.963-119.015-30.06-42.017-61.308-79.674-83.307-113.003-65.965-4.69 4.657-3.997 9.48 1.982 14.501 6.012 4.988 14.996 11.66 27.02 19.985 11.99 8.357 20.976 17.507 26.987 27.515 0.661 1.322 2.51 6.177 5.517 14.502a831.917 831.917 0 0 0 8.985 23.981c2.973 7.663 8.654 16.186 17.011 25.5 8.324 9.349 18.003 17.178 29.003 23.52 11 6.309 26.161 11 45.485 14.006 19.324 2.972 41.323 3.138 65.998 0.495v100.484c0 0.991-0.165 2.643-0.495 5.021-0.33 2.312-0.991 3.964-1.982 4.955-0.991 1.024-2.345 2.015-4.03 3.039a12.52 12.52 0 0 1-6.474 1.486c-2.676 0-6.012-0.33-10.009-0.99-101.343-35.345-183.825-97.182-247.51-185.51C31.842 731.037 0 631.577 0 520.92z" p-id="2595"></path></svg>
        ...
        <div class="has_tip centerWrap_top_btn centerWrap_toogle_option" data-show="1" data-tip="${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_收起展开设置项')}">▲</div>
      ...
      `;
        ...
        this.toggleFormEl = this.centerPanel.querySelector('.centerWrap_toogle_option');
    ...
    bindEvents() {
        ...
        this.toggleFormEl.addEventListener('click', () => {
            ...
            _EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_1__["EVT"].events.toggleForm, !!parseInt(newShow));
        });
        // 切换显示表单时，更改按钮的数据
...
class DOM {
    ...
    */
    ...
    static getUserId() {
        ...
        const testA = document.querySelector('.jkOmlQ a') || document.querySelector('a.lknEaI');
        if (testA && testA.href) {
...
class DownloadControl {
    ...
    set setDownloaded(val) {
        ...
        this.LogDownloadStates();
        // 设置下载进度信息
        this.totalNumberEl.textContent = _Store__WEBPACK_IMPORTED_MODULE_1__["store"].result.length.toString();
    ...
    setDownloadThread() {
        ...
        // 重设下载进度条
        _ProgressBar__WEBPACK_IMPORTED_MODULE_9__["progressBar"].reset(this.downloadThread);
    }
...
class FastScreen {
    ...
    openFastScreenLink(secondTag) {
        ...
        const firstTag = _PageInfo__WEBPACK_IMPORTED_MODULE_2__["pageInfo"].getPageTag.split(' ')[0];
        const fullTag = encodeURIComponent(firstTag + ' ' + secondTag);
        // 用新的 tag 替换掉当前网址里的 tag
        const newURL = location.href.replace(encodeURIComponent(_PageInfo__WEBPACK_IMPORTED_MODULE_2__["pageInfo"].getPageTag), fullTag);
...
class FileName {
    ...
    getFileName(data) {
        ...
        const cfg = [
            ...
            {
                name: '{p_title}',
                value: _Store__WEBPACK_IMPORTED_MODULE_2__["store"].pageInfo.pageTitle,
                prefix: '',
                safe: false
            },
            {
...
class Filter {
    constructor() {
        ...
        this.ratioSwitch = false; // 宽高比例设置的开关
    ...
    init() {
        ...
        // 获取是否设置了收藏数要求
        this.filterBMKNum = _Settings__WEBPACK_IMPORTED_MODULE_0__["form"].favNumSwitch.checked;
        ...
        // 获取宽高比设置
        this.ratioSwitch = _Settings__WEBPACK_IMPORTED_MODULE_0__["form"].ratioSwitch.checked;
        if (this.ratioSwitch) {
...
class InitBookmarkDetailPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        ...
        for (const id of data.recommendations) {
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(id.toString());
        }
        this.getIdListFinished();
    }
    resetGetIdListStatus() { }
...
class InitBookmarkNewIllustPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        ...
        for (const data of worksData) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_5__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.push(data.illustId);
            }
        }
...
/* harmony import */ var _PageInfo__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./PageInfo */ "./src/ts/modules/PageInfo.ts");
// 初始化收藏页面
...
class InitBookmarkPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    getWantPage() {
        ...
        if (this.crawlRecommended) {
            pageTip = _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg11');
        }
        else {
            pageTip = _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg7');
        }
        this.crawlNumber = this.checkWantPageInput(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg6'), pageTip);
    }
    nextStep() {
        if (this.crawlRecommended) {
            // 下载推荐图片
    ...
    readyGetIdList() {
        ...
        this.tag = _PageInfo__WEBPACK_IMPORTED_MODULE_10__["pageInfo"].getPageTag;
        // 判断是公开收藏还是非公开收藏
        // 在新旧版 url 里，rest 都是在查询字符串里的
        this.isHide = _API__WEBPACK_IMPORTED_MODULE_1__["API"].getURLField(location.href, 'rest') === 'hide';
        // 获取 id 列表
        this.getIdList();
        _Log__WEBPACK_IMPORTED_MODULE_8__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_正在抓取'));
        if (this.crawlNumber === -1) {
            _Log__WEBPACK_IMPORTED_MODULE_8__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_获取全部书签作品'));
        }
    }
    // 获取用户的收藏作品列表
    async getIdList() {
        let data;
        try {
            data = await _API__WEBPACK_IMPORTED_MODULE_1__["API"].getBookmarkData(_DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].getUserId(), this.tag, this.offset, this.isHide);
        }
        catch (error) {
            this.getIdList();
            return;
    ...
    getRecommendedList() {
        ...
        for (const li of elements) {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.push(_API__WEBPACK_IMPORTED_MODULE_1__["API"].getIllustId(a.href));
        }
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
    ...
    getIdList() {
        ...
        for (const id of idValue) {
            ...
            if (isNaN(nowId) || nowId < 22 || nowId > 99999999) {
                _Log__WEBPACK_IMPORTED_MODULE_8__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_id不合法'), 0, false);
            }
            else {
                _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.push(nowId.toString());
            }
        }
        this.getIdListFinished();
    }
...
class InitNewIllustPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    getWantPage() {
        ...
        _Log__WEBPACK_IMPORTED_MODULE_8__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_抓取多少个作品', this.crawlNumber.toString()));
    }
    nextStep() {
        this.initFetchURL();
        this.getIdList();
    ...
    initFetchURL() {
        ...
        this.option.type = _API__WEBPACK_IMPORTED_MODULE_6__["API"].getURLField(location.href, 'type') || 'illust';
        // 是否是 R18 模式
    ...
    async getIdList() {
        let data;
        try {
            data = await _API__WEBPACK_IMPORTED_MODULE_6__["API"].getNewIllustData(this.option);
        }
        catch (error) {
            this.getIdList();
            return;
        ...
        for (const nowData of useData) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_5__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_7__["store"].idList.push(nowData.illustId);
            }
        }
        _Log__WEBPACK_IMPORTED_MODULE_8__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_新作品进度', this.fetchCount.toString()), 1, false);
        // 抓取完毕
...
/* harmony import */ var _InitWorksPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./InitWorksPage */ "./src/ts/modules/InitWorksPage.ts");
...
/* harmony import */ var _InitBookmarkPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./InitBookmarkPage */ "./src/ts/modules/InitBookmarkPage.ts");
/* harmony import */ var _InitSearchPage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./InitSearchPage */ "./src/ts/modules/InitSearchPage.ts");
/* harmony import */ var _InitAreaRankingPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./InitAreaRankingPage */ "./src/ts/modules/InitAreaRankingPage.ts");
/* harmony import */ var _InitRankingPage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./InitRankingPage */ "./src/ts/modules/InitRankingPage.ts");
/* harmony import */ var _InitPixivisionPage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./InitPixivisionPage */ "./src/ts/modules/InitPixivisionPage.ts");
/* harmony import */ var _InitBookmarkDetailPage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./InitBookmarkDetailPage */ "./src/ts/modules/InitBookmarkDetailPage.ts");
...
class InitPage {
    ...
    initPage() {
        switch (_PageType__WEBPACK_IMPORTED_MODULE_1__["pageType"].getPageType()) {
            ...
            case 1:
                return new _InitWorksPage__WEBPACK_IMPORTED_MODULE_3__["InitWorksPage"]();
            case 2:
                return new _InitUserPage__WEBPACK_IMPORTED_MODULE_4__["InitUserPage"]();
            case 4:
                return new _InitBookmarkPage__WEBPACK_IMPORTED_MODULE_5__["InitBookmarkPage"]();
            case 5:
                return new _InitSearchPage__WEBPACK_IMPORTED_MODULE_6__["InitSearchPage"]();
            case 6:
                return new _InitAreaRankingPage__WEBPACK_IMPORTED_MODULE_7__["InitAreaRankingPage"]();
            case 7:
                return new _InitRankingPage__WEBPACK_IMPORTED_MODULE_8__["InitRankingPage"]();
            case 8:
                return new _InitPixivisionPage__WEBPACK_IMPORTED_MODULE_9__["InitPixivisionPage"]();
            case 9:
                return new _InitBookmarkDetailPage__WEBPACK_IMPORTED_MODULE_10__["InitBookmarkDetailPage"]();
            case 10:
                return new _InitBookmarkNewIllustPage__WEBPACK_IMPORTED_MODULE_11__["InitBookmarkNewIllustPage"]();
            case 11:
...
/* harmony import */ var _Lang__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Lang */ "./src/ts/modules/Lang.ts");
/* harmony import */ var _Colors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Colors */ "./src/ts/modules/Colors.ts");
/* harmony import */ var _CenterButtons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CenterButtons */ "./src/ts/modules/CenterButtons.ts");
...
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Settings */ "./src/ts/modules/Settings.ts");
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _PageInfo__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./PageInfo */ "./src/ts/modules/PageInfo.ts");
// 初始化抓取页面的流程
...
class InitPageBase {
    ...
    init() {
        ...
        this.appendElseEl();
        this.initElse();
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.destroy, () => {
            this.destroy();
        });
    }
    // 各个子类私有的初始化内容
    ...
    appendCenterBtns() {
        _CenterButtons__WEBPACK_IMPORTED_MODULE_2__["centerButtons"]
            .add(_Colors__WEBPACK_IMPORTED_MODULE_1__["Colors"].blue, _Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_开始抓取'), [
    ...
    // 作品个数/页数的输入不合法
    getWantPageError() {
        _EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.crawlError);
    ...
    checkWantPageInput(crawlPartTip, crawlAllTip) {
        const temp = parseInt(_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].setWantPage.value);
        // 如果比 1 小，并且不是 -1，则不通过
        ...
        if (temp >= 1) {
            _Log__WEBPACK_IMPORTED_MODULE_7__["log"].warning(crawlPartTip.replace('-num-', temp.toString()));
        }
        else if (temp === -1) {
    ...
    checkWantPageInputGreater0() {
        const result = _API__WEBPACK_IMPORTED_MODULE_5__["API"].checkNumberGreater0(_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].setWantPage.value);
        if (result.result) {
            return result.value;
        }
        else {
    ...
    // 获取作品张数设置
    getFirstFewImages() {
        const check = _API__WEBPACK_IMPORTED_MODULE_5__["API"].checkNumberGreater0(_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].firstFewImages.value);
        if (check.result) {
            return check.value;
        }
        else {
    ...
    getMultipleSetting() {
        this.multipleImageWorks = parseInt(_Settings__WEBPACK_IMPORTED_MODULE_9__["form"].multipleImageWorks.value);
        if (this.multipleImageWorks === -1) {
            _Log__WEBPACK_IMPORTED_MODULE_7__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_不下载多图作品'));
        }
        // 获取作品张数设置
        if (this.multipleImageWorks === 1) {
            this.firstFewImages = this.getFirstFewImages();
            _Log__WEBPACK_IMPORTED_MODULE_7__["log"].warning(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_多图作品下载前n张图片', this.firstFewImages.toString()));
        }
    }
    ...
    async readyCrawl() {
        ...
        if (!_Store__WEBPACK_IMPORTED_MODULE_6__["store"].states.allowWork) {
            window.alert(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_当前任务尚未完成2'));
            return;
        }
        _EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.crawlStart);
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].clear();
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_任务开始0'));
    ...
    getIdListFinished() {
        ...
        if (_Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.length === 0) {
            return this.noResult();
        }
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_当前作品个数', _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.length.toString()));
        if (_Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.length <= this.ajaxThreadsDefault) {
            this.ajaxThreads = _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.length;
        }
        else {
    ...
    async getWorksData(id) {
        id = id || _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.shift();
        let data;
        try {
            // 发起请求
            data = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getWorksData(id);
        }
        catch (error) {
        ...
        // 检查通过
        if (_Filter__WEBPACK_IMPORTED_MODULE_4__["filter"].check(filterOpt)) {
            ...
            let testRank = _Store__WEBPACK_IMPORTED_MODULE_6__["store"].getRankList(body.illustId);
            ...
            if (body.illustType !== 2) {
                ...
                // 动图
                // 获取动图的信息
                const meta = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getUgoiraMeta(illustId);
                // 动图帧延迟数据
                const ugoiraInfo = {
                    frames: meta.body.frames,
                    mime_type: meta.body.mime_type
                };
                const ext = _Settings__WEBPACK_IMPORTED_MODULE_9__["form"].ugoiraSaveAs.value; // 扩展名可能是 webm、gif、zip
                _Store__WEBPACK_IMPORTED_MODULE_6__["store"].addResult({
                    id: illustId,
                    idNum: idNum,
                    thumb: thumb,
    ...
    // 抓取完毕
    crawlFinished() {
        if (_Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.length === 0) {
            return this.noResult();
        }
        this.sortResult();
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_抓取图片网址的数量', _Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.length.toString()));
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_抓取完毕'), 2);
        _EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.crawlFinish);
    }
    // 网络请求状态异常时输出提示
    logErrorStatus(status, id) {
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_无权访问2', id), 1);
        switch (status) {
            case 0:
    ...
    // 在抓取图片网址时，输出提示
    logImagesNo() {
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_抓取图片网址的数量', _Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.length.toString()), 1, false);
    }
    // 抓取结果为 0 时输出提示
    noResult() {
        _EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_8__["EVT"].events.crawlEmpty);
        _TitleBar__WEBPACK_IMPORTED_MODULE_10__["titleBar"].reset();
        _Log__WEBPACK_IMPORTED_MODULE_7__["log"].error(_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_抓取结果为零'), 2);
...
class InitRankingPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    async getIdList() {
        ...
        for (const data of contents) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_7__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_8__["store"].setRankList(data.illust_id.toString(), data.rank.toString());
                _Store__WEBPACK_IMPORTED_MODULE_8__["store"].idList.push(data.illust_id.toString());
            }
        }
...
/* harmony import */ var _EVT__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./EVT */ "./src/ts/modules/EVT.ts");
/* harmony import */ var _Filter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Filter */ "./src/ts/modules/Filter.ts");
/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./API */ "./src/ts/modules/API.ts");
/* harmony import */ var _Store__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Store */ "./src/ts/modules/Store.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Log */ "./src/ts/modules/Log.ts");
/* harmony import */ var _CenterPanel__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./CenterPanel */ "./src/ts/modules/CenterPanel.ts");
/* harmony import */ var _TitleBar__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./TitleBar */ "./src/ts/modules/TitleBar.ts");
/* harmony import */ var _Settings__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Settings */ "./src/ts/modules/Settings.ts");
/* harmony import */ var _FastScreen__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./FastScreen */ "./src/ts/modules/FastScreen.ts");
// 初始化搜索页
...
class InitSearchPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    constructor() {
        ...
        this.showCount = () => {
            ...
            _Log__WEBPACK_IMPORTED_MODULE_11__["log"].success(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_调整完毕', count));
    ...
    `;
        ...
        this.addBookmark = (event) => {
            const data = event.detail.data;
            _API__WEBPACK_IMPORTED_MODULE_9__["API"].addBookmark(data.id.toString(), data.tags, _API__WEBPACK_IMPORTED_MODULE_9__["API"].getToken(), false);
        ...
        this.onCrawlFinish = () => {
            if (this.crawlWorks) {
                this.crawled = true;
                this.resultMeta = [..._Store__WEBPACK_IMPORTED_MODULE_10__["store"].resultMeta];
                this.reAddResult();
            }
        };
        // 清除多图作品
    ...
    initElse() {
        this.setPreviewResult(_Settings__WEBPACK_IMPORTED_MODULE_14__["form"].previewResult.checked);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.addResult, this.addWork);
        window.addEventListener('addBMK', this.addBookmark);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.crawlFinish, this.onCrawlFinish);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.crawlFinish, this.showCount);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.clearMultiple, this.clearMultiple);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.clearUgoira, this.clearUgoira);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.deleteWork, this.deleteWork);
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.settingChange, this.onSettingChange);
    }
    appendCenterBtns() {
        _CenterButtons__WEBPACK_IMPORTED_MODULE_4__["centerButtons"]
    ...
    destroy() {
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.addResult, this.addWork);
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.crawlFinish, this.onCrawlFinish);
        window.removeEventListener(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.crawlFinish, this.showCount);
        // 离开下载页面时，取消设置“不自动下载”
        _Store__WEBPACK_IMPORTED_MODULE_10__["store"].states.notAutoDownload = false;
    }
    startScreen() {
        if (!_Store__WEBPACK_IMPORTED_MODULE_10__["store"].states.allowWork) {
    ...
    filterResult(callback) {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.crawlFinish);
    }
    ...
    reAddResult() {
        ...
        _EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].fire(_EVT__WEBPACK_IMPORTED_MODULE_7__["EVT"].events.worksUpdate);
    ...
    screenInResult() {
        ...
        this.filterResult(data => {
            ...
            return _Filter__WEBPACK_IMPORTED_MODULE_8__["filter"].check(filterOpt);
        });
    }
    getWantPage() {
    ...
    async getSearchData(p) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_9__["API"].getSearchData(_PageInfo__WEBPACK_IMPORTED_MODULE_5__["pageInfo"].getPageTag, this.worksType, p, this.option);
    ...
    initFetchURL() {
        ...
        */
        ...
        let p = _API__WEBPACK_IMPORTED_MODULE_9__["API"].getURLField(location.href, 'p');
        this.startpageNo = parseInt(p) || 1;
        // 从页面 url 中获取可以使用的选项
        this.option = {};
        this.allOption.forEach(param => {
            let value = _API__WEBPACK_IMPORTED_MODULE_9__["API"].getURLField(location.href, param);
            if (value !== '') {
    ...
    async getIdList() {
        ...
        for (const nowData of data) {
            ...
            if (_Filter__WEBPACK_IMPORTED_MODULE_8__["filter"].check(filterOpt)) {
                _Store__WEBPACK_IMPORTED_MODULE_10__["store"].idList.push(nowData.illustId);
            }
        }
        this.listPageFinished++;
        _Log__WEBPACK_IMPORTED_MODULE_11__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_列表页抓取进度', this.listPageFinished.toString()), 1, false);
        if (this.sendCrawlTaskCount + 1 <= this.needCrawlPageCount) {
            ...
            if (this.listPageFinished === this.needCrawlPageCount) {
                // 抓取任务全部完成
                _Log__WEBPACK_IMPORTED_MODULE_11__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_列表页抓取完成'));
                this.getIdListFinished();
            }
        }
    }
    ...
    // 搜索页把下载任务按收藏数从高到低下载
    sortResult() {
        _Store__WEBPACK_IMPORTED_MODULE_10__["store"].resultMeta.sort(_API__WEBPACK_IMPORTED_MODULE_9__["API"].sortByProperty('bmk'));
        _Store__WEBPACK_IMPORTED_MODULE_10__["store"].result.sort(_API__WEBPACK_IMPORTED_MODULE_9__["API"].sortByProperty('bmk'));
    }
    setPreviewResult(value) {
        this.previewResult = value;
        // 如果设置了“预览搜索结果”，则“不自动下载”。否则允许自动下载
        _Store__WEBPACK_IMPORTED_MODULE_10__["store"].states.notAutoDownload = value ? true : false;
    }
}
...
class InitSettings {
    ...
    bindOptionEvent() {
        // 保存是否显示选项区域
        window.addEventListener(_EVT__WEBPACK_IMPORTED_MODULE_0__["EVT"].events.toggleForm, (event) => {
            const boolean = event.detail.data;
...
class InitUserPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    readyGetIdList() {
        // 如果前面有页数，就去掉前面页数的作品数量。即：从本页开始下载
        const nowPage = _API__WEBPACK_IMPORTED_MODULE_5__["API"].getURLField(location.href, 'p'); // 判断当前处于第几页，页码从 1 开始。也可能没有页码
        if (nowPage) {
    ...
    async getIdList() {
        ...
        let idList = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type);
        // 把作品 id 转换成数字
        let tempList = [];
        ...
        // 储存
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.concat(idList);
        this.getIdListFinished();
    }
    // 获取用户某一类型的作品列表（附带 tag）
    async getIdListByTag(type) {
        let data = await _API__WEBPACK_IMPORTED_MODULE_5__["API"].getUserWorksByTypeWithTag(_DOM__WEBPACK_IMPORTED_MODULE_8__["DOM"].getUserId(), type, this.tag, this.offset, this.requsetNumber);
        data.body.works.forEach(data => _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(data.id));
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
        this.offset = 0;
    ...
    sortResult() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].result.sort(_API__WEBPACK_IMPORTED_MODULE_5__["API"].sortByProperty('id'));
    }
}
...
/* harmony import */ var _DOM__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./DOM */ "./src/ts/modules/DOM.ts");
/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./API */ "./src/ts/modules/API.ts");
/* harmony import */ var _Log__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Log */ "./src/ts/modules/Log.ts");
//初始化作品页
...
class InitWorksPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_0__["InitPageBase"] {
    ...
    getWantPage() {
        if (_Store__WEBPACK_IMPORTED_MODULE_6__["store"].states.quickDownload) {
            // 快速下载
            this.crawlNumber = 1;
        }
        else {
            ...
            if (!this.crawlRelated) {
                this.crawlNumber = this.checkWantPageInput(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg3'), _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg4'));
            }
            else {
                // 相关作品的提示
                this.crawlNumber = this.checkWantPageInput(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg9'), _Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_checkWantPageRule1Arg10'));
            }
        }
    }
    nextStep() {
        ...
        else if (_Store__WEBPACK_IMPORTED_MODULE_6__["store"].states.quickDownload) {
            // 快速下载
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.push(_API__WEBPACK_IMPORTED_MODULE_10__["API"].getIllustId(window.location.href));
            _Log__WEBPACK_IMPORTED_MODULE_11__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_开始获取作品页面'));
            this.getIdListFinished();
        }
        else {
            // 向前向后下载
    ...
    async getIdList() {
        ...
        let idList = await _API__WEBPACK_IMPORTED_MODULE_10__["API"].getUserWorksByType(_DOM__WEBPACK_IMPORTED_MODULE_9__["DOM"].getUserId(), type);
        // 储存符合条件的 id
        let nowId = parseInt(_API__WEBPACK_IMPORTED_MODULE_10__["API"].getIllustId(window.location.href));
        idList.forEach(id => {
        ...
        if (this.crawlNumber !== -1) {
            ...
            if (this.crawlDirection === -1) {
                _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.sort(function (x, y) {
            ...
            _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.splice(0, this.crawlNumber);
        }
        this.getIdListFinished();
    }
    // 下载相关作品时使用
    async getRelatedList() {
        let data = await _API__WEBPACK_IMPORTED_MODULE_10__["API"].getRelatedData(_API__WEBPACK_IMPORTED_MODULE_10__["API"].getIllustId());
        ...
        _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList = _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.concat(recommendIdList);
        _Log__WEBPACK_IMPORTED_MODULE_11__["log"].log(_Lang__WEBPACK_IMPORTED_MODULE_3__["lang"].transl('_相关作品抓取完毕', _Store__WEBPACK_IMPORTED_MODULE_6__["store"].idList.length.toString()));
        this.getIdListFinished();
    }
    resetGetIdListStatus() {
...
class PageInfo {
    ...
    async store() {
        ...
        _Store__WEBPACK_IMPORTED_MODULE_3__["store"].pageInfo.pageTitle = this.pageTitle;
    ...
    // 获取当前页面的一些信息，用于文件名中
    async getPageInfo() {
        const type = _PageType__WEBPACK_IMPORTED_MODULE_4__["pageType"].getPageType();
        this.reset();
        // 去掉标题上的下载状态、消息数量提示
        ...
        if (type === 1 || type === 2) {
            ...
            try {
                const data = await _API__WEBPACK_IMPORTED_MODULE_0__["API"].getUserProfile(_DOM__WEBPACK_IMPORTED_MODULE_1__["DOM"].getUserId());
        ...
        // 获取当前页面的 tag
        this.pageTag = decodeURIComponent(_API__WEBPACK_IMPORTED_MODULE_0__["API"].getTagFromURL(location.href));
        // 将可用选项添加到下拉选项里
...
class ProgressBar {
  ...
  <span class="fileName"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${_Lang__WEBPACK_IMPORTED_MODULE_2__["lang"].transl('_已下载')}&nbsp;&nbsp;<span class="loaded">0/0</span>KB
        ...
        this.allProgressBar = [];
        this.wrap = _CenterPanel__WEBPACK_IMPORTED_MODULE_1__["centerPanel"].useSlot('progressBar', this.wrapHTML);
...
/* harmony import */ var _BeautifyForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BeautifyForm */ "./src/ts/modules/BeautifyForm.ts");
...
class Settings {
  ...
  <span>${_Lang__WEBPACK_IMPORTED_MODULE_0__["lang"].transl('_大于')}&nbsp;</span>
  ...
  <input type="hidden" name="debut" value="0">
        ...
        new _BeautifyForm__WEBPACK_IMPORTED_MODULE_5__["BeautifyForm"](this.form);
    }
    // 把下拉框的选择项插入到文本框里
