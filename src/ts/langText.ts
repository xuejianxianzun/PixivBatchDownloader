...
const langText = {
  ...
  _不限制: ['不限制', '不限制', 'not limited', '無制限', '제한 없음', 'Без лимитов'],
  ...
  _抓取多少作品: [
    ...
    'Какое <span class="key">колличество</span> работ вытащить,
  ],
  _抓取多少页面: [
    ...
    'Какое <span class="key">колличество</span> страниц вытащить',
  ],
  _收藏数量: [
  ...
  _插画: ['插画', '插畫', 'Illustrations', 'イラスト', '일러스트', 'Иллюстрации'],
  _漫画: ['漫画', '漫畫', 'Manga', '漫画', '만화', 'Манга'],
  _动图: ['动图', '動圖', 'Ugoira', 'うごイラ', '움직이는 일러스트', 'Ugoira(гиф)'],
  _动图保存格式: [
  ...
  _gif: ['GIF 图片', '圖片（GIF）', 'GIF image', 'GIF 画像', 'GIF 이미지', 'GIF изображение'],
  _apng: [
    'APNG 图片',
    '圖片（APNG）',
    'APNG image',
  ...
  _新作品进度: [
    ...
    'На этой странице было вытащено {} работ',
  ],
  _抓取多少个作品: [
    '抓取本页面 {} 个作品',
    '擷取本頁面 {} 個作品',
    ...
    'このページの {} つの作品をクロールします',
    '이 페이지의 {}개의 작품 긁어오기',
    'Вытащить на этой странице {} работ',
  ],
  _相关作品抓取完毕: [
    ...
    'Связанные работы были вытащены. Содержит {} работ и начинает получать информацию о работе(ах).',
  ],
  _排行榜任务完成: [
  ...
  _停止下载: ['停止下载', '停止下載', 'Stop download', '停止', '다운로드 정지', 'Остановить загрузку'],
  _复制url: [
    '复制 URL',
    '複製下載網址',
    'Copy URLs',
  ...
  _从本页开始抓取new: [
    ...
    'このページから新しい作品を入手する',
    '이 페이지부터 새 작품 긁어오기',
    'Вытащить новые работы с этой страницы',
  ],
  _从本页开始抓取old: [
    '从本页开始抓取旧作品',
    '從本頁開始擷取舊作品',
    ...
    'このページから古い作品を入手する',
    '이 페이지부터 오래된 작품 긁어오기',
    'Вытащить старые работы с этой страницы',
  ],
  _抓取推荐作品: [
    '抓取推荐作品',
    '擷取推薦作品',
  ...
  _抓取推荐作品Title: [
    ...
    'ページの下部で推奨作品をクロールします',
    '페이지 하단 추천 작품 긁어오기',
    'Вытащить рекомендованные работы внизу страницы',
  ],
  _抓取相关作品: [
    '抓取相关作品',
    '擷取相關作品',
  ...
  _抓取当前作品Title: [
    ...
    'Вытащить все работы в текущем списке',
  ],
  _清除多图作品: [
    '清除多图作品',
    '清除多圖作品',
  ...
  _抓取本页作品: [
    ...
    'このページをクロールする',
    '이 페이지의 작품 긁어오기',
    'Вытащить работы с этой страницы',
  ],
  _抓取本页作品Title: [
    '抓取本页列表中的所有作品',
    '擷取本頁清單中的所有作品',
  ...
  _抓取本排行榜作品: [
    ...
    'このリストの作品をクロールする',
    '이 목록의 작품 긁어오기',
    'Вытащить работы из этого списка',
  ],
  _抓取本排行榜作品Title: [
  ...
  _抓取该页面的图片: [
    ...
    'ページの画像をクロールする',
    '페이지의 이미지 긁어오기',
    'Вытащить по изображение страницы',
  ],
  _抓取相似图片: [
    '抓取相似图片',
    '擷取相似圖片',
  ...
  _时间范围: ['时间范围', '時間範圍', 'Time range', '時間範囲', '시간 범위', 'Диапазон времени'],
  _必须大于0: [
    '必须大于 0',
    '必須大於 0',
  ...
  _新增功能: ['新增功能', '新增功能', 'New feature', '新機能', '새로운 기능', 'Новая фича'],
  _抓取: ['抓取', '擷取', 'Crawl', 'クロール', '긁어오기','Вытащить'],
  ...
  _策略: ['策略：', '策略：', 'Strategy:', 'フィルター：', '전략:', 'Стратегия'],
  ...
  _变更语言后刷新页面的提示: [
    ...
    'Пожалуйста, обновите страницу после изменения языка.',
  ],
  _公开: ['公开', '公開', 'Public', '公開', '공개', 'Публичный'],
  _不公开: ['不公开', '非公開', 'Private', '非公開', '비공개', 'Приватный'],
  _已收藏: ['已收藏', '已收藏', 'Bookmarked', 'ブックマークした', '북마크됨', 'В закладках'],
  _已收藏带参数: [
    '已收藏 {}',
    '已收藏 {}',
    'Bookmarked {}',
  ...
  _添加tag: ['添加标签', '加入標籤', 'Add tag', 'タグを追加', '태그 추가', 'Добавить тег'],
  _不添加tag: [
    '不添加标签',
    '不加入標籤',
    "Don't add tag",
  ...
  _不透明度: ['不透明度', '不透明度', 'Opacity', '不透明度', '투명도', 'Непрозрачность'],
  _对齐方式: ['对齐方式', '對齊方式', 'Alignment', '揃え方式', '정렬', 'Выравнивание'],
