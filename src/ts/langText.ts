...
const langText = {
  ...
  _完全一致: ['完全一致', '完全一致', 'Perfect match', '完全一致', '완전 일치', 'Идеальное совпадение'],
  _部分一致: ['部分一致', '部分一致', 'Partial match', '部分一致', '부분 일치', 'Частичное совпадение'],
  ...
  _搜索模式: ['搜索模式', '搜尋模式', 'Search mode', '検索モード', '검색 모드', 'Режим поиска'],
  _标签部分一致: [
    '标签（部分一致）',
    '標籤（部分一致）',
    'Tags (partial match)',
  ...
  _减慢抓取速度的说明: [
    ...
    'Замедлите ползание, чтобы избежать временного ограничения Pixiv во время ползания. Но это увеличит время ползания.',
  ],
  _作品数量: ['作品数量', '作品數量', 'Number of works', '作品数', '작품 수', 'Количество работ'],
  _慢速抓取: [
    '慢速抓取',
    '慢速抓取',
    'slow crawl',
  ...
  _修复bug: ['修复 bug', '修復 bug', 'fix bugs', 'バグを修正', '버그 수정', 'Баг фикс'],
  _不支持的浏览器: [
