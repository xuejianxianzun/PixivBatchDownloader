...
之前下载器的快捷键不能自定义，现在你可以在浏览器的扩展管理里修改它们了。方法如下：
打开浏览器菜单，点击“扩展程序”进入扩展管理页面，然后点击“键盘快捷键”，找到这个扩展程序，即可设置快捷键。

注意：由于浏览器的限制，这次修改导致一些之前有预设快捷键的功能，现在没有预设了。如果你有需要的话，可以为它们设置自定义快捷键。你可以在下载器的“帮助”页面里点击“快捷键”按钮查看详细说明。

修改前的文档：notes\允许用户设置快捷键.md
