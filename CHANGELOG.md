...
例如收藏一个作品之后，在作品下面出现的推荐作品列表。

另外，首页顶部的“关注用户・好P友的作品”也存在问题，因为它原本以此显示 6 个作品，开启“放大缩略图”之后，只能显示 4 个。滚动的时候 pixiv 还是按照原来逻辑进行滚动，从放大后的角度来看，会一次滚动 5 个作品，经常会导致有一个作品被滚动到可视区域之外。
