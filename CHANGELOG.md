...
强大的 Pixiv 下载器，支持批量下载。

一键下载作品；
批量下载画师的所有作品、你的收藏、排行榜等；
转换动图为 GIF、WebM、APNG；
小说保存为 TXT、EPUB；
重命名文件；
通过设置条件来过滤作品，或者手动选择要下载的作品。


一括ダウンロードをサポートする強力な Pixiv ダウンローダー。

ワンクリックですべての作品をダウンロードできます。
ユーザーの全作品、ボックマーク、ランキングなどの一括ダウンロード。
動画を GIF、WebM、APNG に変換できます。
小説を TXT、EPUB として保存できます。
保存ファイル名を変更できます。
条件を設定してフィルタリングするか、手動で作品を選んでダウンロードすることもできます。
