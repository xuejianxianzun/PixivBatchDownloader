...
另外，我更新了在移动端页面里查找作品缩略图的代码，查找更准确、也覆盖到了很多之前没有覆盖到的地方，这样才能让全选功能发挥最用。
...
现在我区分了“普通下载任务”和“快速下载任务”，你可以更精细的控制了。

### ✨在搜索用户的页面里，适配了“显示更大的缩略图”的样式

### 🎨把“显示日志”按钮从网页顶部移动到了右侧
...
- “导出日志”改为“自动导出日志”。这是因为现在有了“手动导出日志”的按钮，所以之前的“导出日志”功能改名为更准确的“自动导出日志”。
...
如果你想修改下载器内置的快捷键，可以在"通用"-"操作方式"-"自定义快捷键"设置里进行修改。
...
快捷键 `Alt` + `Z` 可以点击默认的抓取按钮（通常是“开始抓取”）。这样不需要打开设置面板就可以直接开始抓取。
...
如果你想让预览图和以前一样：尽量不缩小，但有时会遮挡住缩略图，可以启用此开关。
...
预览作品时显示的图片是缩略图，如果你想以 1:1 的比例查看原图，可以按 `V` 查看原图。
