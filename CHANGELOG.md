...
### ✨新功能：在插画、漫画页面里，下载器会在每张图片的右上角添加下载按钮
...
3. 鼠标停留在缩略图上后，可以预览这张图片（也就是“预览作品”功能）。
...
仅在漫画页面里，点击“阅读作品”后，图片列表底部会显示一个“相关作品”区域，它和平时底部的“相关作品”内容是一样的，但此时是单独的元素。之前我没有看到这部分，没有进行处理，导致它的宽度没有加宽，现在进行了修复。
